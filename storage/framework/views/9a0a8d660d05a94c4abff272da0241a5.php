<?php $__env->startSection('title', 'Dokumen Izin Persiapan - Property Management App'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="filter-card mb-3">
                        ...
                        <div class="filter-row-desktop d-none d-md-block">
                            <form method="GET" action="<?php echo e(route('dokument.persiapan')); ?>" onsubmit="return showFilterLoading()">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 w-100">
                                    <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
                                        ...
                                        <div style="width: 190px;">
                                            <select class="form-control" name="required" id="requiredSelect">
                                                ...
                                                <option value="yes" <?php echo e(request('required') == 'yes' ? 'selected' : ''); ?>>Wajib Upload</option>
                                                <option value="no" <?php echo e(request('required') == 'no' ? 'selected' : ''); ?>>Opsional</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2 ms-auto">
                                        ...
                                        <a href="<?php echo e(route('dokument.persiapan')); ?>" class="btn btn-gradient-secondary btn-icon-only" title="Reset" onclick="showResetLoading(event)">
                        ...
                        <div class="filter-row-mobile d-block d-md-none">
                            <form method="GET" action="<?php echo e(route('dokument.persiapan')); ?>" onsubmit="return showFilterLoading()">
                                <div class="row g-2">
                                    ...
                                    <div class="col-6">
                                        <a href="<?php echo e(route('dokument.persiapan')); ?>" class="btn btn-gradient-secondary w-100 d-flex align-items-center justify-content-center gap-1" onclick="showResetLoading(event)">
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-muted"><?php echo e($item->description ?: '-'); ?></span>
                                    </td>
                                    <td>
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Property-Management-Web-App\resources\views/dokument/dokument-persiapan.blade.php ENDPATH**/ ?>