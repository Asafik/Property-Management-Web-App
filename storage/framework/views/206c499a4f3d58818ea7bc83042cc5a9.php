            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white d-flex flex-wrap flex-md-row justify-content-between align-items-center gap-2 py-3">
                        ...
                        <a href="<?php echo e(route('properti')); ?>" class="btn btn-sm btn-gradient-primary d-inline-flex align-items-center" style="gap: 5px;">
                        ...
                        <div class="filter-card mb-3">
                            <form id="filterForm" method="GET" action="<?php echo e(route('properti-all')); ?>">
                                ...
                                <input type="hidden" name="sort_order" id="sort_order"
                                    value="<?php echo e(request('sort_order', 'asc')); ?>">
                                                ...
                                                <select name="kategori" class="form-select" onchange="document.getElementById('filterForm').submit()" style="height: 38px;">
                                                    ...
                                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($cat); ?>"
                                                            <?php echo e(request('kategori') == $cat ? 'selected' : ''); ?>>
                                                            <?php echo e($cat); ?>
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $landBanks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-center fw-bold text-muted"><?php echo e($landBanks->firstItem() + $index); ?></td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="document-trigger" data-bs-toggle="modal"
                                                    ...
                                                    <i
                                                        class="mdi mdi-file-document-multiple-outline"></i><?php echo e($item->merged_documents->count()); ?>
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="pagination pagination-sm flex-wrap justify-content-center mb-0">
                                        ...
                                        <?php else: ?>
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="<?php echo e($landBanks->appends(request()->query())->previousPageUrl()); ?>"
                                        ...
                                        <?php $__currentLoopData = $landBanks->getUrlRange(max(1, $landBanks->currentPage() - 2), min($landBanks->lastPage(), $landBanks->currentPage() + 2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($page == $landBanks->currentPage()): ?>
                                            ...
                                            <?php else: ?>
                                                <li class="page-item">
                                                    <a class="page-link"
                                                        href="<?php echo e($landBanks->appends(request()->query())->url($page)); ?>"><?php echo e($page); ?></a>
                                                </li>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                        
                                        <?php if($landBanks->hasMorePages()): ?>
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="<?php echo e($landBanks->appends(request()->query())->nextPageUrl()); ?>"
