    ...
    <?php $__env->startSection('title', 'Pengaturan - Property Management App'); ?>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('setting.update')); ?>" method="POST" enctype="multipart/form-data" id="formSettings">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="npwp" value="<?php echo e(old('npwp', $company->npwp ?? '')); ?>" id="npwpInput">
...
unset($__errorArgs, $__bag); ?>" name="address" rows="3"><?php echo e(old('address', $company->address ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="city" value="<?php echo e(old('city', $company->city ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="province" value="<?php echo e(old('province', $company->province ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="postal_code" value="<?php echo e(old('postal_code', $company->postal_code ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone', $company->phone ?? '')); ?>">
                                        </div>
...
unset($__errorArgs, $__bag); ?>" name="whatsapp" value="<?php echo e(old('whatsapp', $company->whatsapp ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email', $company->email ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="website" value="<?php echo e(old('website', $company->website ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control <?php $__errorArgs = ['founded_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            name="founded_date"
                                            value="<?php echo e(old('founded_date', isset($company->founded_date) ? $company->founded_date->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body d-flex justify-content-start">
                        <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-gradient-secondary">
    ...
    $(document).ready(function() {
        ...
        <?php if(isset($company) && $company->logo): ?>
            $('#logoPreviewImage').attr('src', '<?php echo e(asset('storage/' . $company->logo)); ?>');
        ...
        <?php if(isset($company) && $company->favicon): ?>
            $('#faviconPreviewImage').attr('src', '<?php echo e(asset('storage/' . $company->favicon)); ?>');
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/setting/setting.blade.php ENDPATH**/ ?>