<?php $__env->startSection('title', 'Pengolahan Lahan per Fase - ' . ($land->name ?? 'Proyek') . ' - Property Management App'); ?>
...
<div class="content-wrapper p-3 p-md-4">
    ...
    <div class="page-header-box mb-4">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
            <div>
                <div>
                    <h4 class="fw-bold text-dark mb-0">
                        Pengolahan Lahan: <span class="text-primary"><?php echo e($land->name); ?></span>
                    </h4>
            ...
            <div class="d-flex flex-wrap gap-2 align-items-center">
                <a href="<?php echo e(url()->previous() && url()->previous() !== url()->current() ? url()->previous() : route('proyek.pengolahan-lahan.index')); ?>" class="btn btn-outline-secondary btn-sm px-3 rounded-2 d-flex align-items-center gap-1 shadow-sm">
                    <i class="mdi mdi-arrow-left"></i> Kembali
                </a>
                <!-- Validasi Legalitas Status Trigger -->
                <?php if($land->legal_status == 'verified' || $land->isFromPraLandbank()): ?>
                ...
                <?php elseif($land->legal_status == 'rejected'): ?>
                ...
                <a href="<?php echo e(route('master.bahan.index')); ?>" class="btn btn-outline-primary btn-sm px-3 rounded-2 d-flex align-items-center gap-1 shadow-sm">
                    Master Bahan
                </a>

                <?php if($land->canCreateKavling()): ?>
                    <a href="<?php echo e(route('properti.buatKavling', $land->id)); ?>" class="btn btn-gradient-success btn-sm px-3 rounded-2 d-flex align-items-center gap-1 shadow-sm">
                        Tambah Kavling
                    </a>
                <?php else: ?>
            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <?php elseif($progress > 0): ?>
                            <span class="badge bg-warning text-dark py-1 px-3 rounded-2 fw-bold" id="headerStatusBadge">
                                Dalam Proses (<?php echo e($progress); ?>%)
                            </span>
                        <?php else: ?>
                    ...
                    <div class="progress mb-2" style="height: 12px; border-radius: 8px; background: #e9ecef;">
                        <div class="progress-bar progress-bar-striped progress-bar-animated <?php echo e($isDevSelesai ? 'bg-success' : ($progress > 0 ? 'bg-warning' : 'bg-primary')); ?>" 
                             id="headerProgressBar" 
                             role="progressbar" 
                             style="width: <?php echo e($progress); ?>%; border-radius: 8px;"></div>
                    </div>

                    <div class="d-flex justify-content-between small text-muted">
                        <span>Total: <b class="text-primary" id="headerProgressText"><?php echo e($progress); ?>%</b></span>
                        <?php if($isCanKavling): ?>
    ...
    <div class="row g-2 g-md-3 mb-4" id="faseStepper" role="tablist">
        <?php $__currentLoopData = $phaseData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phNum => $phInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $pProg = $phInfo['progress'];
            ?>
            <div class="col-6 col-md-4 col-xl-3">
                <div class="card shadow-sm border-0 h-100 fase-step-card <?php echo e($loop->first ? 'active' : ''); ?>" 
                     id="step-fase<?php echo e($phNum); ?>-tab" 
                     data-bs-toggle="pill" 
                     data-bs-target="#step-fase<?php echo e($phNum); ?>" 
                     role="tab" 
                     onclick="activateTab('#step-fase<?php echo e($phNum); ?>-tab')"
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center p-2 p-md-3">
                        <div class="overflow-hidden">
                            <div class="d-flex align-items-center gap-1 gap-md-2 mb-1">
                                <h4 class="text-dark mb-0 fw-bold fs-5 fs-md-4"><?php echo e($pProg); ?>%</h4>
                                <?php if($pProg >= 100): ?>
                            ...
                            <p class="text-muted mb-0 fw-semibold text-truncate small"><?php echo e($phInfo['title']); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-6 col-md-4 col-xl-3">
            <div class="card shadow-sm border-0 h-100" 
                 ...
                 onclick="openAddStepModal(<?php echo e($nextPhaseNum); ?>)" 
        ...
        <div class="col-6 col-md-4 col-xl-3">
            <div class="card shadow-sm border-0 h-100 fase-step-card" 
                ...
                <div class="card-body d-flex justify-content-between align-items-center p-2 p-md-3">
                    <div class="overflow-hidden">
                        <h4 class="text-danger mb-1 fw-bold fs-6 fs-md-5 text-truncate">Rp <?php echo e(number_format($totalExpense, 0, ',', '.')); ?></h4>
                        <p class="text-muted mb-0 fw-semibold text-truncate small">Total Belanja (<?php echo e($expenses->count()); ?> Nota)</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="tab-content" id="faseStepperContent">
        ...
        <?php $__currentLoopData = $phaseData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phNum => $phInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <div class="tab-pane fade <?php echo e($loop->first ? 'show active' : ''); ?>" id="step-fase<?php echo e($phNum); ?>" role="tabpanel">
                <div class="card border-0 shadow-sm rounded-3 bg-white p-3 p-md-4 mb-4">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 pb-3 mb-4 border-bottom">
                        <div>
                            <h5 class="fw-bold text-dark mb-0"><?php echo e($phInfo['title']); ?></h5>
                        </div>
                        <div class="d-flex flex-wrap align-items-center justify-content-md-end gap-2 ms-md-auto fase-header-actions">
                            <button type="button" class="btn btn-sm btn-gradient-primary rounded-2 px-3 shadow-sm fw-semibold" onclick="openAddStepModal(<?php echo e($phNum); ?>)">
                                + Tambah Pos
                            </button>
                            <button type="button" class="btn btn-sm btn-primary text-white rounded-2 px-3 shadow-sm fw-semibold" onclick="toggleInlineAddExpense(<?php echo e($phNum); ?>)">
                                + Catat Belanja
                            </button>
                            <button type="button" class="btn btn-sm btn-success rounded-2 px-3 shadow-sm fw-semibold" onclick="finalizePhaseAction(<?php echo e($phNum); ?>)">
                                Selesaikan (100%)
                            </button>
                        </div>
                    </div>
                    ...
                    <?php echo $__env->make('properti.partials.inline_expense_form', ['phase' => $phNum, 'infrastructures' => $pItems], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                    <!-- Tasks Grid -->
                    <h6 class="fw-bold text-dark mb-3">Pos Pekerjaan: <?php echo e($phInfo['title']); ?></h6>
                    <div class="row g-3 g-md-4 mb-4">
                        <?php $__empty_1 = true; $__currentLoopData = $pItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php echo $__env->make('properti.partials.phase_item_card', ['item' => $item], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="col-12">
                                <div class="p-4 text-center bg-light rounded-3 border border-dashed">
                                    <h6 class="text-dark fw-bold mb-2">Belum ada pos pekerjaan di <?php echo e($phInfo['title']); ?></h6>
                                    <button type="button" class="btn btn-sm btn-gradient-primary px-3 rounded-2 shadow-sm fw-semibold" onclick="openAddStepModal(<?php echo e($phNum); ?>)">
                                        + Tambah Pos
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="mt-4 pt-3 border-top">
                        <h6 class="fw-bold text-dark mb-3 d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-2">
                            ...
                            <span class="badge bg-soft-danger text-danger">Total: Rp <?php echo e(number_format($pExpenses->sum('total_amount'), 0, ',', '.')); ?></span>
                        </h6>
                        <?php echo $__env->make('properti.partials.phase_expense_table', ['phase' => $phNum, 'phaseExpenses' => $pExpenses], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>

                    <!-- Navigation Footer -->
                    <div class="d-flex flex-column flex-sm-row justify-content-between gap-2 pt-4 border-top mt-4 footer-nav-actions">
                        <?php if($prevTabTarget): ?>
                            <button type="button" class="btn btn-outline-secondary px-4 rounded-2 mb-2 mb-sm-0" onclick="activateTab('<?php echo e($prevTabTarget); ?>');">
                                &larr; <?php echo e($prevTitle); ?>
                        ...
                        <?php if($isLastPhase): ?>
                            <?php if($land->canCreateKavling()): ?>
                                <a href="<?php echo e(route('properti.buatKavling', $land->id)); ?>" class="btn btn-gradient-success px-4 rounded-2 shadow-sm text-center">
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <button type="button" class="btn btn-primary px-4 rounded-2 shadow-sm" onclick="activateTab('<?php echo e($nextTabTarget); ?>');">
                                Lanjut: <?php echo e($nextTitle); ?> &rarr;
                            </button>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-6 col-md-3">
                        <div class="p-3 rounded-4 bg-light border">
                            ...
                            <h4 class="fw-bold text-danger mb-0 mt-1">Rp <?php echo e(number_format($totalExpense, 0, ',', '.')); ?></h4>
                            <span class="small text-muted"><?php echo e($expenses->count()); ?> transaksi</span>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="p-3 rounded-4 bg-light border">
                            <span class="text-muted small fw-bold">Lunas</span>
                            <h4 class="fw-bold text-success mb-0 mt-1">Rp <?php echo e(number_format($totalLunas, 0, ',', '.')); ?></h4>
                            <span class="small text-muted"><?php echo e($expenses->where('payment_status', 'Lunas')->count()); ?> transaksi</span>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="p-3 rounded-4 bg-light border">
                            <span class="text-muted small fw-bold">Hutang / Tempo</span>
                            <h4 class="fw-bold text-warning mb-0 mt-1">Rp <?php echo e(number_format($totalHutang, 0, ',', '.')); ?></h4>
                            <span class="small text-muted"><?php echo e($expenses->where('payment_status', '!=', 'Lunas')->count()); ?> transaksi</span>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="p-3 rounded-4 bg-light border">
                            ...
                            <div class="small mt-1">
                                <div>Fase 1: <b>Rp <?php echo e(number_format($expenses->where('phase', 1)->sum('total_amount'), 0, ',', '.')); ?></b></div>
                                <div>Fase 2: <b>Rp <?php echo e(number_format($expenses->where('phase', 2)->sum('total_amount'), 0, ',', '.')); ?></b></div>
                                <div>Fase 3: <b>Rp <?php echo e(number_format($expenses->where('phase', 3)->sum('total_amount'), 0, ',', '.')); ?></b></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-elevated table-hover align-middle mb-0" style="min-width: 960px;">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="ps-3">
                                        <code class="text-primary fw-bold"><?php echo e($exp->expense_code ?? '-'); ?></code>
                                        <span class="small text-muted d-block"><?php echo e($exp->expense_date ? $exp->expense_date->format('d M Y') : '-'); ?></span>
                                    </td>
                                    <td>
                                        <span class="badge bg-gradient-primary text-white rounded-2 small">Fase <?php echo e($exp->phase ?? 1); ?></span>
                                    </td>
                                    <td>
                                        <strong class="text-dark d-block"><?php echo e($exp->item_name); ?></strong>
                                        <?php if($exp->category): ?>
                                            <span class="badge bg-soft-primary text-primary small py-0 px-2 rounded-2"><?php echo e($exp->category); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if($exp->infrastructure): ?>
                                            <span class="badge bg-light text-dark border"><?php echo e($exp->infrastructure->item_name); ?></span>
                                        <?php else: ?>
                                            <span class="text-muted small">- Umum -</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <span class="fw-bold"><?php echo e(number_format($exp->quantity, 0, ',', '.')); ?></span>
                                        <span class="text-muted small"><?php echo e($exp->unit); ?></span>
                                    </td>
                                    <td>
                                        Rp <?php echo e(number_format($exp->unit_price, 0, ',', '.')); ?>

                                    </td>
                                    <td>
                                        <strong class="text-danger fs-6">
                                            Rp <?php echo e(number_format($exp->total_amount, 0, ',', '.')); ?>

                                        </strong>
                                    </td>
                                    <td>
                                        <span class="small text-dark fw-bold"><?php echo e($exp->vendor_name ?? '-'); ?></span>
                                        <small class="text-muted d-block"><?php echo e($exp->payment_method); ?></small>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <?php if($exp->receipt_proof): ?>
                                            ...
                                            ?>
                                            <a href="<?php echo e($rUrl); ?>" target="_blank" class="btn btn-sm btn-outline-info p-1 px-2 rounded-2">
                                    ...
                                    <td class="text-center pe-3">
                                        <button type="button" class="btn btn-sm btn-outline-danger p-1 px-2 rounded-2" onclick="deleteExpense(<?php echo e($exp->id); ?>)" title="Hapus">
                    ...
                    <div class="modal-body pt-2">
                        <div class="p-3 bg-light rounded-3 mb-3 border">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h6 class="fw-bold text-primary mb-0"><?php echo e($land->name); ?></h6>
                                </div>
                                <span class="badge bg-white text-dark border px-2 py-1 small">
                                    <?php echo e($land->ownership_status ?? 'SHM'); ?> (<?php echo e(number_format($land->area, 0, ',', '.')); ?> m²)
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="p-2 px-3 bg-white rounded-3 border mb-3 small">
                            <div class="d-flex justify-content-between py-1 border-bottom">
                                ...
                                <strong class="text-dark"><?php echo e($land->certificate_no ?? '-'); ?></strong>
                            </div>
                            <div class="d-flex justify-content-between py-1 border-bottom">
                                <span class="text-muted">Pemilik Sertifikat:</span>
                                <strong class="text-dark"><?php echo e($land->certificate_owner ?? '-'); ?></strong>
                            </div>
                            <div class="d-flex justify-content-between py-1 border-bottom">
                                <span class="text-muted">No. IMB / PBG:</span>
                                <strong class="text-dark"><?php echo e($land->imb_no ?? '-'); ?></strong>
                            </div>
                            <div class="d-flex justify-content-between py-1">
                                <span class="text-muted">No. PBB:</span>
                                <strong class="text-dark"><?php echo e($land->pbb_no ?? '-'); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="legal_status" id="selectLegalStatus" required>
                                <option value="verified" <?php echo e($land->legal_status === 'verified' ? 'selected' : ''); ?>>✔ Terverifikasi (Sah & Lolos Validasi)</option>
                                <option value="pending" <?php echo e($land->legal_status === 'pending' ? 'selected' : ''); ?>>⏳ Pending (Menunggu Kelengkapan Berkas)</option>
                                <option value="rejected" <?php echo e($land->legal_status === 'rejected' ? 'selected' : ''); ?>>✖ Ditolak / Perlu Revisi Dokumen</option>
                            </select>
                        </div>

                        <div class="mb-2">
                            <label class="small text-muted fw-bold mb-1">Catatan Verifikator Legalitas</label>
                            <textarea class="form-control" name="admin_notes" id="textareaLegalNotes" rows="3" placeholder="Catatan keabsahan sertifikat, perizinan, atau instruksi revisi..."><?php echo e($land->description ?? ''); ?></textarea>
                        </div>
                    </div>
                    <div class="modal-footer border-top-0 pt-0">
                        <button type="button" class="btn btn-secondary rounded-2 px-3" data-bs-dismiss="modal">Batal</button>
                ...
                <form id="formAddStep" onsubmit="submitAddStep(event)" enctype="multipart/form-data">
                    ...
                    <div class="modal-body pt-2">
                        <p class="small text-muted mb-3" id="modalAddStepSubtitle">
                            Tambahkan pos pekerjaan baru secara dinamis untuk proyek <strong><?php echo e($land->name); ?></strong>.
                        </p>
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="addStepPhase" name="phase" onchange="toggleNewPhaseInput(this.value)" required>
                                    <?php $__currentLoopData = $phaseData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phNum => $phInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($phNum); ?>"><?php echo e($phInfo['title']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($nextPhaseNum); ?>" class="fw-bold text-primary">+ Buat / Tambah Tahapan Baru</option>
                                </select>
                            </div>
...
<script>
    const currentLandId = <?php echo e($land->id); ?>;
    ...
    window.showKavlingLockedInfo = function() {
        let isLegal = <?php echo e(($land->legal_status === 'verified' || $land->isFromPraLandbank()) ? 'true' : 'false'); ?>;
        let isDev = <?php echo e((in_array(strtolower($land->development_status), ['selesai', 'done']) || $land->overall_infrastructure_progress >= 100) ? 'true' : 'false'); ?>;
    ...
    let phaseCategoryMap = {
        <?php $__currentLoopData = $phaseData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phNum => $phInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo e($phNum); ?>: "<?php echo e(addslashes($phInfo['title'])); ?>",
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    };

    window.toggleNewPhaseInput = function(phaseVal) {
        let maxExisting = <?php echo e($nextPhaseNum - 1); ?>;
        ...
        if (isNewPhase) {
            ...
            $('#modalAddStepSubtitle').html('Buat tahapan pembangunan baru dan tentukan rincian pos pekerjaan pertama untuk proyek <strong><?php echo e($land->name); ?></strong>.');
            ...
            $('#modalAddStepSubtitle').html('Tambahkan pos pekerjaan baru ke dalam <strong>' + phaseTitle + '</strong> untuk proyek <strong><?php echo e($land->name); ?></strong>.');
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/properti/pengolahan_lahan.blade.php ENDPATH**/ ?>