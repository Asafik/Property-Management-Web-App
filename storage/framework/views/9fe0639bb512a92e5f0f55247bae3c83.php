<?php $__env->startSection('title', 'Master Data Aturan Fee & Komisi - Property Management App'); ?>
...
<div class="container-fluid px-2 px-md-4 py-3">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="<?php echo e(route('keuangan.pembayaran.simulasi')); ?>" class="btn btn-sm btn-white border d-inline-flex align-items-center gap-1.5 px-3 py-2 shadow-sm fw-semibold" style="border-radius: 6px; font-size: 0.84rem; background: #ffffff; color: #334155;">
            ...
            <div class="card compact-table-card" style="background: #ffffff !important; border: 1px solid #e2e8f0 !important; border-radius: 8px !important; box-shadow: none !important;">
                ...
                <div class="card-body" style="padding: 0.75rem 1.25rem 1.15rem 1.25rem !important;">
                    ...
                    <div class="filter-card" style="margin-top: 0 !important; margin-bottom: 0.6rem !important;">
                        <form id="filterForm" method="GET" action="<?php echo e(route('keuangan.pembayaran.index')); ?>" style="margin-bottom: 0 !important;">
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 w-100">
                                ...
                                <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
                                    ...
                                    <div style="width: 175px;">
                                        <select class="form-control" name="kategori" id="kategoriFilterSelect" onchange="document.getElementById('filterForm').submit()">
                                            ...
                                            <option value="notaris" <?php echo e(request('kategori') == 'notaris' ? 'selected' : ''); ?>>Notaris / PPAT</option>
                                            <option value="makelar" <?php echo e(request('kategori') == 'makelar' ? 'selected' : ''); ?>>Makelar & Agency</option>
                                            <option value="pajak" <?php echo e(request('kategori') == 'pajak' ? 'selected' : ''); ?>>Perpajakan</option>
                                            <option value="pertanahan" <?php echo e(request('kategori') == 'pertanahan' ? 'selected' : ''); ?>>Pertanahan BPN</option>
                                        </select>
                                    </div>
                                    ...
                                    <div style="width: 165px;">
                                        <select class="form-control" name="tipe_hitung" id="tipeFilterSelect" onchange="document.getElementById('filterForm').submit()">
                                            ...
                                            <option value="flat" <?php echo e(request('tipe_hitung') == 'flat' ? 'selected' : ''); ?>>Nominal Tetap (Flat)</option>
                                            <option value="persen" <?php echo e(request('tipe_hitung') == 'persen' ? 'selected' : ''); ?>>Persentase (%)</option>
                                            <option value="meter" <?php echo e(request('tipe_hitung') == 'meter' ? 'selected' : ''); ?>>Per Meter (m²)</option>
                                        </select>
                                    </div>
                                ...
                                <div class="d-flex align-items-center gap-2 ms-auto">
                                    ...
                                    <a href="<?php echo e(route('keuangan.pembayaran.index')); ?>" class="btn btn-gradient-secondary btn-icon-only" title="Reset Filter">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle table-fee mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                    ...
                                    ?>
                                    <tr class="fee-table-row" id="row_fee_<?php echo e($r['id']); ?>" 
                                        data-search="<?php echo e(strtolower($r['kode_fee'] . ' ' . $r['nama_fee'] . ' ' . $r['kategori_label'] . ' ' . $r['target_penerima'] . ' ' . $r['proyek'] . ' ' . $r['keterangan'])); ?>">
                                        ...
                                        <td>
                                            <div class="fw-bold text-dark" style="font-size: 0.86rem; line-height: 1.35;">
                                                <?php echo e($r['nama_fee']); ?>

                                            </div>
                                            <div class="d-flex align-items-center gap-1.5 mt-0.5">
                                                <span class="badge bg-light text-secondary border font-monospace" style="font-size: 0.7rem; font-weight: 500;">
                                                    <?php echo e($r['kode_fee']); ?>

                                                </span>
                                                <?php if(!empty($r['syarat_cair'])): ?>
                                                    <i class="mdi mdi-information-outline text-muted" style="font-size: 0.85rem; cursor: pointer;" title="Syarat: <?php echo e($r['syarat_cair']); ?>" data-bs-toggle="tooltip"></i>
                                                <?php endif; ?>
                                            </div>
                                        </td>

                                        <td style="white-space: nowrap;">
                                            <span class="<?php echo e($katBadge); ?>">
                                        ...
                                        <td style="white-space: nowrap;">
                                            <span class="fw-bold text-dark" style="font-size: 0.88rem;">
                                                <?php if($r['tipe_hitung'] === 'flat'): ?>
                                                    Rp <?php echo e(number_format($r['nilai'], 0, ',', '.')); ?>

                                                <?php elseif($r['tipe_hitung'] === 'persen'): ?>
                                                    <?php echo e(number_format($r['nilai'], 1, ',', '.')); ?>%
                                                <?php else: ?>
                                                    Rp <?php echo e(number_format($r['nilai'], 0, ',', '.')); ?>/m²
                                                <?php endif; ?>
                                            </span>
                                            <span class="badge bg-light text-muted border ms-1" style="font-size: 0.68rem; font-weight: 500;">
                                                <?php echo e($r['tipe_hitung'] === 'flat' ? 'Flat' : ($r['tipe_hitung'] === 'persen' ? '% Transaksi' : 'Per m²')); ?>
                                        ...
                                        <td class="text-center" style="white-space: nowrap;">
                                            <div class="form-check form-switch d-inline-block mb-0">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                    id="switchStatus_<?php echo e($r['id']); ?>"
                                                    <?php echo e($r['is_active'] ? 'checked' : ''); ?>

                                                    onchange='toggleStatusItem(<?php echo json_encode($r, 15, 512) ?>, this)'
                                                    title="<?php echo e($r['is_active'] ? 'Status: Aktif' : 'Status: Non-aktif'); ?>"
                                        ...
                                        <td class="text-center" style="white-space: nowrap;">
                                            <div class="d-inline-flex align-items-center gap-1">
                                                <button type="button" class="btn-action edit" title="Edit Aturan" onclick='editItemIni(<?php echo json_encode($r, 15, 512) ?>)'>
                                                    <i class="mdi mdi-pencil"></i>
                                                </button>
                                                <button type="button" class="btn-action delete" title="Hapus Aturan" onclick='hapusItemIni(<?php echo json_encode($r, 15, 512) ?>)'>
                        ...
                        <div class="row g-2.5">
                            ...
                            <div class="col-md-6">
                                ...
                                <datalist id="notarisDatalist">
                                    <?php $__currentLoopData = $notarisList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($n->nama_notaris); ?>">
                        ...
                        <div class="row g-2.5">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="proyek" id="input_proyek">
                                    ...
                                    <?php $__currentLoopData = $proyekList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    const masterRulesData = <?php echo json_encode($rules->values(), 15, 512) ?>;
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/keuangan/pembayaran/index.blade.php ENDPATH**/ ?>