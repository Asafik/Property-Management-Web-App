<?php $__env->startSection('title', 'Master Dokumen Perizinan & Legalitas Properti - Property Management App'); ?>
    ...
    <div class="row g-3 mb-3 mb-md-4">
        <div class="col-12 col-sm-6 col-md-3">
            <div class="card shadow-sm border-0 h-100 mb-0">
                <div class="card-body d-flex justify-content-between align-items-center p-3">
                    <div>
                        <h4 class="text-dark mb-1 fw-bold"><?php echo e($stats['total'] ?? 0); ?></h4>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="card shadow-sm border-0 h-100 mb-0">
                <div class="card-body d-flex justify-content-between align-items-center p-3">
                    <div>
                        <h4 class="text-success mb-1 fw-bold"><?php echo e($stats['active'] ?? 0); ?></h4>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="card shadow-sm border-0 h-100 mb-0">
                <div class="card-body d-flex justify-content-between align-items-center p-3">
                    <div>
                        <h4 class="text-warning mb-1 fw-bold" style="color: #ea580c !important;"><?php echo e($stats['required'] ?? 0); ?></h4>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="card shadow-sm border-0 h-100 mb-0">
                <div class="card-body d-flex justify-content-between align-items-center p-3">
                    <div>
                        <h4 class="text-info mb-1 fw-bold" style="color: #0d6efd !important;"><?php echo e(count($categories)); ?></h4>
                ...
                <div class="card-body p-3 p-md-4">
                    ...
                    <div class="filter-card mb-3 p-3" style="background-color: #fcfbfe; border: 1px solid #f0ecf8; border-radius: 10px;">
                        ...
                        <div class="filter-row-desktop d-none d-md-block">
                            <form id="filterForm" method="GET" action="<?php echo e(route('master.dokumen-perizinan.index')); ?>" onsubmit="return showFilterLoading()">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
                                        ...
                                        <div style="width: 150px;">
                                            <select class="form-control" name="is_required" id="requiredSelect">
                                                ...
                                                <option value="1" <?php echo e(request('is_required') === '1' ? 'selected' : ''); ?>>Wajib</option>
                                                <option value="0" <?php echo e(request('is_required') === '0' ? 'selected' : ''); ?>>Opsional</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2 ms-auto">
                                        <div style="width: 110px;">
                                            <select class="form-control" name="per_page" id="perPageSelect">
                                                <option value="10" <?php echo e(request('per_page', 15) == 10 ? 'selected' : ''); ?>>10 data</option>
                                                <option value="15" <?php echo e(request('per_page', 15) == 15 ? 'selected' : ''); ?>>15 data</option>
                                                <option value="25" <?php echo e(request('per_page', 15) == 25 ? 'selected' : ''); ?>>25 data</option>
                                                <option value="50" <?php echo e(request('per_page', 15) == 50 ? 'selected' : ''); ?>>50 data</option>
                                            </select>
                                        </div>
                                        ...
                                        <a href="<?php echo e(route('master.dokumen-perizinan.index')); ?>" class="btn btn-gradient-secondary btn-icon-only" title="Reset" onclick="showResetLoading(event)">
                        ...
                        <div class="filter-row-mobile d-block d-md-none">
                            <form method="GET" action="<?php echo e(route('master.dokumen-perizinan.index')); ?>" onsubmit="return showFilterLoading()">
                                <div class="row g-2">
                                    ...
                                    <div class="col-6">
                                        <a href="<?php echo e(route('master.dokumen-perizinan.index')); ?>" class="btn btn-gradient-secondary w-100 d-flex align-items-center justify-content-center gap-1" onclick="showResetLoading(event)">
                        ...
                        <table class="table table-hover align-middle mb-0" style="font-size: 0.88rem;">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sortable" data-field="kode_dokumen" data-direction="<?php echo e(request('sortField') == 'kode_dokumen' ? (request('sortDirection') == 'asc' ? 'desc' : 'asc') : 'asc'); ?>" style="cursor: pointer; width: 130px;">
                                        Kode
                                        <?php if(request('sortField') == 'kode_dokumen'): ?>
                                            <i class="mdi mdi-<?php echo e(request('sortDirection') == 'asc' ? 'arrow-up' : 'arrow-down'); ?>"></i>
                                        <?php else: ?>
                                            <i class="mdi mdi-swap-vertical text-muted"></i>
                                        <?php endif; ?>
                                    </th>
                                    <th class="sortable" data-field="nama_dokumen" data-direction="<?php echo e(request('sortField') == 'nama_dokumen' ? (request('sortDirection') == 'asc' ? 'desc' : 'asc') : 'asc'); ?>" style="cursor: pointer;">
                                        Nama Dokumen Perizinan
                                        <?php if(request('sortField') == 'nama_dokumen'): ?>
                                            <i class="mdi mdi-<?php echo e(request('sortDirection') == 'asc' ? 'arrow-up' : 'arrow-down'); ?>"></i>
                                        <?php else: ?>
                                            <i class="mdi mdi-swap-vertical text-muted"></i>
                                        <?php endif; ?>
                                    </th>
                                    <th class="sortable" data-field="kategori" data-direction="<?php echo e(request('sortField') == 'kategori' ? (request('sortDirection') == 'asc' ? 'desc' : 'asc') : 'asc'); ?>" style="cursor: pointer; width: 160px;">
                                        Kategori
                                        <?php if(request('sortField') == 'kategori'): ?>
                                            <i class="mdi mdi-<?php echo e(request('sortDirection') == 'asc' ? 'arrow-up' : 'arrow-down'); ?>"></i>
                                        <?php else: ?>
                                            <i class="mdi mdi-swap-vertical text-muted"></i>
                                        <?php endif; ?>
                                    ...
                                    <th class="text-center sortable" data-field="is_active" data-direction="<?php echo e(request('sortField') == 'is_active' ? (request('sortDirection') == 'asc' ? 'desc' : 'asc') : 'asc'); ?>" style="cursor: pointer; width: 95px;">
                                        Status
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($doc->deskripsi): ?>
                                                <div class="text-muted small text-truncate" style="max-width: 320px;" title="<?php echo e($doc->deskripsi); ?>">
                                                    <?php echo e($doc->deskripsi); ?>

                                                </div>
                                            <?php endif; ?>
                                            <?php if($doc->syarat_dokumen): ?>
                                                <div class="text-muted" style="font-size: 0.76rem;">
                                                    <i class="mdi mdi-file-outline text-primary me-1"></i>Syarat: <?php echo e(Str::limit($doc->syarat_dokumen, 40)); ?>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="badge rounded-2 fw-semibold px-2 py-1" style="<?php echo e($badgeStyle); ?> font-size: 0.78rem;">
                                                <?php echo e($doc->kategori); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <span class="small fw-semibold text-secondary">
                                                <i class="mdi mdi-office-building me-1 text-muted"></i><?php echo e($doc->instansi_terkait ?: '-'); ?>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex flex-column gap-1 align-items-center">
                                                <span class="badge bg-light text-dark border px-2 py-1" style="font-size: 0.76rem;">
                                                    <i class="mdi mdi-clock-outline me-1 text-muted"></i><?php echo e($doc->estimasi_hari ? $doc->estimasi_hari . ' hari' : '-'); ?>

                                                </span>
                                                <?php if($doc->estimasi_biaya > 0): ?>
                                                    <span class="fw-bold text-success" style="font-size: 0.8rem;">
                                                        Rp <?php echo e(number_format($doc->estimasi_biaya, 0, ',', '.')); ?>
                                        ...
                                        <td class="text-center">
                                            <div class="form-check form-switch d-inline-flex align-items-center justify-content-center p-0 m-0">
                                                <input class="form-check-input ms-0" type="checkbox" role="switch" 
                                                    ...
                                                    <?php echo e($doc->is_active ? 'checked' : ''); ?> 
                                                    onchange="toggleDocStatus(<?php echo e($doc->id); ?>, this)">
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="d-inline-flex align-items-center gap-1">
                                                <button class="btn-action edit" title="Edit Master Dokumen" onclick="openModal('edit', <?php echo e($doc->id); ?>)">
                                                    <i class="mdi mdi-pencil"></i>
                                                </button>
                                                <button class="btn-action delete" title="Hapus Master Dokumen" onclick="confirmDelete(<?php echo e($doc->id); ?>)">
                    ...
                    <!-- Pagination -->
                    <?php if($documents instanceof \Illuminate\Pagination\LengthAwarePaginator && $documents->total() > 0): ?>
                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center mt-4">
                            <div class="pagination-info mb-2 mb-sm-0 text-muted" style="font-size: 0.82rem;">
                                Menampilkan <?php echo e($documents->firstItem()); ?> - <?php echo e($documents->lastItem()); ?> dari <?php echo e($documents->total()); ?> data master dokumen
                            </div>
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-sm flex-wrap justify-content-center mb-0">
                                    <li class="page-item <?php echo e($documents->onFirstPage() ? 'disabled' : ''); ?>">
                                        <a class="page-link" href="<?php echo e($documents->previousPageUrl()); ?>" <?php echo e(!$documents->onFirstPage() ? 'onclick=showPaginationLoading(event)' : ''); ?>>
                                            <i class="mdi mdi-chevron-left"></i>
                                        </a>
                                    </li>

                                    <?php for($page = 1; $page <= $documents->lastPage(); $page++): ?>
                                        <li class="page-item <?php echo e($page == $documents->currentPage() ? 'active' : ''); ?>">
                                            <?php if($page == $documents->currentPage()): ?>
                                                <span class="page-link"><?php echo e($page); ?></span>
                                            <?php else: ?>
                                                <a class="page-link" href="<?php echo e($documents->appends(request()->query())->url($page)); ?>" onclick="showPaginationLoading(event)"><?php echo e($page); ?></a>
                                            <?php endif; ?>
                                        </li>
                                    <?php endfor; ?>

                                    <li class="page-item <?php echo e($documents->hasMorePages() ? '' : 'disabled'); ?>">
                                        <a class="page-link" href="<?php echo e($documents->nextPageUrl()); ?>" <?php echo e($documents->hasMorePages() ? 'onclick=showPaginationLoading(event)' : ''); ?>>
...
function openModal(type, id = null) {
    if (type === 'tambah') {
        ...
        $('#formDokumenPerizinan').attr('action', '<?php echo e(route("master.dokumen-perizinan.store")); ?>');
        ...
        $.get('<?php echo e(url("master-data/dokumen-perizinan")); ?>/' + id + '/edit', function(data) {
            Swal.close();
            ...
            $('#formDokumenPerizinan').attr('action', '<?php echo e(url("master-data/dokumen-perizinan")); ?>/' + id);
...
function toggleDocStatus(id, checkbox) {
    ...
    $.ajax({
        url: '<?php echo e(url("master-data/dokumen-perizinan")); ?>/' + id + '/toggle-status',
        type: 'PATCH',
        data: {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                ...
                form.method = 'POST';
                form.action = '<?php echo e(url("master-data/dokumen-perizinan")); ?>/' + id;
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/master_data/dokumen_perizinan/index.blade.php ENDPATH**/ ?>