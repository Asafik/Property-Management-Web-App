<?php $__env->startSection('title', 'Marketing Jual Unit - Property Management App'); ?>
        ...
        <div class="row g-3 mb-4">
            <div class="col-6 col-md-3">
                <div class="card shadow-sm border-0 h-100 mb-0">
                    <div class="card-body d-flex justify-content-between align-items-center p-3">
                        <div>
                            <h3 class="text-dark mb-1 fw-bold"><?php echo e($totalUnits); ?></h3>
            ...
            <div class="col-6 col-md-3">
                <div class="card shadow-sm border-0 h-100 mb-0">
                    <div class="card-body d-flex justify-content-between align-items-center p-3">
                        <div>
                            <h3 class="text-dark mb-1 fw-bold"><?php echo e($totalTersedia); ?></h3>
            ...
            <div class="col-6 col-md-3">
                <div class="card shadow-sm border-0 h-100 mb-0">
                    <div class="card-body d-flex justify-content-between align-items-center p-3">
                        <div>
                            <h3 class="text-dark mb-1 fw-bold"><?php echo e($totalBooking); ?></h3>
            ...
            <div class="col-6 col-md-3">
                <div class="card shadow-sm border-0 h-100 mb-0">
                    <div class="card-body d-flex justify-content-between align-items-center p-3">
                        <div>
                            <h3 class="text-dark mb-1 fw-bold"><?php echo e($totalSold); ?></h3>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center py-3 px-3 px-md-4 gap-2 border-bottom">
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            ...
                            <!-- Export Buttons -->
                            <a href="<?php echo e(route('marketing.jual-unit.export.excel')); ?>"
                            ...
                            <a href="<?php echo e(route('marketing.jual-unit.export.pdf')); ?>" 
                    ...
                    <div class="card-body p-3 p-md-4">
                        ...
                        <div class="filter-card mb-3">
                            ...
                            <div class="filter-row-desktop d-none d-lg-block">
                                <form method="GET" action="<?php echo e(route('marketing.jual-unit')); ?>" id="filterForm">
                                    <?php if(request('sort')): ?>
                                        <input type="hidden" name="sort" value="<?php echo e(request('sort')); ?>">
                                    <?php endif; ?>
                                    <?php if(request('direction')): ?>
                                    ...
                                    <div class="row g-2 align-items-center w-100 m-0">
                                            ...
                                            <select name="project" class="form-control select2" id="projectSelect" style="width: 100%;">
                                                ...
                                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($p->id); ?>"
                                                        <?php echo e(request('project') == $p->id ? 'selected' : ''); ?>>
                                                        <?php echo e($p->name); ?>
                                        ...
                                        <div class="col-lg-2 col-xl-2 p-0 pe-2">
                                            <select name="jenis" class="form-control select2" id="jenisSelect" style="width: 100%;">
                                                ...
                                                <option value="subsidi"
                                                    <?php echo e(request('jenis') == 'subsidi' ? 'selected' : ''); ?>>Subsidi
                                                </option>
                                                <option value="komersil"
                                                    <?php echo e(request('jenis') == 'komersil' ? 'selected' : ''); ?>>Komersil
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-xl-2 p-0 pe-2">
                                            <select name="status" class="form-control select2" id="statusSelect" style="width: 100%;">
                                                ...
                                                <option value="ready"
                                                    <?php echo e(request('status') == 'ready' ? 'selected' : ''); ?>>Tersedia
                                                </option>
                                                <option value="booked"
                                                    <?php echo e(request('status') == 'booked' ? 'selected' : ''); ?>>Booking
                                                </option>
                                                <option value="sold"
                                        ...
                                        <div class="col-lg-3 col-xl-3 p-0 d-flex align-items-center justify-content-end gap-2 ms-auto">
                                            <div style="width: 100px;">
                                                <select name="perPage" class="form-control select2" id="perPageSelect" style="width: 100%;">
                                                    <option value="10"
                                                        <?php echo e(request('perPage') == 10 ? 'selected' : ''); ?>>10 Data
                                                    </option>
                                                    <option value="25"
                                                        <?php echo e(request('perPage') == 25 ? 'selected' : ''); ?>>25 Data
                                                    </option>
                                                    <option value="50"
                                                        <?php echo e(request('perPage') == 50 ? 'selected' : ''); ?>>50 Data
                                                    </option>
                                                    <option value="100"
                                                        <?php echo e(request('perPage') == 100 ? 'selected' : ''); ?>>100 Data
                                                    </option>
                                                </select>
                                            </div>
                                            <button type="submit"
                                            ...
                                            <a href="<?php echo e(route('marketing.jual-unit')); ?>"
                            ...
                            <div class="d-block d-lg-none">
                                <form method="GET" action="<?php echo e(route('marketing.jual-unit')); ?>" id="filterFormMobile">
                                    <?php if(request('sort')): ?>
                                        <input type="hidden" name="sort" value="<?php echo e(request('sort')); ?>">
                                    <?php endif; ?>
                                    <?php if(request('direction')): ?>
                        ...
                        <div id="tableView" style="display: block;">
                                ...
                                <table class="table table-hover align-middle">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sortable" data-field="block"
                                                data-direction="<?php echo e(request('sort') == 'block' ? (request('direction') == 'asc' ? 'desc' : 'asc') : 'asc'); ?>">
                                                Nama - Unit
                                                <?php if(request('sort') == 'block'): ?>
                                                    <i
                                                        class="mdi mdi-<?php echo e(request('direction') == 'asc' ? 'arrow-up' : 'arrow-down'); ?>"></i>
                                                <?php else: ?>
                                                    <i class="mdi mdi-swap-vertical"></i>
                                                <?php endif; ?>
                                            </th>
                                            <th class="sortable" data-field="jenis"
                                                data-direction="<?php echo e(request('sort') == 'jenis' ? (request('direction') == 'asc' ? 'desc' : 'asc') : 'asc'); ?>">
                                                Jenis & Tipe
                                                <?php if(request('sort') == 'jenis'): ?>
                                                    <i
                                                        class="mdi mdi-<?php echo e(request('direction') == 'asc' ? 'arrow-up' : 'arrow-down'); ?>"></i>
                                                <?php else: ?>
                                                    <i class="mdi mdi-swap-vertical"></i>
                                            ...
                                            <th class="sortable" data-field="agent_name"
                                                data-direction="<?php echo e(request('sort') == 'agent_name' ? (request('direction') == 'asc' ? 'desc' : 'asc') : 'asc'); ?>">
                                                Agent
                                                <?php if(request('sort') == 'agent_name'): ?>
                                                    <i
                                                        class="mdi mdi-<?php echo e(request('direction') == 'asc' ? 'arrow-up' : 'arrow-down'); ?>"></i>
                                                <?php else: ?>
                                                    <i class="mdi mdi-swap-vertical"></i>
                                            ...
                                            <th class="sortable" data-field="customer_name"
                                                data-direction="<?php echo e(request('sort') == 'customer_name' ? (request('direction') == 'asc' ? 'desc' : 'asc') : 'asc'); ?>">
                                                Customer
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            ?>
                                            <tr>
                                                <td class="fw-bold text-center"><?php echo e($units->firstItem() + $index); ?></td>
                                                <td>
                                                    <span class="icon-text">
                                                        <i class="mdi mdi-office-building"></i>
                                                        <span class="fw-bold"><?php echo e($unit->landBank->name ?? '-'); ?></span>
                                                    </span>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="fw-bold">
                                                            ...
                                                            <?php echo e($unit->unit_code ?? ($unit->block ?? '') . ' ' . ($unit->unit_number ?? '')); ?>

                                                        </span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <?php if(strtolower($unit->jenis ?? '') == 'subsidi'): ?>
                                                        <span class="badge badge-gradient-success">
                                                            <i class="mdi mdi-home-assistant me-1"></i><?php echo e($unit->jenis); ?>

                                                            -
                                                            <?php echo e($unit->type ?? '-'); ?>

                                                        </span>
                                                    <?php elseif(strtolower($unit->jenis ?? '') == 'komersil'): ?>
                                                        <span class="badge badge-gradient-primary">
                                                            <i
                                                                class="mdi mdi-office-building me-1"></i><?php echo e($unit->jenis); ?>
                                                    ...
                                                    <?php else: ?>
                                                        <span class="badge badge-gradient-secondary">
                                                            <i
                                                                class="mdi mdi-help-circle-outline me-1"></i><?php echo e(($unit->jenis ?? '-') . ' - ' . ($unit->type ?? '-')); ?>
                                                ...
                                                <td class="d-none d-md-table-cell">
                                                    <span class="icon-text">
                                                        ...
                                                        <span><?php echo e(Str::limit($unit->landBank->address ?? '-', 20)); ?></span>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="info-badge-icon land-badge">
                                                        <i class="mdi mdi-arrow-expand-all"></i><?php echo e($unit->area ?? '-'); ?>
                                                ...
                                                <td>
                                                    <span class="info-badge-icon building-badge">
                                                        <i
                                                            class="mdi mdi-home-floor-1"></i><?php echo e($unit->building_area ?? '-'); ?>

                                                    </span>
                                                </td>
                                                <td class="price-text">Rp
                                                    <?php echo e(number_format($unit->price ?? 0, 0, ',', '.')); ?>

                                                </td>
                                                <td class="fw-bold"><i
                                                        class="mdi mdi-compass-outline text-primary me-1"></i><?php echo e($unit->facing ?? '-'); ?>

                                                </td>
                                                <td>
                                                    <span class="badge-soft <?php echo e($statusBadge); ?>">
                                                ...
                                                <td>
                                                    <div class="progress-wrapper">
                                                        <div class="progress-row">
                                                            <div class="progress">
                                                                <div class="progress-bar-custom <?php echo e($progressClass); ?>"
                                                ...
                                                <td>
                                                    <?php if($unit->activeBooking && $unit->activeBooking->sales): ?>
                                                        <?php
                                                        ...
                                                        <div class="customer-info">
                                                            ...
                                                            <span><?php echo e($salesName); ?></span>
                                                        </div>
                                                    <?php else: ?>
                                                ...
                                                <td class="fee-text">
                                                    Rp
                                                    <?php echo e(number_format($unit->activeBooking->agent_fee ?? 0, 0, ',', '.')); ?>

                                                </td>
                                                <td>
                                                    <?php if($unit->activeBooking && $unit->activeBooking->customer): ?>
                                                        <?php
                                                ...
                                                <td class="fee-text">
                                                    Rp
                                                    <?php echo e(number_format($unit->activeBooking->booking_fee ?? 0, 0, ',', '.')); ?>
                                                ...
                                                <td class="text-center">
                                                    <div class="action-group">
                                                        <button class="btn-action view" title="Detail"
                                                            ...
                                                            data-unit_name="<?php echo e($unit->unit_name ?? '-'); ?>"
                                                            data-unit="<?php echo e($unit->unit_code); ?>"
                                                            data-unit_number="<?php echo e($unit->unit_number ?? '-'); ?>"
                                                            data-block="<?php echo e($unit->block ?? '-'); ?>"
                                                            data-jenis="<?php echo e($unit->jenis ?? '-'); ?>"
                                                            data-type="<?php echo e($unit->type ?? '-'); ?>"
                                                            data-address="<?php echo e($unit->landBank->address ?? '-'); ?>"
                                                            data-area="<?php echo e($unit->area ?? 0); ?>"
                                                            data-building="<?php echo e($unit->building_area ?? 0); ?>"
                                                            data-price="<?php echo e($unit->price ?? 0); ?>"
                                                            data-direction="<?php echo e($unit->facing ?? '-'); ?>"
                                                            data-status_raw="<?php echo e($unit->status); ?>"
                                                            data-status_text="<?php echo e($statusText); ?>"
                                                            data-construction="<?php echo e($unit->construction_progress ?? 'belum_mulai'); ?>"
                                                            data-has_booking="<?php echo e($unit->activeBooking ? '1' : '0'); ?>"
                                                            data-booking_id="<?php echo e($unit->activeBooking->id ?? ''); ?>"
                                                            data-customer="<?php echo e($unit->activeBooking->customer->full_name ?? '-'); ?>"
                                                            data-sales="<?php echo e($unit->activeBooking->sales->name ?? '-'); ?>"
                                                            data-booking_date="<?php echo e($unit->activeBooking ? \Carbon\Carbon::parse($unit->activeBooking->booking_date)->format('d F Y') : '-'); ?>"
                                                            data-booking_fee="<?php echo e($unit->activeBooking->booking_fee ?? 0); ?>"
                                                            data-agent_fee="<?php echo e($unit->activeBooking->agent_fee ?? 0); ?>"
                                                            data-booking_status="<?php echo e($unit->activeBooking->status ?? '-'); ?>">
                                                            <i class="mdi mdi-eye"></i>
                                                        </button>
                                                        <?php if(auth()->user()->position_id != 4): ?>
                                                            <button class="btn-action customer" title="Booking Unit / Pilih Customer"
                                                                onclick="openCustomerModal(<?php echo e($unit->id); ?>)">
                                                                <i class="mdi mdi-account-plus"></i>
                                                            </button>
                                                            <?php if(empty($isStaffMarketing)): ?>
                                                                <button class="btn-action agent" title="Pasang Agency & Komisi"
                                                                    onclick="openAgentModal(<?php echo e($unit->id); ?>)">
                            ...
                            <!-- PAGINATION - COMPACT -->
                            <?php if($units instanceof \Illuminate\Pagination\LengthAwarePaginator && $units->total() > 0): ?>
                                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center mt-3 pt-2">
                                    <div class="pagination-info mb-2 mb-sm-0">
                                        Menampilkan <?php echo e($units->firstItem()); ?> - <?php echo e($units->lastItem()); ?> dari <?php echo e($units->total()); ?> unit
                                    </div>
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination pagination-sm flex-wrap justify-content-center mb-0">
                                            ...
                                            <?php else: ?>
                                                <li class="page-item">
                                                    <a class="page-link"
                                                        href="<?php echo e($units->appends(request()->query())->previousPageUrl()); ?>"
                                            ...
                                            <?php $__currentLoopData = $units->getUrlRange(max(1, $units->currentPage() - 2), min($units->lastPage(), $units->currentPage() + 2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($page == $units->currentPage()): ?>
                                                ...
                                                <?php else: ?>
                                                    <li class="page-item">
                                                        <a class="page-link"
                                                            href="<?php echo e($units->appends(request()->query())->url($page)); ?>"><?php echo e($page); ?></a>
                                                    </li>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if($units->hasMorePages()): ?>
                                                <li class="page-item">
                                                    <a class="page-link"
                                                        href="<?php echo e($units->appends(request()->query())->nextPageUrl()); ?>"
                                        ...
                                        <div class="card grid-card h-100">
                                            <div class="card-body p-3">
                                                    ...
                                                    <?php else: ?>
                                                        <span
                                                            class="badge badge-gradient-warning position-absolute top-0 end-0 m-2"><i
                                                                class="mdi mdi-clock-outline me-1"></i><?php echo e(ucfirst($unit->status)); ?></span>
                                                    <?php endif; ?>
                                                ...
                                                <h6 class="mt-2 fw-bold"><i
                                                        class="mdi mdi-home-variant text-primary me-1"></i><?php echo e($unit->unit_name ?? '-'); ?>
                                                ...
                                                <p class="text-muted small mb-1"><i
                                                        class="mdi mdi-office-building me-1"></i><?php echo e($unit->landBank->name ?? '-'); ?>

                                                </p>
                                                <p class="small mb-1"><i
                                                        class="mdi mdi-ruler-square me-1"></i><?php echo e($unit->building_area ?? ($unit->area ?? '-')); ?>

                                                    mÂ² | <i class="mdi mdi-currency-usd me-1"></i>Rp
                                                    <?php echo e(number_format($unit->price ?? 0, 0, ',', '.')); ?></p>
                                                ...
                                                <div class="mt-2 border-top pt-2">
                                                    <?php if($unit->activeBooking && $unit->activeBooking->customer): ?>
                                                        ...
                                                        <div class="customer-info mb-1">
                                                            ...
                                                            <small
                                                                class="text-muted fw-bold"><?php echo e(Str::limit($customerName, 15)); ?></small>
                                                        </div>
                                                    <?php else: ?>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mt-1">
                                                    <?php if($unit->activeBooking && $unit->activeBooking->sales): ?>
                                                        ...
                                                        <div class="customer-info">
                                                            ...
                                                            <small
                                                                class="text-muted fw-bold"><?php echo e(Str::limit($salesName, 15)); ?></small>
                                                        </div>
                                                    <?php else: ?>
                                                    ...
                                                    <button class="btn btn-outline-danger btn-sm"
                                                        onclick="openCustomerModal(<?php echo e($unit->id); ?>)"><i
                        ...
                        <div id="denahView" style="display: none;">
                            <div class="denah-container">
                                <div style="display:flex; flex-wrap:wrap; justify-content:center; gap:10px;">
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $unitsByProject; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectName => $projectUnits): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $blokKavlings = [];
                                        ...
                                        <div
                                            ...
                                            <h6 class="text-primary mb-3"><i
                                                ...
                                                <?php echo e($projectName); ?></h6>
                                            <?php $__currentLoopData = $allBloks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div style="margin-bottom:15px; width:100%;">
                                                    ...
                                                    ?>
                                                    <strong style="font-size: 14px;">Blok <?php echo e($blok); ?> -
                                                        <?php echo e($labelType); ?> <small
                                                            class="text-muted ms-2">(<?php echo e(count($blokKavlings[$blok])); ?>
                                                    ...
                                                    <div
                                                        ...
                                                        <?php for($i = 1; $i <= $maxNum; $i++): ?>
                                                            ...
                                                            ?>
                                                            <span class="unit-box"
                                                                style="background-color: <?php echo e($bgColor); ?>; border: <?php echo e($borderStyle); ?>; <?php echo e($extraStyle); ?>"
                                                                title="<?php echo e($unitFound ? $unitFound->unit_code . ' - ' . ucfirst($unitFound->status) : 'Unit ' . $blok . '.' . $i . ' belum tersedia'); ?>">
                                                                <?php if($typeBadge): ?>
                                                                    <span
                                                                        class="type-badge-small"><?php echo e($typeBadge); ?></span>
                                                                <?php endif; ?>
                                                                <i
                                                                    class="mdi mdi-<?php echo e($icon); ?> me-1"></i><?php echo e($blok . '.' . $i); ?>
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-grow-1" style="max-width: 450px;">
                                        ...
                                        <select id="siteplanProjectSelect" class="form-control select2" style="width: 100%;">
                                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                ?>
                                                <option value="<?php echo e($p->id); ?>"
                                                    data-denah="<?php echo e($denahUrl); ?>"
                                                    data-name="<?php echo e($p->name); ?>"
                                                    <?php echo e((request('project') == $p->id || (empty(request('project')) && $loop->first)) ? 'selected' : ''); ?>>
                                                    <?php echo e($p->name); ?> <?php echo e(!empty($denahUrl) ? ' (✓ Denah Terunggah)' : ' (Denah Default)'); ?>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="timeline-detail-card" id="m_booking_card">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12 mt-3 pt-2 border-top d-flex flex-wrap justify-content-between align-items-center gap-2">
                                                    <div class="text-muted small">
                                                        <i class="mdi mdi-receipt-text-check-outline text-success me-1"></i> Bukti Pembayaran Resmi Uang Tanda Jadi (UTJ)
                                                    </div>
                                                    <div>
                                                        <a href="#" id="m_btn_cetak_kuitansi" target="_blank" class="btn btn-sm btn-gradient-primary d-inline-flex align-items-center gap-1 shadow-sm px-3 py-2" style="border-radius: 6px; font-weight: 600; text-decoration: none;">
                                                            <i class="mdi mdi-printer me-1" style="font-size: 1.1rem;"></i> Cetak Kuitansi UTJ
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal-content border-0 shadow-lg" style="border-radius: 14px; overflow: hidden;">
                    <div class="modal-header bg-light border-bottom" style="padding: 1.1rem 1.4rem;">
                        <div>
                            ...
                            <small class="text-muted" style="font-size: 0.78rem;">Pilih Customer pembeli unit dan rincian transaksi booking</small>
                        </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2-customer-modal" id="select_customer_id" name="customer_id" style="width: 100%;" required>
                                    ...
                                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($c->id); ?>" data-id="<?php echo e($c->customer_id ?? ''); ?>">
                                            <?php if(!empty($c->customer_id)): ?> [<?php echo e($c->customer_id); ?>] <?php endif; ?> <?php echo e($c->full_name); ?>
                ...
                <div class="modal-content border-0 shadow-lg" style="border-radius: 14px; overflow: hidden;">
                    <div class="modal-header bg-light border-bottom" style="padding: 1.1rem 1.4rem;">
                        <div>
                            ...
                            <small class="text-muted" style="font-size: 0.78rem;">Pilih Agency / Sales Agent dan tetapkan komisi fee untuk unit terpilih</small>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2-agency-modal" id="select_sales_id" name="sales_id" style="width: 100%;" required>
                                    ...
                                    <?php $__currentLoopData = $agencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($a->id); ?>" data-phone="<?php echo e($a->phone ?? ''); ?>" data-address="<?php echo e($a->address ?? ''); ?>">
                                            <?php echo e($a->name); ?> <?php if(!empty($a->phone)): ?> (<?php echo e($a->phone); ?>) <?php endif; ?>
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                    ...
                    <div class="modal-footer bg-white border-top px-3 py-2.5 d-flex justify-content-end gap-2">
                        <button type="button" class="btn btn-sm btn-light border px-3" data-bs-dismiss="modal" style="border-radius: 8px; font-weight: 600;">
                            Batal
                        </button>
                        <button type="button" class="btn btn-sm btn-gradient-primary px-4 fw-bold shadow-sm" id="btnSimpanAgencyOnly" style="border-radius: 8px;">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        window.commissionRules = <?php echo json_encode($commissionRules, 15, 512) ?>;
        window.catalogUnitsMap = {
            <?php $__currentLoopData = $unitsForSvg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo e($u->id); ?>: {
                id: <?php echo e($u->id); ?>,
                unit_code: "<?php echo e($u->unit_code); ?>",
                unit_name: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($u->unit_name ?? ''))); ?>",
                block: "<?php echo e($u->block); ?>",
                unit_number: "<?php echo e($u->unit_number); ?>",
                jenis: "<?php echo e($u->jenis ?? $u->type); ?>",
                type: "<?php echo e($u->type); ?>",
                price: <?php echo e($u->price ?? 0); ?>,
                land_bank_id: <?php echo e($u->land_bank_id ?? 'null'); ?>
        ...
        if (detailModal) {
            detailModal.addEventListener('show.bs.modal', function(event) {
                ...
                if (hasBooking) {
                    ...
                    // Tombol Cetak Kuitansi UTJ
                    const bookingId = button.getAttribute('data-booking_id');
                    const btnKuitansi = document.getElementById('m_btn_cetak_kuitansi');
                    if (btnKuitansi) {
                        if (bookingId) {
                            btnKuitansi.href = "<?php echo e(url('dashboard-cetak-kuitansi-utj')); ?>/" + bookingId;
                            btnKuitansi.style.display = 'inline-flex';
                        } else {
                            btnKuitansi.style.display = 'none';
                        }
                    }
                }
            });
        ...
        const allUnitsData = [
            <?php $__currentLoopData = $unitsForSvg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {
                id: "<?php echo e($unit->id); ?>",
                land_bank_id: "<?php echo e($unit->land_bank_id); ?>",
                unitCode: "<?php echo e($unit->unit_code); ?>",
                unitName: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($unit->unit_name ?? '-'))); ?>",
                unitNumber: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($unit->unit_number ?? '-'))); ?>",
                block: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($unit->block ?? '-'))); ?>",
                jenis: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($unit->jenis ?? '-'))); ?>",
                type: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($unit->type ?? '-'))); ?>",
                address: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($unit->landBank->address ?? '-'))); ?>",
                area: <?php echo e($unit->area ?? 0); ?>,
                building: <?php echo e($unit->building_area ?? 0); ?>,
                price: <?php echo e($unit->price ?? 0); ?>,
                direction: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($unit->facing ?? '-'))); ?>",
                statusRaw: "<?php echo e($unit->status); ?>",
                statusText: "<?php echo e($unit->status == 'ready' || $unit->status == 'tersedia' ? 'Tersedia' : ($unit->status == 'sold' ? 'Terjual' : 'Booking')); ?>",
                construction: "<?php echo e($unit->construction_progress ?? 'belum_mulai'); ?>",
                hasBooking: <?php echo e($unit->activeBooking ? 1 : 0); ?>,
                bookingId: "<?php echo e($unit->activeBooking->id ?? ''); ?>",
                customer: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($unit->activeBooking->customer->full_name ?? '-'))); ?>",
                sales: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($unit->activeBooking->sales->name ?? '-'))); ?>",
                sales_id: "<?php echo e($unit->activeBooking->sales_id ?? ''); ?>",
                sales_name: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($unit->activeBooking->sales->name ?? ''))); ?>",
                sales_phone: "<?php echo e($unit->activeBooking->sales->phone ?? ''); ?>",
                bookingDate: "<?php echo e($unit->activeBooking ? \Carbon\Carbon::parse($unit->activeBooking->booking_date)->format('d F Y') : '-'); ?>",
                bookingFee: <?php echo e($unit->activeBooking->booking_fee ?? 0); ?>,
                agentFee: <?php echo e($unit->activeBooking->agent_fee ?? 0); ?>,
                bookingStatus: "<?php echo e(str_replace(["\r", "\n"], ' ', addslashes($unit->activeBooking->status ?? '-'))); ?>",
                pos_x: <?php echo e($unit->pos_x ?? 100); ?>,
                pos_y: <?php echo e($unit->pos_y ?? 100); ?>,
                width: <?php echo e($unit->width ?? 80); ?>,
                angle: <?php echo e($unit->angle ?? 0); ?>,
            },
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ];
        ...
        function loadProjectSiteplan(landBankId) {
            ...
            const denahUrl = (selectedOption && selectedOption.dataset && selectedOption.dataset.denah) ? selectedOption.dataset.denah : "<?php echo e(asset('images/siteplan.jpeg')); ?>";
        ...
        window.populateModalDirectly = function(data) {
            ...
            if (hasBooking) {
                ...
                if (btnKuitansi) {
                    if (data.bookingId) {
                        btnKuitansi.href = "<?php echo e(url('dashboard-cetak-kuitansi-utj')); ?>/" + data.bookingId;
                        btnKuitansi.style.display = 'inline-flex';
                    } else {
                        btnKuitansi.style.display = 'none';
                    }
        ...
        function savePosition() {
            ...
            fetch("<?php echo e(route('unit.save.position')); ?>", {
                    method: 'POST',
                    headers: {
        ...
        window.openCustomerModal = function(unitId) {
            ...
            $('#select_purchase_type').val('kpr').trigger('change');
            $('#booking_fee').val('');
            $('#bukti_transfer').val('');
            $('#buktiFileName').text('Upload Bukti Transfer UTJ');
            $('#buktiFileSize').text('');
        ...
        $(document).ready(function () {
            ...
            $('#bukti_transfer').on('change', function() {
                ...
                if (file) {
                    ...
                    $fileName.text('Upload Bukti Transfer UTJ');
                    $fileSize.text('');
            ...
            $('#btnSimpanCustomer').on('click', function(e) {
                ...
                let actionUrl = "<?php echo e(route('set.customer', ':unitId')); ?>".replace(':unitId', unitId);
            ...
            function submitAgencyAjax() {
                ...
                $.ajax({
                    url: "<?php echo e(url('marketing/set-agency')); ?>/" + unitId,
                    type: 'POST',
                    data: {
            ...
            $('#formCommissionRule').on('submit', function(e) {
                ...
                let isEdit = !!ruleId;
                let url = isEdit 
                    ? "<?php echo e(url('marketing/commission-rules')); ?>/" + ruleId
                    : "<?php echo e(route('marketing.commission-rules.store')); ?>";
            ...
            $(document).on('change', '.switch-rule-status', function() {
                ...
                $.ajax({
                    url: "<?php echo e(url('marketing/commission-rules')); ?>/" + id + "/toggle",
                    type: 'POST',
            ...
            $(document).on('click', '.btn-delete-rule', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(url('marketing/commission-rules')); ?>/" + id,
                            type: 'DELETE',
                            data: { _token: '<?php echo e(csrf_token()); ?>' },
                            success: function(res) {
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/marketing/jual_unit.blade.php ENDPATH**/ ?>