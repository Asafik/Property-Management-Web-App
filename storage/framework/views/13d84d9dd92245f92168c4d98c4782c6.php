<?php $__env->startSection('title', 'Sweet Home — Jual Rumah'); ?>
    ...
    <div class="hero-inner">
        <div class="hero-cols">
            ...
            <div class="search-card">
                ...
                <a href="<?php echo e(route('home.detail')); ?>" class="btn-search" style="text-decoration: none;">
        ...
        <div class="area-grid">
            <div class="area-card">
                ...
                <div class="area-overlay">
                    ...
                    <a href="<?php echo e(route('home.detail')); ?>" class="area-cta">Lihat <i class="fa-solid fa-arrow-right fa-xs"></i></a>
                </div>
            </div>
            <div class="area-card">
...
<div class="section" id="properti">
    <div class="shead">
        ...
        <a href="<?php echo e(route('home.detail')); ?>" class="link-all">Lihat semua <i class="fa-solid fa-arrow-right fa-xs"></i></a>
    </div>
    ...
    <div class="prop-grid">
        ...
        <div class="prop-card">
            <div class="prop-img">
                <a href="<?php echo e(route('home.detail')); ?>">
            ...
            <div class="prop-body">
                ...
                <h3 class="ptitle"><a href="<?php echo e(route('home.detail')); ?>" style="color: inherit; text-decoration: none;">Rumah Subsidi Ambulu</a></h3>
                <div class="pspecs">
                ...
                <a href="<?php echo e(route('home.detail')); ?>" class="btn-detail">Lihat Detail <i class="fa-solid fa-arrow-right fa-xs"></i></a>
            </div>
        </div>
        ...
        <div class="prop-card">
            ...
            <div class="prop-body">
                ...
                <h3 class="ptitle"><a href="<?php echo e(route('home.detail')); ?>" style="color: inherit; text-decoration: none;">Rumah Subsidi Patrang</a></h3>
                <div class="pspecs">
                    <div class="pspec"><i class="fa-solid fa-door-open"></i> 2 KT</div>
                    <span class="psep">·</span>
                    <div class="pspec"><i class="fa-solid fa-shower"></i> 1 KM</div>
        ...
        <div class="prop-card">
            ...
            <div class="prop-body">
                ...
                <h3 class="ptitle"><a href="<?php echo e(route('home.detail')); ?>" style="color: inherit; text-decoration: none;">Cluster Tegal Besar</a></h3>
                <div class="pspecs">
        ...
        <div class="prop-card">
            ...
            <div class="prop-body">
                ...
                <h3 class="ptitle"><a href="<?php echo e(route('home.detail')); ?>" style="color: inherit; text-decoration: none;">Cluster Kaliwates Residence</a></h3>
                <div class="pspecs">
                    <div class="pspec"><i class="fa-solid fa-door-open"></i> 3 KT</div>
                    <span class="psep">·</span>
                    <div class="pspec"><i class="fa-solid fa-shower"></i> 2 KM</div>
        ...
        <div class="prop-card">
            ...
            <div class="prop-body">
                ...
                <h3 class="ptitle"><a href="<?php echo e(route('home.detail')); ?>" style="color: inherit; text-decoration: none;">Rumah Sumbersari Indah</a></h3>
                <div class="pspecs">
                    <div class="pspec"><i class="fa-solid fa-door-open"></i> 3 KT</div>
                    <span class="psep">·</span>
                    <div class="pspec"><i class="fa-solid fa-shower"></i> 2 KM</div>
        ...
        <div class="prop-card">
            ...
            <div class="prop-body">
                ...
                <h3 class="ptitle"><a href="<?php echo e(route('home.detail')); ?>" style="color: inherit; text-decoration: none;">Rumah Kalisat Asri</a></h3>
                <div class="pspecs">
                    <div class="pspec"><i class="fa-solid fa-door-open"></i> 3 KT</div>
                    <span class="psep">·</span>
                    <div class="pspec"><i class="fa-solid fa-shower"></i> 2 KM</div>
...
<?php echo $__env->make('home.layouts.floating-wa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('home.layouts.partials.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/home/index.blade.php ENDPATH**/ ?>