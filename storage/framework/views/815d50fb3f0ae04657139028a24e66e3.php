<nav class="navbar">
  <div class="nav-inner">
    <a href="<?php echo e(route('landingpage')); ?>" class="nav-logo">
    ...
    <ul class="nav-links">
      <li>
        <a href="<?php echo e(route('landingpage')); ?>" class="active">
...
<div class="mobile-menu" id="mobileMenu">
  ...
  <a href="<?php echo e(route('landingpage')); ?>" onclick="closeMenu()">
...
<?php /**PATH F:\Property-Management-Web-App\resources\views/home/layouts/navbar.blade.php ENDPATH**/ ?>