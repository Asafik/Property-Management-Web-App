<?php $__env->startSection('title', 'Master Invoice Keuangan - Property Management App'); ?>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <div class="card shadow-sm border-0 h-100 mb-0">
                    <div class="card-body d-flex justify-content-between align-items-center p-3">
                        <div>
                            <h4 class="text-dark mb-1 fw-bold" style="font-size: 1.15rem;">Rp <?php echo e(number_format($stats['total_amount'], 0, ',', '.')); ?></h4>
                            <p class="text-muted mb-0" style="font-size: 0.85rem;">Total Akumulasi Tagihan</p>
                            <small class="text-muted" style="font-size: 0.78rem;"><?php echo e($stats['total_invoices_count']); ?> Transaksi Terdata</small>
                        </div>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <div class="card shadow-sm border-0 h-100 mb-0">
                    <div class="card-body d-flex justify-content-between align-items-center p-3">
                        <div>
                            <h4 class="text-success mb-1 fw-bold" style="font-size: 1.15rem;">Rp <?php echo e(number_format($stats['total_paid'], 0, ',', '.')); ?></h4>
                            <p class="text-muted mb-0" style="font-size: 0.85rem;">Realisasi Terbayar</p>
                            <small class="text-success fw-semibold" style="font-size: 0.78rem;"><?php echo e($stats['count_lunas']); ?> Invoice Lunas</small>
                        </div>
                        <div class="d-none d-sm-block">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <div class="card shadow-sm border-0 h-100 mb-0">
                    <div class="card-body d-flex justify-content-between align-items-center p-3">
                        <div>
                            <h4 class="text-danger mb-1 fw-bold" style="color: #ea580c !important; font-size: 1.15rem;">Rp <?php echo e(number_format($stats['total_remaining'], 0, ',', '.')); ?></h4>
                            <p class="text-muted mb-0" style="font-size: 0.85rem;">Sisa Tagihan Berjalan</p>
                            <small class="text-danger" style="font-size: 0.78rem;"><?php echo e($stats['count_partial'] + $stats['count_pending']); ?> Invoice Belum Lunas</small>
                        </div>
                        <div class="d-none d-sm-block">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <div class="card shadow-sm border-0 h-100 mb-0">
                    <div class="card-body d-flex justify-content-between align-items-center p-3">
                        <div>
                            <h4 class="text-primary mb-1 fw-bold" style="font-size: 1.15rem;"><?php echo e($stats['count_pra_landbank']); ?> Dokumen</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="filter-card mb-3">
                            ...
                            <div class="filter-row-desktop d-none d-md-block">
                                <form method="GET" action="<?php echo e(route('keuangan.master-invoice.index')); ?>" id="filterForm">
                                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 w-100">
                                        <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
                                            ...
                                            <div style="min-width: 200px; max-width: 260px; flex: 1;">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="search" id="searchInput"
                                                        placeholder="No Invoice, Penerima, Objek..." value="<?php echo e(request('search')); ?>"
                                            ...
                                            <div style="min-width: 170px;">
                                                <select class="form-select" name="category" onchange="document.getElementById('filterForm').submit()" style="height: 38px;">
                                                    ...
                                                    <option value="pra_landbank" <?php echo e(request('category') == 'pra_landbank' ? 'selected' : ''); ?>>Pra Land Bank (Lahan)</option>
                                                    <option value="unit_cash" <?php echo e(request('category') == 'unit_cash' ? 'selected' : ''); ?>>Unit Cash</option>
                                                    <option value="operasional" <?php echo e(request('category') == 'operasional' ? 'selected' : ''); ?>>Operasional</option>
                                                </select>
                                            </div>
                                            ...
                                            <div style="min-width: 135px;">
                                                <input type="date" class="form-control" name="start_date" value="<?php echo e(request('start_date')); ?>" title="Tanggal Mulai" style="height: 38px;">
                                            </div>

                                            <!-- Tanggal Akhir -->
                                            <div style="min-width: 135px;">
                                                <input type="date" class="form-control" name="end_date" value="<?php echo e(request('end_date')); ?>" title="Tanggal Akhir" style="height: 38px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 ms-auto">
                                            ...
                                            <a href="<?php echo e(route('keuangan.master-invoice.index')); ?>" class="btn btn-gradient-secondary btn-icon-only" title="Reset" onclick="showResetLoading(event)">
                            ...
                            <div class="filter-row-mobile d-block d-md-none">
                                <form method="GET" action="<?php echo e(route('keuangan.master-invoice.index')); ?>" id="filterFormMobile">
                                    <div class="row g-2">
                                        <div class="col-12 mb-2">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="search" placeholder="No Invoice, Penerima, Objek..." value="<?php echo e(request('search')); ?>" style="border-top-right-radius: 0 !important; border-bottom-right-radius: 0 !important; border-right: none; height: 38px;">
                                        ...
                                        <div class="col-6">
                                            <a href="<?php echo e(route('keuangan.master-invoice.index')); ?>" class="btn btn-gradient-secondary w-100 d-inline-flex align-items-center justify-content-center" style="height: 38px;" title="Reset">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php
                                            $percentPaid = $inv->total_amount > 0 ? min(100, round(($inv->paid_amount / $inv->total_amount) * 100)) : 0;
                                        ?>
                                        <tr>
                                            <td class="text-center text-muted fw-bold">
                                                <?php echo e($invoices->firstItem() + $idx); ?>
                                            ...
                                            <td>
                                                ...
                                                <small class="text-muted d-block" style="font-size: 11px;">
                                                    <i class="mdi mdi-calendar-blank me-1"></i><?php echo e($inv->invoice_date ? $inv->invoice_date->format('d/m/Y') : '-'); ?>

                                                </small>
                                            </td>
                                            <td>
                                                <?php if($inv->category === 'pra_landbank'): ?>
                                                    <span class="badge-cat badge-cat-pra">
                                                        <i class="mdi mdi-map-clock"></i> Pra Land Bank
                                                    </span>
                                                <?php elseif($inv->category === 'unit_cash'): ?>
                                                    <span class="badge-cat badge-cat-unit">
                                                        <i class="mdi mdi-home-outline"></i> Unit Cash
                                                    </span>
                                                <?php else: ?>
                                                    <span class="badge-cat badge-cat-ops">
                                                        <i class="mdi mdi-receipt"></i> <?php echo e(ucfirst($inv->category)); ?>
                                            ...
                                            <td>
                                                <div class="fw-bold text-dark" style="font-size: 0.88rem;">
                                                    <?php echo e($inv->title); ?>

                                                </div>
                                                <?php if($inv->praLandbank): ?>
                                                    <small class="text-muted d-block" style="font-size: 11px;">
                                                        <i class="mdi mdi-map-marker-outline"></i> <?php echo e($inv->praLandbank->city ?? 'Lokasi Lahan'); ?> (<?php echo e(number_format($inv->praLandbank->area ?? 0, 0, ',', '.')); ?> m²)
                                                    </small>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <div class="fw-semibold text-dark">
                                                    <?php echo e($inv->recipient_name ?? '-'); ?>

                                                </div>
                                                <?php if($inv->recipient_contact): ?>
                                                    <small class="text-muted d-block" style="font-size: 11px;">
                                                        <i class="mdi mdi-phone-outline"></i> <?php echo e($inv->recipient_contact); ?>
                                            ...
                                            <td class="text-end">
                                                <div class="fw-bold text-dark" style="font-size: 0.9rem;">
                                                    Rp <?php echo e(number_format($inv->total_amount, 0, ',', '.')); ?>

                                                </div>
                                                <small class="text-muted" style="font-size: 11px;">
                                                    Metode: <strong class="text-uppercase"><?php echo e($inv->payment_method ?? 'Cash'); ?></strong>
                                                </small>
                                            </td>
                                            <td class="text-end">
                                                <div class="fw-bold text-success" style="font-size: 0.85rem;">
                                                    Rp <?php echo e(number_format($inv->paid_amount, 0, ',', '.')); ?>

                                                </div>
                                                <?php if($inv->remaining_amount > 0): ?>
                                                    <div class="text-warning" style="font-size: 11px; font-weight: 600;">
                                                        Sisa: Rp <?php echo e(number_format($inv->remaining_amount, 0, ',', '.')); ?>

                                                    </div>
                                                <?php endif; ?>
                                                <div class="progress mt-1" style="height: 4px;" title="<?php echo e($percentPaid); ?>% Terbayar">
                                                    <div class="progress-bar <?php echo e($percentPaid >= 100 ? 'bg-success' : 'bg-warning'); ?>" role="progressbar" style="width: <?php echo e($percentPaid); ?>%"></div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <?php if($inv->payment_status === 'lunas'): ?>
                                            ...
                                            <td class="text-center">
                                                <div class="d-inline-flex gap-1">
                                                    ...
                                                    <button type="button" class="btn-action view" title="Lihat Detail Invoice" onclick="showInvoiceDetail(<?php echo e($inv->id); ?>)">
                                                        <i class="mdi mdi-eye"></i>
                                                    </button>

                                                    <!-- Tombol Cetak / PDF Format Resmi -->
                                                    <?php if($inv->pra_landbank_id): ?>
                                                        <a href="<?php echo e(route('pra-landbank.invoice', $inv->pra_landbank_id)); ?>" target="_blank" class="btn-action print" title="Cetak Format Resmi Pra Land Bank">
                                                            <i class="mdi mdi-printer"></i>
                                                        </a>
                                                    <?php else: ?>
                                                        <button type="button" class="btn-action print" title="Cetak Rincian Invoice" onclick="printInvoiceDirect(<?php echo e($inv->id); ?>)">
                                                            <i class="mdi mdi-printer"></i>
                                                        </button>
                                                    <?php endif; ?>

                                                    <!-- Tombol Edit / Update Pembayaran -->
                                                    <button type="button" class="btn-action edit" title="Update Pembayaran / Status" onclick="openEditModal(<?php echo e(json_encode($inv)); ?>)">
                                                        <i class="mdi mdi-pencil"></i>
                                                    </button>

                                                    <!-- Tombol Hapus -->
                                                    <button type="button" class="btn-action delete" title="Hapus Invoice" onclick="confirmDeleteInvoice(<?php echo e($inv->id); ?>, '<?php echo e($inv->invoice_number); ?>')">
                        ...
                        <?php if($invoices instanceof \Illuminate\Pagination\LengthAwarePaginator && $invoices->total() > 0): ?>
                            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center mt-4">
                                <div class="pagination-info mb-2 mb-sm-0">
                                    Menampilkan <?php echo e($invoices->firstItem()); ?> - <?php echo e($invoices->lastItem()); ?> dari
                                    <?php echo e($invoices->total()); ?> data
                                </div>
                                <nav aria-label="Page navigation">
                                    <ul class="pagination pagination-sm flex-wrap justify-content-center mb-0">
                                        ...
                                        <?php else: ?>
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="<?php echo e($invoices->appends(request()->query())->previousPageUrl()); ?>"
                                        ...
                                        <?php $__currentLoopData = $invoices->getUrlRange(max(1, $invoices->currentPage() - 2), min($invoices->lastPage(), $invoices->currentPage() + 2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php else: ?>
                                                <li class="page-item">
                                                    <a class="page-link"
                                                        href="<?php echo e($invoices->appends(request()->query())->url($page)); ?>"><?php echo e($page); ?></a>
                                                </li>
                                            <?php endif; ?>
                                        ...
                                        <?php if($invoices->hasMorePages()): ?>
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="<?php echo e($invoices->appends(request()->query())->nextPageUrl()); ?>"
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control" name="invoice_date" value="<?php echo e(date('Y-m-d')); ?>" required>
                            </div>
                            <div class="col-md-4">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        async function syncAllInvoices() {
            ...
            try {
                const res = await fetch("<?php echo e(route('keuangan.master-invoice.sync-all')); ?>", {
                    method: 'POST',
                    headers: {
        ...
        async function showInvoiceDetail(id) {
            ...
            try {
                const res = await fetch(`<?php echo e(url('/keuangan/master-invoice')); ?>/${id}`, {
                    headers: {
                        'Accept': 'application/json',
        ...
        async function submitCreateInvoice(e) {
            ...
            try {
                const res = await fetch("<?php echo e(route('keuangan.master-invoice.store')); ?>", {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                        'Accept': 'application/json',
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/keuangan/master_invoice/index.blade.php ENDPATH**/ ?>