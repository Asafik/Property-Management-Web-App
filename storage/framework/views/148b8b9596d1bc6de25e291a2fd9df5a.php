<?php $__env->startSection('title', 'Master Biaya Legalitas & Administrasi - Property Management App'); ?>
        ...
        <div class="dash-kpi-card">
            <div class="dash-kpi-left">
                ...
                <div class="dash-kpi-info">
                    ...
                    <div class="dash-kpi-val"><?php echo e($stats['total'] ?? 0); ?></div>
        ...
        <div class="dash-kpi-card">
            <div class="dash-kpi-left">
                ...
                <div class="dash-kpi-info">
                    ...
                    <div class="dash-kpi-val text-success"><?php echo e($stats['active'] ?? 0); ?></div>
        ...
        <div class="dash-kpi-card">
            <div class="dash-kpi-left">
                ...
                <div class="dash-kpi-info">
                    ...
                    <div class="dash-kpi-val" style="color: #0284c7;"><?php echo e($stats['standard'] ?? 0); ?></div>
        ...
        <div class="dash-kpi-card">
            <div class="dash-kpi-left">
                ...
                <div class="dash-kpi-info">
                    ...
                    <div class="dash-kpi-val text-danger"><?php echo e($stats['custom'] ?? 0); ?></div>
        ...
        <div class="col-12">
            <div class="card compact-table-card">
                ...
                <div class="card-header bg-white d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    <div>
                        <a href="<?php echo e(route('master.biaya-legalitas.create')); ?>" class="btn btn-sm btn-gradient-primary d-inline-flex align-items-center gap-1.5 px-3 py-1.5 fw-semibold shadow-sm" style="border-radius: 5px; font-size: 0.84rem;">
                ...
                <div class="card-body">
                    ...
                    <div class="filter-card mb-3">
                        <form id="filterForm" method="GET" action="<?php echo e(route('master.biaya-legalitas.index')); ?>">
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 w-100">
                                <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
                                    ...
                                    <div style="width: 180px;">
                                        <select class="form-control" name="kategori" id="categorySelect" onchange="document.getElementById('filterForm').submit()" style="height: 38px; border-radius: 5px;">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catKey => $catLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($catKey); ?>" <?php echo e(request('kategori') == $catKey ? 'selected' : ''); ?>><?php echo e($catKey); ?></option>
                                    ...
                                    <div style="width: 160px;">
                                        <select class="form-control" name="tipe_perhitungan" id="tipeSelect" onchange="document.getElementById('filterForm').submit()" style="height: 38px; border-radius: 5px;">
                                            ...
                                            <option value="nominal_tetap" <?php echo e(request('tipe_perhitungan') == 'nominal_tetap' ? 'selected' : ''); ?>>Nominal Tetap</option>
                                            <option value="persentase" <?php echo e(request('tipe_perhitungan') == 'persentase' ? 'selected' : ''); ?>>Persentase (%)</option>
                                            <option value="fleksibel" <?php echo e(request('tipe_perhitungan') == 'fleksibel' ? 'selected' : ''); ?>>Fleksibel</option>
                                        </select>
                                    </div>
                                    ...
                                    <div style="width: 140px;">
                                        <select class="form-control" name="is_standard" id="standardSelect" onchange="document.getElementById('filterForm').submit()" style="height: 38px; border-radius: 5px;">
                                            ...
                                            <option value="1" <?php echo e(request('is_standard') === '1' ? 'selected' : ''); ?>>Baku Standar</option>
                                            <option value="0" <?php echo e(request('is_standard') === '0' ? 'selected' : ''); ?>>Tambahan</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2 ms-auto">
                                    ...
                                    <?php if(request()->hasAny(['search', 'kategori', 'tipe_perhitungan', 'status', 'is_standard', 'per_page'])): ?>
                                        <a href="<?php echo e(route('master.biaya-legalitas.index')); ?>" class="btn btn-gradient-secondary btn-icon-only" title="Reset Filter" style="height: 38px; width: 38px; border-radius: 5px;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle table-perizinan">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $biayas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                    ...
                                    ?>
                                    <tr class="biaya-table-row" data-search="<?php echo e(strtolower($item->kode_biaya . ' ' . $item->nama_biaya . ' ' . $item->kategori . ' ' . $penanggungLabel)); ?>">
                                        <td class="col-no fw-bold text-center text-muted">
                                            <?php echo e($biayas->firstItem() + $index); ?>
                                        ...
                                        <td>
                                            <span class="badge font-monospace" style="background: #f8fafc; color: #334155; border: 1px solid #e2e8f0; font-size: 0.74rem; padding: 3px 6px; letter-spacing: 0.3px;">
                                                <?php echo e($item->kode_biaya); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <div class="fw-bold text-dark" style="font-size: 0.86rem; line-height: 1.35;">
                                                <?php echo e($item->nama_biaya); ?>

                                            </div>
                                            <?php if($item->deskripsi): ?>
                                                <div class="text-secondary small mt-0.5 text-truncate" style="font-size: 0.76rem; max-width: 320px;" title="<?php echo e($item->deskripsi); ?>">
                                        ...
                                        <td>
                                            <span class="badge <?php echo e($catClass); ?>">
                                                <?php echo e($item->kategori); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <?php if($item->tipe_perhitungan === 'nominal_tetap'): ?>
                                                <span class="badge d-inline-flex align-items-center gap-1 font-monospace fw-bold" style="background: #ecfdf5; color: #047857; border: 1px solid #a7f3d0; font-size: 0.83rem; padding: 4px 8px; border-radius: 5px;">
                                                    ...
                                                    <span>Rp <?php echo e(number_format($item->nominal_standar ?? 0, 0, ',', '.')); ?></span>
                                                </span>
                                            <?php elseif($item->tipe_perhitungan === 'persentase'): ?>
                                                <span class="badge d-inline-flex align-items-center gap-1 fw-bold" style="background: #fffbeb; color: #b45309; border: 1px solid #fde68a; font-size: 0.83rem; padding: 4px 8px; border-radius: 5px;">
                                                    ...
                                                    <span><?php echo e($item->persentase_standar); ?>% Deal</span>
                                                </span>
                                                <?php if($item->nominal_standar): ?>
                                                    <small class="text-muted d-block mt-0.5" style="font-size: 0.72rem;">(Est: Rp <?php echo e(number_format($item->nominal_standar, 0, ',', '.')); ?>)</small>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                ...
                                                <?php if($item->nominal_standar): ?>
                                                    <small class="text-muted d-block mt-0.5" style="font-size: 0.72rem;">Acuan: Rp <?php echo e(number_format($item->nominal_standar, 0, ',', '.')); ?></small>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <span class="badge <?php echo e($penanggungClass); ?>">
                                                <?php echo e($penanggungLabel); ?>

                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <?php if($item->is_standard): ?>
                                        ...
                                        <td class="text-center">
                                            <div class="form-check form-switch d-inline-block mb-0 custom-switch-clean">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                    id="switchStatus_<?php echo e($item->id); ?>"
                                                    <?php echo e($item->is_active ? 'checked' : ''); ?>

                                                    onchange="toggleActiveStatus(<?php echo e($item->id); ?>, this)"
                                                    title="<?php echo e($item->is_active ? 'Status: Aktif' : 'Status: Nonaktif'); ?>">
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="d-inline-flex align-items-center gap-1">
                                                <a href="<?php echo e(route('master.biaya-legalitas.edit', $item->id)); ?>" class="btn-action edit" title="Edit Biaya">
                                                    <i class="mdi mdi-pencil"></i>
                                                </a>
                                                <button type="button" class="btn-action delete" title="Hapus Biaya" onclick="deleteBiaya(<?php echo e($item->id); ?>, '<?php echo e(addslashes($item->nama_biaya)); ?>')">
                                    ...
                                    <tr>
                                        <td colspan="9" class="text-center py-5 text-muted">
                                            <div class="p-3">
                                                ...
                                                <a href="<?php echo e(route('master.biaya-legalitas.create')); ?>" class="btn btn-sm btn-gradient-primary px-3 py-1.5" style="border-radius: 5px;">
                    ...
                    <!-- Pagination -->
                    <?php if($biayas->hasPages()): ?>
                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center gap-2 mt-4 pt-3 border-top">
                            <small class="text-muted">
                                Menampilkan <?php echo e($biayas->firstItem()); ?> s/d <?php echo e($biayas->lastItem()); ?> dari <?php echo e($biayas->total()); ?> data
                            </small>
                            <div>
                                <?php echo e($biayas->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Property-Management-Web-App\resources\views/master_data/biaya_legalitas/index.blade.php ENDPATH**/ ?>