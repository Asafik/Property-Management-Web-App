<?php $__env->startSection('title', 'Dokumen Tanah Induk (LandBank) - Property Management App'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="filter-card mb-3">
                        ...
                        <div class="filter-row-desktop d-none d-md-block">
                            <form method="GET" action="<?php echo e(route('dokument.index')); ?>" onsubmit="return showFilterLoading()">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 w-100">
                                    <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
                                        ...
                                        <div style="width: 170px;">
                                            <select class="form-control" name="category" id="categorySelect">
                                                ...
                                                <option value="SHM" <?php echo e(request('category') == 'SHM' ? 'selected' : ''); ?>>SHM</option>
                                                <option value="AJB" <?php echo e(request('category') == 'AJB' ? 'selected' : ''); ?>>AJB / Hibah</option>
                                                <option value="APHB" <?php echo e(request('category') == 'APHB' ? 'selected' : ''); ?>>APHB</option>
                                                <option value="WARISAN" <?php echo e(request('category') == 'WARISAN' ? 'selected' : ''); ?>>Warisan</option>
                                                <option value="PETOK_C" <?php echo e(request('category') == 'PETOK_C' ? 'selected' : ''); ?>>Petok C</option>
                                            </select>
                                        </div>
                                        ...
                                        <div style="width: 170px;">
                                            <select class="form-control" name="has_expiry" id="expirySelect">
                                                ...
                                                <option value="yes" <?php echo e(request('has_expiry') == 'yes' ? 'selected' : ''); ?>>Ada Masa Berlaku</option>
                                                <option value="no" <?php echo e(request('has_expiry') == 'no' ? 'selected' : ''); ?>>Tanpa Masa Berlaku</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2 ms-auto">
                                        ...
                                        <a href="<?php echo e(route('dokument.index')); ?>" class="btn btn-gradient-secondary btn-icon-only" title="Reset" onclick="showResetLoading(event)">
                        ...
                        <div class="filter-row-mobile d-block d-md-none">
                            <form method="GET" action="<?php echo e(route('dokument.index')); ?>" onsubmit="return showFilterLoading()">
                                <div class="row g-2">
                                    ...
                                    <div class="col-6">
                                        <a href="<?php echo e(route('dokument.index')); ?>" class="btn btn-gradient-secondary w-100 d-flex align-items-center justify-content-center gap-1" onclick="showResetLoading(event)">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $documentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="text-center fw-bold"><?php echo e($documentTypes->firstItem() + $index); ?></td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <button class="btn-action edit me-1" title="Edit Dokumen" onclick="openModal('edit', <?php echo e($item->id); ?>)">
                                            <i class="mdi mdi-pencil"></i>
                                        </button>
                                        <button class="btn-action delete" title="Hapus Dokumen" onclick="confirmDelete(<?php echo e($item->id); ?>)">
                    ...
                    <!-- Pagination -->
                    <?php if($documentTypes instanceof \Illuminate\Pagination\LengthAwarePaginator && $documentTypes->total() > 0): ?>
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center mt-4">
                        <div class="pagination-info mb-2 mb-sm-0 text-muted" style="font-size: 0.82rem;">
                            Menampilkan <?php echo e($documentTypes->firstItem()); ?> - <?php echo e($documentTypes->lastItem()); ?> dari <?php echo e($documentTypes->total()); ?> data
                        </div>

                        <nav aria-label="Page navigation">
                            <ul class="pagination pagination-sm flex-wrap justify-content-center mb-0">
                                <li class="page-item <?php echo e($documentTypes->onFirstPage() ? 'disabled' : ''); ?>">
                                    <a class="page-link" href="<?php echo e($documentTypes->previousPageUrl()); ?>" <?php echo e(!$documentTypes->onFirstPage() ? 'onclick=showPaginationLoading(event)' : ''); ?>>
                                        <i class="mdi mdi-chevron-left"></i>
                                    </a>
                                </li>

                                <?php for($page = 1; $page <= $documentTypes->lastPage(); $page++): ?>
                                    <li class="page-item <?php echo e($page == $documentTypes->currentPage() ? 'active' : ''); ?>">
                                        <?php if($page == $documentTypes->currentPage()): ?>
                                            <span class="page-link"><?php echo e($page); ?></span>
                                        <?php else: ?>
                                            <a class="page-link" href="<?php echo e($documentTypes->appends(request()->query())->url($page)); ?>" onclick="showPaginationLoading(event)"><?php echo e($page); ?></a>
                                        <?php endif; ?>
                                    </li>
                                <?php endfor; ?>

                                <li class="page-item <?php echo e($documentTypes->hasMorePages() ? '' : 'disabled'); ?>">
                                    <a class="page-link" href="<?php echo e($documentTypes->nextPageUrl()); ?>" <?php echo e($documentTypes->hasMorePages() ? 'onclick=showPaginationLoading(event)' : ''); ?>>
...
function openModal(type, id = null) {
    if (type === 'tambah') {
        ...
        $('#formDokumen').attr('action', '<?php echo e(route("dokument.store")); ?>');
        ...
        $.get('<?php echo e(url("dokument")); ?>/' + id + '/edit', function(data) {
            Swal.close();
            ...
            $('#methodField').val('PUT');
            $('#formDokumen').attr('action', '<?php echo e(url("dokument")); ?>/' + id);
        ...
        preConfirm: () => {
            return new Promise((resolve) => {
                ...
                setTimeout(() => {
                    ...
                    form.method = 'POST';
                    form.action = '<?php echo e(url("dokument")); ?>/' + id;
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Property-Management-Web-App\resources\views/dokument/dokument.blade.php ENDPATH**/ ?>