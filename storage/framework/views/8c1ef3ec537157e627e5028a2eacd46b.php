<?php $__env->startSection('title', 'Lokasi Properti - Property Management App'); ?>
        ...
        <div class="dash-kpi-card">
            <div class="dash-kpi-left">
                ...
                <div class="dash-kpi-info">
                    ...
                    <div class="dash-kpi-val"><?php echo e($totalLandBanks ?? 0); ?></div>
        ...
        <div class="dash-kpi-card">
            <div class="dash-kpi-left">
                ...
                <div class="dash-kpi-info">
                    ...
                    <div class="dash-kpi-val"><?php echo e($totalReady ?? 0); ?></div>
        ...
        <div class="dash-kpi-card">
            <div class="dash-kpi-left">
                ...
                <div class="dash-kpi-info">
                    ...
                    <div class="dash-kpi-val"><?php echo e($totalBooked ?? 0); ?></div>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="card-toolbar-box p-3 border-bottom bg-white">
                        ...
                        <div class="d-none d-md-block">
                            <form method="GET" action="<?php echo e(route('lokasi.index')); ?>">
                                    ...
                                    <div class="d-flex align-items-center gap-2 ms-auto">
                                        <div style="width: 115px;">
                                            <select name="tampil" class="form-select" id="showSelect" onchange="this.form.submit()" style="height: 38px;">
                                                <option value="10" <?php echo e(request('tampil', 10) == 10 ? 'selected' : ''); ?>>10 data</option>
                                                <option value="25" <?php echo e(request('tampil') == 25 ? 'selected' : ''); ?>>25 data</option>
                                                <option value="50" <?php echo e(request('tampil') == 50 ? 'selected' : ''); ?>>50 data</option>
                                                <option value="100" <?php echo e(request('tampil') == 100 ? 'selected' : ''); ?>>100 data</option>
                                            </select>
                                        </div>
                                        ...
                                        <a href="<?php echo e(route('lokasi.index')); ?>" class="btn btn-gradient-secondary d-inline-flex align-items-center justify-content-center" style="width: 38px; height: 38px; padding: 0;" title="Reset">
                        ...
                        <div class="d-block d-md-none">
                            <form method="GET" action="<?php echo e(route('lokasi.index')); ?>">
                                <div class="row g-2">
                                    ...
                                    <div class="col-4">
                                        <a href="<?php echo e(route('lokasi.index')); ?>" class="btn btn-gradient-secondary w-100 d-inline-flex align-items-center justify-content-center" style="height: 38px;" title="Reset">
                                            <i class="mdi mdi-refresh"></i>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-lahan table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $landBanks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                        $searchKeywords = strtolower(($item->name ?? '') . ' ' . ($item->address ?? ''));
                                    ?>
                                    <tr class="project-table-row" data-search="<?php echo e($searchKeywords); ?>">
                                        <td class="col-no text-center fw-bold text-muted"><?php echo e($loop->iteration + ($landBanks->currentPage() - 1) * $landBanks->perPage()); ?></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <i class="mdi mdi-home-city text-primary me-2" style="font-size: 1.15rem;"></i>
                                                <span class="fw-bold text-dark" style="font-size: 0.88rem;"><?php echo e($item->name); ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="d-inline-flex align-items-center gap-1 text-muted" title="<?php echo e($item->address); ?>">
                                                <i class="mdi mdi-map-marker text-danger"></i>
                                                <span><?php echo e(Str::limit($item->address, 35)); ?></span>
                                            </span>
                                        </td>
                                        <td class="distance fw-semibold text-primary" data-lat="<?php echo e($item->lat); ?>" data-lng="<?php echo e($item->lng); ?>">
                                            <span class="text-muted">Menghitung...</span>
                                        </td>
                                        <td>
                                            <?php $st = strtolower($item->status ?? ''); ?>
                                            <?php if(str_contains($st, 'tersedia') || str_contains($st, 'available')): ?>
                                                <span class="badge-status available">
                                                    <i class="mdi mdi-check-circle-outline me-1"></i>Tersedia
                                                </span>
                                            <?php elseif(str_contains($st, 'booking') || str_contains($st, 'booked')): ?>
                                                <span class="badge-status booking">
                                                    <i class="mdi mdi-calendar-clock me-1"></i>Booking
                                                </span>
                                            <?php elseif(str_contains($st, 'terjual') || str_contains($st, 'sold')): ?>
                                                <span class="badge-status sold">
                                                    <i class="mdi mdi-close-circle-outline me-1"></i>Terjual
                                                </span>
                                            <?php else: ?>
                                                <span class="badge-status available">
                                                    <?php echo e($item->status ?? 'Tersedia'); ?>
                                        ...
                                        <td class="col-aksi text-center">
                                            <button type="button" class="btn-action fase2" title="Lihat Lokasi di Google Maps"
                                                onclick="flyToLocation(<?php echo e($item->lat ?? 0); ?>, <?php echo e($item->lng ?? 0); ?>, '<?php echo e(addslashes($item->name)); ?>')">
                    ...
                    <?php if($landBanks instanceof \Illuminate\Pagination\LengthAwarePaginator && $landBanks->total() > 0): ?>
                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center p-3 border-top bg-white">
                            <div class="pagination-info mb-2 mb-sm-0 text-muted" style="font-size: 0.84rem;">
                                Menampilkan <?php echo e($landBanks->firstItem() ?? 0); ?> - <?php echo e($landBanks->lastItem() ?? 0); ?> dari <?php echo e($landBanks->total()); ?> data
                            </div>
                            <div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $.getJSON("<?php echo e(route('lokasi.data')); ?>", function(locations) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/lokasi/lokasi.blade.php ENDPATH**/ ?>