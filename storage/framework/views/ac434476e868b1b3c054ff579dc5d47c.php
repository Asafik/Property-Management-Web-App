<?php $__env->startSection('title', 'Simulasi & Kalkulator Fee Otomatis - Property Management App'); ?>
...
<div class="container-fluid px-2 px-md-4 py-3">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-3">
        ...
        <div class="d-flex align-items-center gap-2 btn-no-print">
            <a href="<?php echo e(route('keuangan.pembayaran.index')); ?>" class="btn btn-sm btn-white border d-inline-flex align-items-center gap-1.5 px-3 py-2 shadow-sm fw-semibold" style="border-radius: 6px; font-size: 0.84rem; background: #ffffff; color: #334155;">
    ...
    <div class="card simulasi-card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row g-3 mb-4 p-3 bg-light rounded-3 border">
                <div class="col-md-7">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="sim_harga_transaksi" value="<?php echo e($defaultHarga); ?>" onkeyup="hitungSemuaFee()" onchange="hitungSemuaFee()">
                    </div>
                </div>
                <div class="col-md-5">
                    <label class="form-label fw-bold small text-dark mb-1">Luas Tanah (m²)</label>
                    <div class="input-group">
                        <input type="number" class="form-control" id="sim_luas_tanah" value="<?php echo e($defaultLuas); ?>" onkeyup="hitungSemuaFee()" onchange="hitungSemuaFee()">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3 pt-2 border-top btn-no-print">
                <a href="<?php echo e(route('keuangan.pembayaran.index')); ?>" class="btn btn-outline-secondary btn-sm px-3" style="border-radius: 6px; font-weight: 600;">
...
<script>
    ...
    const masterRulesData = <?php echo json_encode($rules, 15, 512) ?>;
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/keuangan/pembayaran/simulasi.blade.php ENDPATH**/ ?>