<?php $__env->startSection('title', 'Master Aturan Fee Agency - Property Management App'); ?>
            ...
            <div class="card border-0 shadow-sm p-3 h-100" style="border-radius: 12px; background: #ffffff;">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h4 class="fw-bold text-dark mb-0 mt-1" id="stat_total"><?php echo e($totalRules); ?></h4>
                    </div>
            ...
            <div class="card border-0 shadow-sm p-3 h-100" style="border-radius: 12px; background: #ffffff;">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h4 class="fw-bold text-success mb-0 mt-1" id="stat_active"><?php echo e($activeRules); ?></h4>
                    </div>
            ...
            <div class="card border-0 shadow-sm p-3 h-100" style="border-radius: 12px; background: #ffffff;">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h4 class="fw-bold text-primary mb-0 mt-1"><?php echo e($komersilRules); ?></h4>
                    </div>
            ...
            <div class="card border-0 shadow-sm p-3 h-100" style="border-radius: 12px; background: #ffffff;">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h4 class="fw-bold text-info mb-0 mt-1"><?php echo e($subsidiRules); ?></h4>
                    </div>
            ...
            <div class="card shadow-sm border-0" style="border-radius: 12px; overflow: hidden;">
                <div class="card-header bg-white d-flex justify-content-between align-items-center flex-wrap gap-2 py-3 px-3 px-md-4">
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
                        <a href="<?php echo e(route('marketing.jual-unit')); ?>" class="btn btn-sm btn-catalog-unit shadow-sm" title="Buka Halaman Catalog Unit">
                ...
                <div class="card-body p-3 p-md-4">
                    ...
                    <div class="filter-card mb-3">
                        ...
                        <div class="filter-row-desktop d-none d-md-block">
                            <form id="filterForm" method="GET" action="<?php echo e(route('marketing.commission-rules.index')); ?>" onsubmit="return showFilterLoading()">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 w-100">
                                    <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
                                        ...
                                        <div style="width: 145px;">
                                            <select class="form-select" name="target_type" id="targetTypeSelect">
                                                ...
                                                <option value="komersil" <?php echo e(request('target_type') == 'komersil' ? 'selected' : ''); ?>>Komersil</option>
                                                <option value="subsidi" <?php echo e(request('target_type') == 'subsidi' ? 'selected' : ''); ?>>Subsidi</option>
                                                <option value="all" <?php echo e(request('target_type') == 'all' ? 'selected' : ''); ?>>Semua Unit</option>
                                            </select>
                                        </div>
                                        ...
                                        <div style="min-width: 200px; max-width: 260px; flex: 1;">
                                            <select class="form-select select2-filter-project" name="land_bank_id" id="landBankSelect" style="width: 100%;">
                                                ...
                                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($prj->id); ?>" <?php echo e(request('land_bank_id') == $prj->id ? 'selected' : ''); ?>><?php echo e($prj->name); ?></option>
                                    ...
                                    <div class="d-flex align-items-center gap-2 ms-auto">
                                        ...
                                        <a href="<?php echo e(route('marketing.commission-rules.index')); ?>" class="btn btn-gradient-secondary btn-icon-only" title="Reset" onclick="showResetLoading(event)">
                        ...
                        <div class="filter-row-mobile d-block d-md-none">
                            <form method="GET" action="<?php echo e(route('marketing.commission-rules.index')); ?>" onsubmit="return showFilterLoading()">
                                <div class="row g-2">
                                    ...
                                    <div class="col-6">
                                        <a href="<?php echo e(route('marketing.commission-rules.index')); ?>" class="btn btn-gradient-secondary w-100 d-flex align-items-center justify-content-center gap-1" style="height: 38px;" onclick="showResetLoading(event)">
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $commissionRules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr id="page_rule_row_<?php echo e($rule->id); ?>">
                                        <td class="text-center fw-bold text-muted" style="font-size: 0.85rem;"><?php echo e($loop->iteration); ?></td>
                                        <td>
                                            <span class="fw-bold text-dark d-block" style="font-size: 0.92rem;"><?php echo e($rule->name); ?></span>
                                            <?php if($rule->description): ?>
                                                <small class="text-muted" style="font-size: 0.78rem;"><?php echo e($rule->description); ?></small>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($rule->land_bank_id): ?>
                                                <span class="badge" style="background: #e0f2fe !important; color: #0369a1 !important; border: 1px solid #bae6fd; font-weight: 700; font-size: 0.78rem; padding: 4px 8px; border-radius: 6px;">
                                                    <i class="mdi mdi-office-building me-1"></i><?php echo e($rule->landBank->name ?? '-'); ?>
                                        ...
                                        <td>
                                            <?php if($rule->target_type === 'komersil'): ?>
                                            ...
                                            <?php elseif($rule->target_type === 'subsidi'): ?>
                                        ...
                                        <td>
                                            <?php if($rule->calculation_type === 'percentage'): ?>
                                                <span class="fw-bold text-primary" style="font-size: 0.92rem;"><?php echo e(floatval($rule->value)); ?>%</span>
                                                <small class="text-muted d-block" style="font-size: 0.74rem;">dari Harga Jual</small>
                                            <?php else: ?>
                                                <span class="fw-bold text-success" style="font-size: 0.92rem;">Rp <?php echo e(number_format($rule->value, 0, ',', '.')); ?></span>
                                        ...
                                        <td class="text-center">
                                            <div class="form-check form-switch d-inline-block m-0">
                                                <input class="form-check-input switch-page-rule-status" type="checkbox" role="switch"
                                                    data-id="<?php echo e($rule->id); ?>" <?php echo e($rule->is_active ? 'checked' : ''); ?> style="cursor: pointer; width: 36px; height: 18px;">
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="d-inline-flex align-items-center gap-1">
                                                <button type="button" class="btn-action edit" title="Edit Aturan" onclick="openModalRule('edit', <?php echo e($rule->id); ?>)">
                                                    <i class="mdi mdi-pencil"></i>
                                                </button>
                                                <button type="button" class="btn-action delete" title="Hapus Aturan" onclick="confirmDeleteRule(<?php echo e($rule->id); ?>)">
                ...
                <div class="modal-body p-3 p-md-4" style="background: #f8fafc;">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select" id="m_rule_land_bank_id" name="land_bank_id" style="width: 100%;">
                            ...
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($prj->id); ?>"><?php echo e($prj->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/marketing/fee_agency.blade.php ENDPATH**/ ?>