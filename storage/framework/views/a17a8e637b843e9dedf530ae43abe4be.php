<?php $__env->startSection('title', 'Login — Sweet Home'); ?>
...
<div class="login-card">
  ...
  <div class="login-right">
    ...
    <form action="<?php echo e(route('login.proses')); ?>" method="POST" id="loginForm">
      <?php echo csrf_field(); ?>
      ...
      <div class="form-group">
        ...
        <div class="input-wrap">
          ...
          <input type="text" name="username" placeholder="Masukkan username Anda" value="<?php echo e(old('username')); ?>" required>
        </div>
      </div>
    ...
    <div class="login-footer">
      <div>&copy; <?php echo e(date('Y')); ?> Property Management. All rights reserved.</div>
    </div>
...
<?php echo $__env->make('home.layouts.partials.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Property-Management-Web-App\resources\views/auth/login.blade.php ENDPATH**/ ?>