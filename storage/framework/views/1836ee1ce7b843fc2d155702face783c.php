<?php $__env->startSection('title', 'Pencairan Dana KPR (Disbursement) - Property Management App'); ?>
...
<div class="container-fluid px-1 px-sm-2 px-md-3 py-2 py-md-3">
    ...
    <div class="row g-2 g-md-3 mb-3 mb-md-4">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <div class="card shadow-sm border-0 h-100 mb-0">
                <div class="card-body d-flex justify-content-between align-items-center p-3">
                    <div>
                        <h4 class="text-dark mb-1 fw-bold stat-value-text" style="font-size: 1.15rem;">Rp <?php echo e(number_format($totalPlafonKpr, 0, ',', '.')); ?></h4>
                        <p class="text-muted mb-0" style="font-size: 0.85rem;">Total Plafon KPR (Piutang)</p>
                        <small class="text-muted" style="font-size: 0.78rem;">Dari <?php echo e($totalUnitKpr); ?> unit skema KPR</small>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <div class="card shadow-sm border-0 h-100 mb-0">
                <div class="card-body d-flex justify-content-between align-items-center p-3">
                    <div>
                        <h4 class="text-success mb-1 fw-bold stat-value-text" style="font-size: 1.15rem;">Rp <?php echo e(number_format($totalDanaCair, 0, ',', '.')); ?></h4>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <div class="card shadow-sm border-0 h-100 mb-0">
                <div class="card-body d-flex justify-content-between align-items-center p-3">
                    <div>
                        <h4 class="text-danger mb-1 fw-bold stat-value-text" style="color: #ea580c !important; font-size: 1.15rem;">Rp <?php echo e(number_format($totalSisaPiutang, 0, ',', '.')); ?></h4>
            ...
            <div class="card shadow-sm border-0 h-100 mb-0">
                <div class="card-body d-flex justify-content-between align-items-center p-3">
                    <div class="w-100 pe-2">
                        <h4 class="text-primary mb-1 fw-bold stat-value-text" style="font-size: 1.15rem;"><?php echo e($pctTotal); ?>%</h4>
                        ...
                        <div class="progress mb-1" style="height: 5px; border-radius: 4px;">
                            <div class="progress-bar bg-gradient-primary" style="width: <?php echo e($pctTotal); ?>%;"></div>
                        </div>
    ...
    <?php if(session('error')): ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <i class="mdi mdi-alert-circle me-1"></i><?php echo e(session('error')); ?>
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white d-flex flex-wrap flex-md-row justify-content-between align-items-center gap-2 py-3 px-3 px-md-4">
                    ...
                    <span class="text-muted small">Total <strong><?php echo e($unitsData->total()); ?></strong> Unit Terdata</span>
                </div>
                ...
                <div class="card-body p-2.5 p-md-4">
                    ...
                    <div class="filter-card mb-3">
                        ...
                        <div class="filter-row-desktop d-none d-md-block">
                            <form method="GET" action="<?php echo e(route('finance.kpr-disbursement.index')); ?>" id="filterForm">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 w-100">
                                    <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
                                        ...
                                        <div style="min-width: 200px; max-width: 280px; flex: 1;">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="search" id="searchInput"
                                                    placeholder="Cari kavling, unit, konsumen..." value="<?php echo e(request('search')); ?>"
                                        ...
                                        <div style="min-width: 180px; max-width: 260px;">
                                            <select name="land_bank_id" class="form-select" onchange="this.form.submit()" style="height: 38px;">
                                                ...
                                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($p->id); ?>" <?php echo e(request('land_bank_id') == $p->id ? 'selected' : ''); ?>>
                                                        <?php echo e($p->name); ?> (<?php echo e($p->units_count); ?> Unit)
                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        ...
                                        <div style="min-width: 170px; max-width: 220px;">
                                            <select name="status_pencairan" class="form-select" onchange="this.form.submit()" style="height: 38px;">
                                                ...
                                                <option value="belum_cair" <?php echo e(request('status_pencairan') == 'belum_cair' ? 'selected' : ''); ?>>Belum Cair (0%)</option>
                                                <option value="termin" <?php echo e(request('status_pencairan') == 'termin' ? 'selected' : ''); ?>>Cair Sebagian (Termin)</option>
                                                <option value="lunas" <?php echo e(request('status_pencairan') == 'lunas' ? 'selected' : ''); ?>>Lunas / Selesai (100%)</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2 ms-auto">
                                        ...
                                        <a href="<?php echo e(route('finance.kpr-disbursement.index')); ?>" class="btn btn-gradient-secondary btn-icon-only" title="Reset Filter">
                        ...
                        <div class="filter-row-mobile d-block d-md-none">
                            <form method="GET" action="<?php echo e(route('finance.kpr-disbursement.index')); ?>" id="filterFormMobile">
                                <div class="row g-2">
                                    <div class="col-12">
                                        <div class="input-group">
                                    ...
                                    <div class="col-12">
                                        <select name="per_page" class="form-select" onchange="this.form.submit()" style="height: 38px;">
                                            <option value="10" <?php echo e(request('per_page', 10) == 10 ? 'selected' : ''); ?>>10 data per halaman</option>
                                            <option value="15" <?php echo e(request('per_page') == 15 ? 'selected' : ''); ?>>15 data per halaman</option>
                                            <option value="25" <?php echo e(request('per_page') == 25 ? 'selected' : ''); ?>>25 data per halaman</option>
                                            <option value="50" <?php echo e(request('per_page') == 50 ? 'selected' : ''); ?>>50 data per halaman</option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <a href="<?php echo e(route('finance.kpr-disbursement.index')); ?>" class="btn btn-gradient-secondary w-100 d-flex align-items-center justify-content-center gap-1" style="height: 38px;" title="Reset">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0 table-kpr">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $unitsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-center fw-bold text-muted"><?php echo e($unitsData->firstItem() + $idx); ?></td>
                                        <td>
                                            <div class="fw-bold text-dark" style="font-size: 0.9rem;">
                                                <?php echo e($row->unit->unit_name ?? 'Unit ' . $row->unit->unit_code); ?>

                                            </div>
                                            <small class="text-muted d-block" style="font-size: 11px;">
                                                <i class="mdi mdi-home-outline text-primary me-1"></i>Kode: <strong class="font-monospace text-primary"><?php echo e($row->unit->unit_code); ?></strong> | Tipe: <?php echo e($row->unit->type); ?>

                                            </small>
                                            <small class="text-muted d-block" style="font-size: 11px;">
                                                <i class="mdi mdi-map-marker-outline me-1"></i><?php echo e($row->unit->landBank->name ?? '-'); ?>

                                            </small>
                                        </td>
                                        <td>
                                            <div class="fw-semibold text-dark" style="font-size: 0.88rem;">
                                                <?php echo e($row->customer->full_name ?? '-'); ?>

                                            </div>
                                            <?php if($row->customer?->phone): ?>
                                                <small class="text-muted d-block" style="font-size: 11px;">
                                                    <i class="mdi mdi-phone-outline me-1"></i><?php echo e($row->customer->phone); ?>
                                        ...
                                        <td>
                                            <div class="fw-bold text-primary" style="font-size: 0.88rem;">
                                                <i class="mdi mdi-bank-outline me-1"></i><?php echo e($row->bankName); ?>

                                            </div>
                                            <?php if($row->kprApp?->bank?->number): ?>
                                                <small class="text-muted d-block" style="font-size: 11px;">
                                                    Rek: <?php echo e($row->kprApp->bank->number); ?>
                                        ...
                                        <td class="text-end">
                                            <div class="fw-bold text-dark font-monospace" style="font-size: 0.9rem;">
                                                Rp <?php echo e(number_format($row->hargaJual, 0, ',', '.')); ?>

                                            </div>
                                            <small class="text-success font-monospace d-block" style="font-size: 11px; font-weight: 600;">
                                                DP: Rp <?php echo e(number_format($row->dpKonsumen, 0, ',', '.')); ?>

                                            </small>
                                        </td>
                                        <td class="text-end font-monospace fw-bold text-primary" style="font-size: 0.9rem;">
                                            Rp <?php echo e(number_format($row->plafonKpr, 0, ',', '.')); ?>

                                        </td>
                                        <td class="text-end">
                                            <div class="fw-bold text-success font-monospace" style="font-size: 0.88rem;">
                                                Rp <?php echo e(number_format($row->totalCair, 0, ',', '.')); ?>

                                            </div>
                                            <div class="progress mt-1" style="height: 4px;" title="<?php echo e($row->persenCair); ?>% Terealisasi">
                                                <div class="progress-bar bg-success" style="width: <?php echo e($row->persenCair); ?>%;"></div>
                                            </div>
                                            <small class="text-muted" style="font-size: 10.5px;"><?php echo e($row->persenCair); ?>% terealisasi</small>
                                        </td>
                                        <td class="text-end font-monospace fw-bold <?php echo e($row->sisaCair > 0 ? 'text-warning' : 'text-muted'); ?>" style="font-size: 0.88rem;">
                                            Rp <?php echo e(number_format($row->sisaCair, 0, ',', '.')); ?>

                                        </td>
                                        <td class="text-center">
                                            <?php if($row->statusPencairan === 'lunas'): ?>
                                                <span class="badge-status-pill badge-status-lunas">
                                                    <i class="mdi mdi-check-circle-outline me-1"></i>Lunas
                                                </span>
                                            <?php elseif($row->statusPencairan === 'termin'): ?>
                                            ...
                                            <div class="d-inline-flex gap-1 align-items-center">
                                                <?php if($row->sisaCair > 0): ?>
                                                    <button type="button" class="btn btn-sm btn-gradient-success btn-open-disburse d-inline-flex align-items-center px-2.5 py-1.5 shadow-sm"
                                                        data-unit-id="<?php echo e($row->unit->id); ?>"
                                                        data-unit-title="<?php echo e(($row->unit->unit_name ?? $row->unit->unit_code) . ' - ' . ($row->customer->full_name ?? '-')); ?>"
                                                        data-plafon="<?php echo e($row->plafonKpr); ?>"
                                                        data-total-cair="<?php echo e($row->totalCair); ?>"
                                                        data-sisa-cair="<?php echo e($row->sisaCair); ?>"
                                                        data-bank-name="<?php echo e($row->bankName); ?>"
                                                        data-termin-count="<?php echo e(count($row->disbursements ?? []) + 1); ?>"
                                                ...
                                                <button type="button" class="btn-action view btn-open-history"
                                                    data-unit-title="<?php echo e(($row->unit->unit_name ?? $row->unit->unit_code) . ' - ' . ($row->customer->full_name ?? '-')); ?>"
                                                    data-history="<?php echo e(base64_encode(json_encode($row->disbursements ?? []))); ?>"
                    ...
                    <?php if($unitsData instanceof \Illuminate\Pagination\LengthAwarePaginator && $unitsData->total() > 0): ?>
                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center mt-4">
                            <div class="pagination-info mb-2 mb-sm-0 text-muted" style="font-size: 0.85rem;">
                                Menampilkan <?php echo e($unitsData->firstItem()); ?> - <?php echo e($unitsData->lastItem()); ?> dari
                                <?php echo e($unitsData->total()); ?> data
                            </div>
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-sm flex-wrap justify-content-center mb-0">
                                    
                                    <?php if($unitsData->onFirstPage()): ?>
                                    ...
                                    <?php else: ?>
                                        <li class="page-item">
                                            <a class="page-link"
                                                href="<?php echo e($unitsData->appends(request()->query())->previousPageUrl()); ?>"
                                    ...
                                    <?php $__currentLoopData = $unitsData->getUrlRange(max(1, $unitsData->currentPage() - 2), min($unitsData->lastPage(), $unitsData->currentPage() + 2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($page == $unitsData->currentPage()): ?>
                                        ...
                                        <?php else: ?>
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="<?php echo e($unitsData->appends(request()->query())->url($page)); ?>"><?php echo e($page); ?></a>
                                            </li>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                    
                                    <?php if($unitsData->hasMorePages()): ?>
                                        <li class="page-item">
                                            <a class="page-link"
                                                href="<?php echo e($unitsData->appends(request()->query())->nextPageUrl()); ?>"
...
<div class="modal fade" id="modalDisbursement" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 560px;">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 14px; overflow: hidden;">
            ...
            <form id="formDisbursement" method="POST" action="<?php echo e(route('finance.kpr-disbursement.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body p-3 p-md-4 bg-light">
                    ...
                    <div class="row g-2.5 mb-2.5">
                        <div class="col-md-6">
                            ...
                            <input type="date" name="tanggal_cair" id="disburse_tanggal" class="form-control form-control-sm" value="<?php echo e(date('Y-m-d')); ?>" required>
                        </div>
                        <div class="col-md-6">
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/keuangan/pencairan_kpr/index.blade.php ENDPATH**/ ?>