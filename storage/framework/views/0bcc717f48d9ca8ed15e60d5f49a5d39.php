...
<div class="container-fluid px-1 px-sm-2 px-md-3 py-2 py-md-3">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <a href="<?php echo e(route('perizinan.index')); ?>" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center gap-1.5 px-3 py-1.5 shadow-sm" style="border-radius: 6px; font-weight: 600;">
            <i class="mdi mdi-arrow-left"></i>
            <span>Kembali ke Daftar Proyek</span>
        </a>

        <span class="badge bg-light text-primary border px-2.5 py-1.5 fw-bold" style="font-size: 0.8rem;">
            <i class="mdi mdi-domain me-1"></i><?php echo e($project['nama']); ?>
            ...
            <div class="card shadow-sm border-0 h-100 p-3 bg-white" style="border-radius: 8px;">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold text-dark mb-0 mt-1"><?php echo e($totalIzin); ?></h4>
                    </div>
            ...
            <div class="card shadow-sm border-0 h-100 p-3 bg-white" style="border-radius: 8px;">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold text-success mb-0 mt-1"><?php echo e($totalTerbit); ?></h4>
                    </div>
            ...
            <div class="card shadow-sm border-0 h-100 p-3 bg-white" style="border-radius: 8px;">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold text-warning mb-0 mt-1"><?php echo e($totalProses); ?></h4>
                    </div>
            ...
            <div class="card shadow-sm border-0 h-100 p-3 bg-white" style="border-radius: 8px;">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold text-danger mb-0 mt-1"><?php echo e($totalRevisi); ?></h4>
                    </div>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <div class="filter-card mb-3">
                        <form id="filterForm" method="GET" action="<?php echo e(route('perizinan.show', $project['id'])); ?>">
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Property-Management-Web-App\resources\views/perizinan/show.blade.php ENDPATH**/ ?>