<?php $__env->startSection('title', 'Manajemen Proyek Kawasan - Property Management App'); ?>
...
<div class="container-fluid px-2 px-md-4 py-3">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="<?php echo e(route('properti')); ?>" class="btn btn-gradient-primary d-inline-flex align-items-center gap-1.5 px-3 py-2 fw-semibold shadow-sm" style="border-radius: 6px; font-size: 0.86rem;">
        ...
        <div class="dash-kpi-card">
            <div class="dash-kpi-left">
                ...
                <div class="dash-kpi-info">
                    ...
                    <div class="dash-kpi-val"><?php echo e($totalProjects ?? 0); ?></div>
        ...
        <div class="dash-kpi-card">
            <div class="dash-kpi-left">
                ...
                <div class="dash-kpi-info">
                    ...
                    <div class="dash-kpi-val"><?php echo e($totalLengkap ?? 0); ?></div>
        ...
        <div class="dash-kpi-card">
            <div class="dash-kpi-left">
                ...
                <div class="dash-kpi-info">
                    ...
                    <div class="dash-kpi-val"><?php echo e($totalBelumLengkap ?? 0); ?></div>
        ...
        <div class="dash-kpi-card">
            <div class="dash-kpi-left">
                ...
                <div class="dash-kpi-info">
                    ...
                    <div class="dash-kpi-val"><?php echo e($totalVerifiedDocs ?? 0); ?></div>
            ...
            <div class="card compact-table-card">
                ...
                <div class="card-body">
                    ...
                    <div class="filter-card">
                        <form id="filterForm" method="GET" action="<?php echo e(route('proyek.index')); ?>" style="margin-bottom: 0 !important;">
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 w-100">
                                <div class="d-flex flex-wrap align-items-center gap-2 flex-grow-1">
                                    ...
                                    <div style="min-width: 180px;">
                                        <select name="company_profile_id" class="form-control" onchange="document.getElementById('filterForm').submit()">
                                            ...
                                            <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($comp->id); ?>" <?php echo e(request('company_profile_id') == $comp->id ? 'selected' : ''); ?>>
                                    ...
                                    <div style="width: 170px;">
                                        <select class="form-control" name="profil_status" onchange="document.getElementById('filterForm').submit()">
                                            <option value="all" <?php echo e(request('profil_status') == 'all' ? 'selected' : ''); ?>>Semua Profil</option>
                                            <option value="lengkap" <?php echo e(request('profil_status') == 'lengkap' ? 'selected' : ''); ?>>Profil Lengkap (100%)</option>
                                            <option value="belum" <?php echo e(request('profil_status') == 'belum' ? 'selected' : ''); ?>>Perlu Dilengkapi</option>
                                        </select>
                                    </div>
                                    ...
                                    <div style="width: 160px;">
                                        <select class="form-control" name="legal_status" onchange="document.getElementById('filterForm').submit()">
                                            ...
                                            <option value="verified" <?php echo e(request('legal_status') == 'verified' ? 'selected' : ''); ?>>Terverifikasi</option>
                                            <option value="pending" <?php echo e(request('legal_status') == 'pending' ? 'selected' : ''); ?>>Menunggu Review</option>
                                            <option value="rejected" <?php echo e(request('legal_status') == 'rejected' ? 'selected' : ''); ?>>Revisi / Ditolak</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2 ms-auto">
                                    ...
                                    <a href="<?php echo e(route('proyek.index')); ?>" class="btn btn-gradient-secondary btn-icon-only" title="Reset Filter">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle table-proyek mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                    ...
                                    ?>
                                    <tr class="proyek-table-row" id="row_proyek_<?php echo e($item->id); ?>" 
                                        data-search="<?php echo e(strtolower($item->name . ' ' . ($item->companyProfile->name ?? '') . ' ' . ($item->address ?? '') . ' ' . ($item->city ?? '') . ' ' . ($item->district ?? ''))); ?>">
                                        ...
                                        <td>
                                            ...
                                            <div class="text-secondary mt-0.5 d-flex align-items-center gap-1" style="font-size: 0.77rem; line-height: 1.3;">
                                                ...
                                                <span><?php echo e($item->companyProfile->name ?? 'PT Pengembang Belum Dipilih'); ?></span>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="text-secondary" style="font-size: 0.82rem; line-height: 1.35;">
                                                ...
                                                <?php echo e($item->district ? $item->district . ', ' : ''); ?><?php echo e($item->city ?: ($item->address ?: 'Lokasi belum diisi')); ?>

                                            </div>
                                            <?php if($item->lat && $item->lng): ?>
                                                <small class="text-muted d-block mt-0.5" style="font-size: 0.72rem;">
                                                    <i class="mdi mdi-crosshairs-gps text-primary me-0.5"></i><?php echo e(round($item->lat, 4)); ?>, <?php echo e(round($item->lng, 4)); ?>
                                        ...
                                        <td>
                                            <div class="d-flex flex-column gap-1">
                                                <span class="badge bg-light text-dark px-2 py-1 border font-monospace" style="font-size: 0.76rem; width: fit-content;">
                                                    <i class="mdi mdi-texture-box text-muted me-1"></i><?php echo e(number_format($item->area ?? 0, 0, ',', '.')); ?> m²
                                                </span>
                                                <?php if($item->denah): ?>
                                                    <a href="<?php echo e(asset($item->denah)); ?>" target="_blank" class="text-primary text-decoration-none d-inline-flex align-items-center gap-1" style="font-size: 0.75rem; font-weight: 600;">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                                <button type="button" class="btn p-0 border-0 text-start" 
                                                    ...
                                                    data-bs-target="#modalChecklistProfil<?php echo e($item->id); ?>"
                                                    title="Klik untuk melihat checklist kelengkapan profil">
                                                    <span class="badge py-1 px-2 fw-semibold" 
                                                        style="font-size: 0.72rem; border-radius: 6px; background-color: <?php echo e($badgeBg); ?>; color: <?php echo e($badgeColor); ?>; border: 1px solid <?php echo e($badgeBorder); ?>; cursor: pointer;">
                                                        <i class="mdi <?php echo e($score >= 100 ? 'mdi-check' : 'mdi-alert-circle-outline'); ?> me-0.5"></i><?php echo e($badgeText); ?>

                                                    </span>
                                                </button>
                                                <span class="fw-bold" style="font-size: 0.75rem; color: #334155;"><?php echo e($score); ?>%</span>
                                            </div>
                                            <div class="progress" style="height: 6px; background-color: #e2e8f0; border-radius: 9999px;">
                                                <div class="progress-bar rounded-pill" role="progressbar" style="width: <?php echo e($score); ?>%; background-color: <?php echo e($barColor); ?>;"></div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center gap-1 px-2.5 py-1 border shadow-none" 
                                                data-bs-toggle="modal" 
                                                data-bs-target="#modalDokumenProyek<?php echo e($item->id); ?>"
                                                ...
                                                <span class="fw-bold"><?php echo e($docCount); ?></span>
                                            </button>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-1.5 mb-1">
                                                <div class="progress flex-grow-1" style="height: 5px; background-color: #e2e8f0; border-radius: 9999px;">
                                                    <div class="progress-bar rounded-pill bg-primary" role="progressbar" style="width: <?php echo e($devPercent); ?>%;"></div>
                                                </div>
                                                <span style="font-size: 0.72rem; font-weight: 700; color: #475569;"><?php echo e($devPercent); ?>%</span>
                                            </div>
                                            <a href="<?php echo e(route('properti.pengolahanLahan', $item->id)); ?>" class="text-decoration-none text-muted d-inline-flex align-items-center gap-1" style="font-size: 0.73rem; font-weight: 600;" title="Buka Detail Pengolahan Lahan Fisik">
...
<?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="modal fade" id="modalChecklistProfil<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 520px;">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 14px; overflow: hidden;">
                <div class="modal-header bg-white border-bottom px-4 py-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <small class="text-muted" style="font-size: 0.78rem;"><?php echo e($item->name); ?></small>
                        </div>
                    </div>
                ...
                <div class="modal-body px-4 py-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between p-3 mb-3" style="background: #f8fafc; border-radius: 10px; border: 1px solid #e2e8f0;">
                        <div>
                            ...
                            <div class="fw-bold text-dark" style="font-size: 1.25rem;"><?php echo e($item->profile_score); ?>% Lengkap</div>
                        </div>
                        <span class="badge py-1 px-3 fw-bold" style="font-size: 0.78rem; border-radius: 6px; background-color: <?php echo e($item->profile_score >= 100 ? '#ecfdf5' : '#fffbeb'); ?>; color: <?php echo e($item->profile_score >= 100 ? '#059669' : '#b45309'); ?>; border: 1px solid <?php echo e($item->profile_score >= 100 ? '#a7f3d0' : '#fde68a'); ?>;">
                            <?php echo e($item->profile_score >= 100 ? 'Siap Operasional' : 'Perlu Dilengkapi'); ?>
                    ...
                    <div class="mb-2">
                        ...
                        <?php $__currentLoopData = $item->core_profile_checklist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="profile-check-item <?php echo e($chk['is_filled'] ? 'is-valid' : 'is-invalid'); ?>">
                                <div class="d-flex align-items-center gap-2">
                                    <i class="mdi <?php echo e($chk['icon']); ?>" style="font-size: 1.1rem; color: <?php echo e($chk['is_filled'] ? '#16a34a' : '#dc2626'); ?>;"></i>
                                    <div>
                                        <div class="fw-semibold text-dark" style="font-size: 0.82rem;"><?php echo e($chk['label']); ?></div>
                                        <small class="text-muted" style="font-size: 0.73rem;">
                                            <?php echo e($chk['val'] ?? 'Belum diisi / belum diunggah'); ?>

                                        </small>
                                    </div>
                                </div>
                                <div>
                                    <?php if($chk['is_filled']): ?>
                ...
                <div class="modal-footer bg-light px-4 py-2.5 border-top d-flex justify-content-between">
                    ...
                    <a href="<?php echo e(route('properti.edit', $item->id)); ?>" class="btn btn-sm btn-gradient-primary fw-semibold px-3 d-inline-flex align-items-center gap-1" style="border-radius: 6px;">
    ...
    <div class="modal fade" id="modalDokumenProyek<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-body px-4 py-3">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $item->merged_documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="fw-semibold text-dark"><?php echo e($doc->documentType->name ?? ($doc->name ?? 'Dokumen Legalitas')); ?></div>
                                            </td>
                                            <td>
                                                <span class="font-monospace text-secondary"><?php echo e($doc->document_number ?: '-'); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge <?php echo e($dBadge); ?> py-1 px-2" style="font-size: 0.72rem; border-radius: 4px;">
                                                    <?php echo e($dLabel); ?>
                                            ...
                                            <td class="text-center">
                                                <?php if($doc->file_path): ?>
                                                    <a href="<?php echo e(asset($doc->file_path)); ?>" target="_blank" class="btn btn-sm btn-outline-primary py-0.5 px-2" style="font-size: 0.72rem; border-radius: 4px;">
                    ...
                    <?php else: ?>
                        <div class="text-center text-muted py-4">
                            ...
                            <a href="<?php echo e(route('properti.edit', $item->id)); ?>" class="btn btn-sm btn-gradient-primary px-3 fw-semibold" style="border-radius: 6px;">
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/proyek/index.blade.php ENDPATH**/ ?>