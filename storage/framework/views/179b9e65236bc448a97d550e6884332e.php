<?php $__env->startSection('title', 'Tambah Pasca Land Bank - Property Management App'); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('namaTanah')); ?>" placeholder="Contoh: Green Harmony Residence Tahap 2" required>
...
unset($__errorArgs, $__bag); ?>" required>
                                            ...
                                            <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($company->id); ?>" <?php echo e(old('company_profile_id') == $company->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" required>
                                            ...
                                            <option value="SHM" <?php echo e(old('statusKepemilikan') == 'SHM' ? 'selected' : ''); ?>>SHM (Sertifikat Hak Milik)</option>
                                            <option value="HGB" <?php echo e(old('statusKepemilikan') == 'HGB' ? 'selected' : ''); ?>>HGB (Hak Guna Bangunan)</option>
                                            <option value="HGU" <?php echo e(old('statusKepemilikan') == 'HGU' ? 'selected' : ''); ?>>HGU (Hak Guna Usaha)</option>
                                            <option value="HP" <?php echo e(old('statusKepemilikan') == 'HP' ? 'selected' : ''); ?>>HP (Hak Pakai)</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('lokasi')); ?>" placeholder="Contoh: Jl. Raya Kaliurang Km 9.5" required>
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('luasTanah')); ?>" min="0" step="0.01" placeholder="Contoh: 15000" required>
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('hargaPerolehan')); ?>" placeholder="1.500.000.000" required>
                                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('tanggalPerolehan', date('Y-m-d'))); ?>" required>
                                ...
                                <div class="properti-col-sm-6 properti-col-md-3">
                                    <div class="properti-form-group">
                                        ...
                                        <input type="text" name="kodePos" class="properti-form-control"
                                            value="<?php echo e(old('kodePos')); ?>" placeholder="55581">
                                    </div>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('zonasi')); ?>" placeholder="Contoh: Perumahan / Komersial">
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('lebarJalan')); ?>" step="0.1" min="0" placeholder="Contoh: 8.5">
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <option value="Aspal" <?php echo e(old('jenisJalan') == 'Aspal' ? 'selected' : ''); ?>>Aspal</option>
                                            <option value="Cor Beton" <?php echo e(old('jenisJalan') == 'Cor Beton' ? 'selected' : ''); ?>>Cor Beton</option>
                                            <option value="Paving Blok" <?php echo e(old('jenisJalan') == 'Paving Blok' ? 'selected' : ''); ?>>Paving Blok</option>
                                            <option value="Tanah" <?php echo e(old('jenisJalan') == 'Tanah' ? 'selected' : ''); ?>>Tanah</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="properti-checkbox-group">
                                    <div class="properti-checkbox-wrapper">
                                        <input type="checkbox" class="properti-checkbox-input" name="fasSekolah"
                                            id="fasSekolah" value="1" <?php echo e(old('fasSekolah') ? 'checked' : ''); ?>>
                                    ...
                                    <div class="properti-checkbox-wrapper">
                                        <input type="checkbox" class="properti-checkbox-input" name="fasRumahSakit"
                                            id="fasRumahSakit" value="1" <?php echo e(old('fasRumahSakit') ? 'checked' : ''); ?>>
                                    ...
                                    <div class="properti-checkbox-wrapper">
                                        <input type="checkbox" class="properti-checkbox-input" name="fasMall"
                                            id="fasMall" value="1" <?php echo e(old('fasMall') ? 'checked' : ''); ?>>
                                    ...
                                    <div class="properti-checkbox-wrapper">
                                        <input type="checkbox" class="properti-checkbox-input" name="fasTransportasi"
                                            id="fasTransportasi" value="1" <?php echo e(old('fasTransportasi') ? 'checked' : ''); ?>>
                            ...
                            <div class="properti-form-group mt-3">
                                ...
                                <textarea name="deskripsi" class="properti-form-control" rows="3" placeholder="Deskripsi ringkas properti..."><?php echo e(old('deskripsi')); ?></textarea>
                            </div>
                                        ...
                                        <div class="card h-100 border shadow-sm rounded-3 p-3 position-relative properti-doc-card-inner" style="background: #ffffff;">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3 pb-2 border-bottom">
                                                ...
                                                <div class="d-flex align-items-center gap-1 flex-wrap justify-content-end">
                                                    <span class="badge bg-light text-muted border py-1 px-2" id="doc_badge_<?php echo e($type->id); ?>" style="font-size: 10px;">
                                                        Belum Upload
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-2">
                                                <label class="form-label mb-1 text-muted" style="font-size: 0.78rem; font-weight: 600;">
                                                    Nomor Dokumen <?php echo e($type->name); ?>
                                                ...
                                                <input type="text" 
                                                    ...
                                                    value="<?php echo e(old('documents.'.$type->id.'.number')); ?>"
                                            ...
                                            <div class="mb-1 flex-grow-1 d-flex flex-column justify-content-end">
                                                ...
                                                <div class="pratanah-file-upload-modern">
                                                    <input type="file" name="documents[<?php echo e($type->id); ?>][file]" id="upload_<?php echo e($type->id); ?>" accept=".pdf,.jpg,.jpeg,.png" data-badge-id="doc_badge_<?php echo e($type->id); ?>" data-type-name="<?php echo e($type->name); ?>">
                                                    <div class="pratanah-file-label-modern py-2 px-2.5 rounded-3 d-flex align-items-center gap-2.5" style="border: 1.5px dashed #c4b5fd; background: #fdfcff; transition: all 0.2s ease;">
                                                        ...
                                                        <div class="pratanah-file-info-modern overflow-hidden">
                                                            <span class="file-label-text fw-bold text-primary text-truncate d-block" style="font-size: 0.80rem;">Pilih Berkas <?php echo e($type->name); ?></span>
...
unset($__errorArgs, $__bag); ?>" required>
                                            <option value="pending" <?php echo e(old('statusLegal') == 'pending' ? 'selected' : ''); ?>>Pending</option>
                                            <option value="verified" <?php echo e(old('statusLegal') == 'verified' ? 'selected' : ''); ?>>Lengkap</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>" required>
                                            <option value="Belum" <?php echo e(old('statusKavling', 'Belum') == 'Belum' ? 'selected' : ''); ?>>Belum</option>
                                            <option value="progress" <?php echo e(old('statusKavling') == 'progress' ? 'selected' : ''); ?>>Proses</option>
                                            <option value="Selesai" <?php echo e(old('statusKavling') == 'Selesai' ? 'selected' : ''); ?>>Selesai</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('fee_document_verification')); ?>"
                                ...
                                <div class="properti-col-md-6">
                                    <div class="properti-form-group">
                                        ...
                                        <input type="text" name="latitude" class="properti-form-control"
                                            value="<?php echo e(old('latitude', '-8.1727')); ?>" placeholder="Contoh: -8.1727">
                                    </div>
                                </div>
                                <div class="properti-col-md-6">
                                    <div class="properti-form-group">
                                        ...
                                        <input type="text" name="longitude" class="properti-form-control"
                                            value="<?php echo e(old('longitude', '113.7000')); ?>" placeholder="Contoh: 113.7000">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="properti-btn-group mt-4">
                                ...
                                <div class="btn-right">
                                    <button type="submit" class="properti-btn properti-btn-primary">
                                        <i class="fas fa-save mr-2"></i>Simpan Data Tanah
                                    </button>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const initialWilayah = {
                province: "<?php echo e(old('provinsi')); ?>",
                city: "<?php echo e(old('kota')); ?>",
                district: "<?php echo e(old('kecamatan')); ?>",
                village: "<?php echo e(old('kelurahan')); ?>"
            };
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/properti/tambah_properti.blade.php ENDPATH**/ ?>