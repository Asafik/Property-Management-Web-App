<?php $__env->startSection('title', 'Edit Properti - Properti Management'); ?>
                    ...
                    <div class="properti-card-body p-3 p-md-4 p-lg-5">
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4 pb-3 border-bottom">
                            <div>
                                <h4 class="properti-section-title mb-1 border-0 pb-0">
                                    ...
                                    Edit Data Tanah: <?php echo e($land->name); ?>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <a href="<?php echo e(route('properti-all')); ?>" class="btn-back-daftar">
                        ...
                        <div class="properti-nav-tab-wrapper">
                            ...
                            <button type="button" class="properti-nav-tab" id="tabBtnDokumen" onclick="switchPropertiTab('dokumen')">
                                ...
                                <span class="properti-tab-badge" id="nav_badge_total_docs"><?php echo e(count($workflowDocs ?? [])); ?></span>
                            </button>
                        </div>
                        ...
                        <form action="<?php echo e(route('properti.update', $land->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="properti-col-md-6">
                                    <div class="properti-form-group">
                                        ...
                                        <input type="text" name="namaTanah"
                                            class="properti-form-control <?php $__errorArgs = ['namaTanah'];
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('namaTanah', $land->name)); ?>" required>
                                        <?php $__errorArgs = ['namaTanah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            <div class="properti-text-danger"><?php echo e($message); ?></div>
                                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="properti-col-md-6">
                                    <div class="properti-form-group">
                                        ...
                                        <select name="company_profile_id" id="companySelect"
                                            class="properti-form-control <?php $__errorArgs = ['company_profile_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($company->id); ?>"
                                                    <?php echo e(old('company_profile_id', $land->company_profile_id ?? ($companies->first()->id ?? '')) == $company->id ? 'selected' : ''); ?>>
                                        ...
                                        <?php $__errorArgs = ['company_profile_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="properti-col-md-6">
                                    <div class="properti-form-group">
                                        ...
                                        <select name="statusKepemilikan"
                                            class="properti-form-control <?php $__errorArgs = ['statusKepemilikan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option value="SHM"
                                                <?php echo e(old('statusKepemilikan', $land->ownership_status ?? 'SHM') == 'SHM' ? 'selected' : ''); ?>>SHM (Sertifikat
                                                Hak Milik)</option>
                                            <option value="HGB"
                                                <?php echo e(old('statusKepemilikan', $land->ownership_status ?? 'SHM') == 'HGB' ? 'selected' : ''); ?>>HGB (Hak Guna
                                                Bangunan)</option>
                                            <option value="HGU"
                                                <?php echo e(old('statusKepemilikan', $land->ownership_status ?? 'SHM') == 'HGU' ? 'selected' : ''); ?>>HGU (Hak Guna
                                                Usaha)</option>
                                            <option value="HP"
                                                <?php echo e(old('statusKepemilikan', $land->ownership_status ?? 'SHM') == 'HP' ? 'selected' : ''); ?>>
                                                HP (Hak Pakai)</option>
                                        </select>
                                        <?php $__errorArgs = ['statusKepemilikan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="properti-form-group">
                                ...
                                <input type="text" name="lokasi"
                                    class="properti-form-control <?php $__errorArgs = ['lokasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('lokasi', $land->address)); ?>" placeholder="Jl. Contoh No. 123" required>
                                ...
                                <div class="properti-col-sm-6 properti-col-md-3">
                                    <div class="properti-form-group">
                                        ...
                                        <input type="number" name="luasTanah"
                                            class="properti-form-control <?php $__errorArgs = ['luasTanah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('luasTanah', $land->area)); ?>" min="0" step="0.01" required>
                                        <?php $__errorArgs = ['luasTanah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="properti-form-group">
                                        ...
                                        <div class="properti-input-group">
                                            ...
                                            <input type="text" name="hargaPerolehan"
                                                class="properti-form-control <?php $__errorArgs = ['hargaPerolehan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('hargaPerolehan', number_format($land->acquisition_price, 0, ',', '.'))); ?>" placeholder="1.000.000" required>
                                        </div>
                                        <?php $__errorArgs = ['hargaPerolehan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="properti-col-sm-6 properti-col-md-3">
                                    <div class="properti-form-group">
                                        ...
                                        <input type="date" name="tanggalPerolehan"
                                            class="properti-form-control <?php $__errorArgs = ['tanggalPerolehan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('tanggalPerolehan', $land->acquisition_date ? \Carbon\Carbon::parse($land->acquisition_date)->format('Y-m-d') : date('Y-m-d'))); ?>">
                                        <?php $__errorArgs = ['tanggalPerolehan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="properti-col-sm-6 properti-col-md-3">
                                    <div class="properti-form-group">
                                        ...
                                        <input type="text" name="kodePos" class="properti-form-control"
                                            value="<?php echo e(old('kodePos', $land->postal_code)); ?>" placeholder="12345">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="properti-col-md-4">
                                    <div class="properti-form-group">
                                        ...
                                        <input type="text" name="zonasi"
                                            class="properti-form-control <?php $__errorArgs = ['zonasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('zonasi', $land->zoning)); ?>" placeholder="Contoh: Perumahan">
                                        <?php $__errorArgs = ['zonasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="properti-col-md-4">
                                    <div class="properti-form-group">
                                        ...
                                        <input type="number" name="lebarJalan"
                                            class="properti-form-control <?php $__errorArgs = ['lebarJalan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('lebarJalan', $land->road_width)); ?>" step="0.1" min="0">
                                        <?php $__errorArgs = ['lebarJalan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="properti-col-md-4">
                                    <div class="properti-form-group">
                                        ...
                                        <select name="jenisJalan"
                                            class="properti-form-control <?php $__errorArgs = ['jenisJalan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <option value="Aspal" <?php echo e(in_array(strtolower(old('jenisJalan', $land->road_type ?? '')), ['aspal', 'aspal hotmix']) ? 'selected' : ''); ?>>
                                                Aspal</option>
                                            <option value="Cor Beton" <?php echo e(in_array(strtolower(old('jenisJalan', $land->road_type ?? '')), ['cor beton', 'beton', 'cor beton (rabat)']) ? 'selected' : ''); ?>>
                                                Cor Beton</option>
                                            <option value="Paving Blok" <?php echo e(in_array(strtolower(old('jenisJalan', $land->road_type ?? '')), ['paving', 'paving blok']) ? 'selected' : ''); ?>>
                                                Paving Blok</option>
                                            <option value="Tanah" <?php echo e(in_array(strtolower(old('jenisJalan', $land->road_type ?? '')), ['tanah', 'tanah / pengerasan']) ? 'selected' : ''); ?>>
                                                Tanah</option>
                                        </select>
                                        <?php $__errorArgs = ['jenisJalan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="properti-checkbox-group">
                                    <div class="properti-checkbox-wrapper">
                                        <input type="checkbox" class="properti-checkbox-input" name="fasSekolah"
                                            id="fasSekolah" value="1" <?php echo e(old('fasSekolah', $land->facility_school) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="properti-checkbox-wrapper">
                                        <input type="checkbox" class="properti-checkbox-input" name="fasRumahSakit"
                                            ...
                                            <?php echo e(old('fasRumahSakit', $land->facility_hospital) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="properti-checkbox-wrapper">
                                        <input type="checkbox" class="properti-checkbox-input" name="fasMall"
                                            id="fasMall" value="1" <?php echo e(old('fasMall', $land->facility_mall) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="properti-checkbox-wrapper">
                                        <input type="checkbox" class="properti-checkbox-input" name="fasTransportasi"
                                            ...
                                            <?php echo e(old('fasTransportasi', $land->facility_transport) ? 'checked' : ''); ?>>
                            ...
                            <div class="properti-form-group mt-3">
                                ...
                                <textarea name="deskripsi" class="properti-form-control" rows="3" placeholder="Deskripsi properti..."><?php echo e(old('deskripsi', $land->description)); ?></textarea>
                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4">
                                        <div class="card h-100 border shadow-sm rounded-3 p-3 position-relative fase4-doc-card-inner" style="background: #ffffff;">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3 pb-2 border-bottom">
                                                <div>
                                                    <h6 class="mb-0 fw-bold text-dark" style="font-size: 0.92rem;"><?php echo e($type->name); ?></h6>
                                                </div>
                                                <div class="d-flex align-items-center gap-1 flex-wrap justify-content-end">
                                                    <?php if($hasDoc && $isDocVerified): ?>
                                            ...
                                            <div class="mb-2">
                                                <label class="form-label mb-1 text-muted d-flex align-items-center justify-content-between" style="font-size: 0.78rem; font-weight: 600;">
                                                    <span>Nomor Dokumen <?php echo e($type->name); ?></span>
                                                    <?php if($isDocVerified && $existingDoc && $existingDoc->document_number): ?>
                                                ...
                                                <input type="text" 
                                                    name="documents[<?php echo e($type->id); ?>][number]"
                                                    class="form-control form-control-sm <?php echo e($isDocVerified ? 'bg-light text-muted' : ''); ?>" 
                                                    placeholder="Nomor <?php echo e($type->name); ?>"
                                                    value="<?php echo e(old('documents.'.$type->id.'.number', $existingDoc ? $existingDoc->document_number : '')); ?>"
                                                    style="font-size: 0.84rem;"
                                                    <?php echo e($isDocVerified ? 'readonly' : ''); ?>>
                                            </div>
                                            ...
                                            <div class="mb-1 flex-grow-1 d-flex flex-column justify-content-end">
                                                <?php if($hasDoc): ?>
                                                        ...
                                                        <div class="d-flex align-items-center gap-2 mb-2">
                                                            ...
                                                            <div class="overflow-hidden flex-grow-1">
                                                                <span class="d-block fw-bold text-success" style="font-size: 0.82rem; line-height: 1.2;">
                                                                    <?php echo e($isDocVerified ? 'Dokumen Sah Terverifikasi' : 'Berkas Terunggah'); ?>

                                                                </span>
                                                                <small class="text-muted text-truncate d-block" style="font-size: 0.72rem;"><?php echo e(basename($existingDoc->file_path)); ?></small>
                                                            </div>
                                                        </div>
                                                        <a href="<?php echo e(asset('uploads/' . $existingDoc->file_path)); ?>" target="_blank" class="btn btn-xs btn-success text-white py-1.5 px-3 d-flex align-items-center justify-content-center w-100 shadow-sm text-decoration-none" style="font-size: 0.78rem; font-weight: 600; border-radius: 6px;">
                                                    ...
                                                    <?php if(!$isDocVerified): ?>
                                                        <div class="pratanah-file-upload-modern mb-1">
                                                            <input type="file" name="documents[<?php echo e($type->id); ?>][file]" id="upload_<?php echo e($type->id); ?>" accept=".pdf,.jpg,.jpeg,.png">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <label class="form-label mb-1 text-muted d-flex align-items-center justify-content-between" style="font-size: 0.78rem; font-weight: 600;">
                                                        <span>Upload Berkas <?php echo e($type->name); ?></span>
                                                    ...
                                                    <div class="pratanah-file-upload-modern">
                                                        ...
                                                        <div class="pratanah-file-label-modern py-2 px-3" style="border: 1.5px dashed #9a55ff; background: #faf5ff;">
                                                            ...
                                                            <div class="pratanah-file-info-modern">
                                                                <span class="file-label-text fw-bold text-primary" style="font-size: 0.82rem;">Pilih Berkas <?php echo e($type->name); ?></span>
                                            ...
                                            <div class="p-2.5 px-3 rounded-3 mb-2" style="background: #f0fdf4; border: 1.5px solid #86efac;">
                                                <div class="d-flex align-items-center gap-2 mb-2">
                                                    ...
                                                    <div class="overflow-hidden flex-grow-1">
                                                        ...
                                                        <small class="text-muted text-truncate d-block" style="font-size: 0.72rem;"><?php echo e(basename($land->denah)); ?></small>
                                                    </div>
                                                </div>
                                                <a href="<?php echo e($denahUrl); ?>" target="_blank" class="btn btn-xs btn-success text-white py-1.5 px-3 d-flex align-items-center justify-content-center w-100 shadow-sm text-decoration-none mb-2" style="font-size: 0.78rem; font-weight: 600; border-radius: 6px;">
                                ...
                                <div class="properti-col-md-4">
                                    <div class="properti-form-group">
                                        ...
                                        <select name="statusLegal"
                                            class="properti-form-control <?php $__errorArgs = ['statusLegal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option value="pending"
                                                <?php echo e(old('statusLegal', $land->legal_status) == 'pending' || old('statusLegal', $land->legal_status) == 'Pending' ? 'selected' : ''); ?>>Pending</option>
                                            <option value="verified"
                                                <?php echo e(old('statusLegal', $land->legal_status) == 'verified' || old('statusLegal', $land->legal_status) == 'Lengkap' ? 'selected' : ''); ?>>Lengkap</option>
                                        </select>
                                        <?php $__errorArgs = ['statusLegal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="properti-col-md-4">
                                    <div class="properti-form-group">
                                        ...
                                        <select name="statusKavling"
                                            class="properti-form-control <?php $__errorArgs = ['statusKavling'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                            <option value="Belum"
                                                <?php echo e(old('statusKavling', $land->development_status ?? 'Belum') == 'Belum' || old('statusKavling', $land->development_status ?? 'Belum') == 'belum' ? 'selected' : ''); ?>>Belum</option>
                                            <option value="progress"
                                                <?php echo e(old('statusKavling', $land->development_status ?? 'Belum') == 'progress' || old('statusKavling', $land->development_status ?? 'Belum') == 'Proses' ? 'selected' : ''); ?>>Proses</option>
                                            <option value="Selesai"
                                                <?php echo e(old('statusKavling', $land->development_status ?? 'Belum') == 'Selesai' || old('statusKavling', $land->development_status ?? 'Belum') == 'selesai' ? 'selected' : ''); ?>>Selesai</option>
                                        </select>
                                        <?php $__errorArgs = ['statusKavling'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="properti-col-md-4">
                                    <div class="properti-form-group">
                                        ...
                                        <select name="prioritas" class="properti-form-control">
                                            <option value="Normal" <?php echo e(old('prioritas', $land->priority) == 'Normal' ? 'selected' : ''); ?>>
                                                Normal</option>
                                            <option value="Tinggi" <?php echo e(old('prioritas', $land->priority) == 'Tinggi' ? 'selected' : ''); ?>>
                                                Tinggi</option>
                                            <option value="Urgent" <?php echo e(old('prioritas', $land->priority) == 'Urgent' ? 'selected' : ''); ?>>
                                                Urgent</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="properti-form-group">
                                        ...
                                        <div class="properti-input-group">
                                            ...
                                            <input type="text" name="fee_document_verification"
                                                class="properti-form-control <?php $__errorArgs = ['fee_document_verification'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('fee_document_verification', $land->fee_document_verification ? number_format($land->fee_document_verification, 0, ',', '.') : '')); ?>"
                                                placeholder="Contoh: 5.000.000">
                                        </div>
                                        <?php $__errorArgs = ['fee_document_verification'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="properti-col-md-6">
                                    <div class="properti-form-group">
                                        ...
                                        <input type="text" name="latitude" class="properti-form-control"
                                            value="<?php echo e(old('latitude', $land->lat)); ?>" placeholder="Contoh: -6.2088">
                                    </div>
                                </div>
                                <div class="properti-col-md-6">
                                    <div class="properti-form-group">
                                        ...
                                        <input type="text" name="longitude" class="properti-form-control"
                                            value="<?php echo e(old('longitude', $land->lng)); ?>" placeholder="Contoh: 106.8456">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="properti-btn-group mt-4">
                                <a href="<?php echo e(route('properti-all')); ?>" class="properti-btn properti-btn-secondary">
                        ...
                        <div id="paneDokumenPerizinan" class="properti-tab-pane d-none">
                            ...
                            <div class="fase4-summary-card p-3 rounded-3 mb-3" style="background: linear-gradient(135deg, #fbf9ff, #f6f0ff); border: 1px solid rgba(154, 85, 255, 0.2);">
                                <div class="row g-3 align-items-center">
                                    <div class="col-12 col-md-3">
                                        ...
                                        <strong class="text-dark" style="font-size: 0.92rem;"><?php echo e($land->name); ?></strong>
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <small class="text-muted d-block" style="font-size: 0.74rem;">Status Alas Hak Awal</small>
                                        <span class="fw-semibold text-dark" style="font-size: 0.88rem;"><?php echo e($land->ownership_status ?? 'SHM'); ?></span>
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <small class="text-muted d-block" style="font-size: 0.74rem;">Alamat / Lokasi</small>
                                        <span class="fw-semibold text-dark text-truncate d-inline-flex align-items-center gap-1.5" style="font-size: 0.85rem;" title="<?php echo e($land->address); ?>">
                                            <i class="fas fa-map-marker-alt text-danger"></i>
                                            <span><?php echo e($land->city ?? ($land->address ?? '-')); ?></span>
                                        </span>
                                    </div>
                                    <div class="col-12 col-md-3 text-md-end">
                                        <small class="text-muted d-block" style="font-size: 0.74rem;">Total Luas Lahan</small>
                                        <span class="badge bg-purple text-white px-2.5 py-1.5 rounded-2" style="background: #9a55ff; font-size: 0.85rem;"><?php echo e(number_format($land->area ?? 0, 0, ',', '.')); ?> m²</span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12 col-md-5">
                                        <div class="d-flex justify-content-between align-items-center mb-1.5">
                                            ...
                                            <span class="fw-bold text-success" id="fase4_progress_text" style="font-size: 0.84rem;">
                                                <?php echo e($terbitCount); ?> dari <?php echo e($totalWorkflowDocs); ?> Selesai (<?php echo e($progressWorkflowPercent); ?>%)
                                            </span>
                                        </div>
                                        <div class="progress" style="height: 8px; border-radius: 6px; background-color: #f1f5f9;">
                                            <div id="fase4_progress_bar" class="progress-bar bg-success progress-bar-striped progress-bar-animated" role="progressbar" style="width: <?php echo e($progressWorkflowPercent); ?>%;"></div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-7">
                                        <div class="fase4-stat-badges d-flex flex-wrap align-items-center justify-content-md-end gap-2">
                                            <div class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-25 px-2.5 py-1.5 rounded-2 d-inline-flex align-items-center gap-2" style="font-size: 0.78rem;">
                                                ...
                                                <span id="stat_terbit"><?php echo e($terbitCount); ?> Selesai / Terbit</span>
                                            </div>
                                            <div class="badge bg-warning bg-opacity-10 text-warning border border-warning border-opacity-25 px-2.5 py-1.5 rounded-2 d-inline-flex align-items-center gap-2" style="font-size: 0.78rem;">
                                                ...
                                                <span id="stat_proses"><?php echo e($prosesCount); ?> Dalam Proses</span>
                                            </div>
                                            <div class="badge bg-secondary bg-opacity-10 text-secondary border border-secondary border-opacity-25 px-2.5 py-1.5 rounded-2 d-inline-flex align-items-center gap-2" style="font-size: 0.78rem;">
                                                ...
                                                <span id="stat_belum"><?php echo e($belumCount); ?> Belum Ada</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="fase4-tab-wrapper d-flex flex-wrap justify-content-between align-items-center gap-2.5 mb-4 p-2.5 bg-white rounded-3 border shadow-sm">
                                <div class="fase4-tab-nav" role="tablist">
                                    <button type="button" class="fase4-tab-item active fase4-filter-btn" data-status="all" onclick="filterFase4Docs('all', this)">
                                        ...
                                        <span class="fase4-tab-count" id="count_all"><?php echo e($totalWorkflowDocs); ?></span>
                                    </button>
                                    <button type="button" class="fase4-tab-item fase4-filter-btn" data-status="terbit" onclick="filterFase4Docs('terbit', this)">
                                        ...
                                        <span class="fase4-tab-count" id="count_terbit"><?php echo e($terbitCount); ?></span>
                                    </button>
                                    <button type="button" class="fase4-tab-item fase4-filter-btn" data-status="proses" onclick="filterFase4Docs('proses', this)">
                                        ...
                                        <span class="fase4-tab-count" id="count_proses"><?php echo e($prosesCount); ?></span>
                                    </button>
                                    <button type="button" class="fase4-tab-item fase4-filter-btn" data-status="belum" onclick="filterFase4Docs('belum', this)">
                                        ...
                                        <span>Belum Ada</span>
                                        <span class="fase4-tab-count" id="count_belum"><?php echo e($belumCount); ?></span>
                                    </button>
                                </div>
                            ...
                            <div id="fase4_docs_container" class="row g-3 mb-4">
                                <?php $__empty_1 = true; $__currentLoopData = ($workflowDocs ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $docIndex => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4 mb-3 fase4-doc-card" 
                                         id="fase4_doc_card_<?php echo e($docId); ?>"
                                         data-id="<?php echo e($docId); ?>"
                                         data-status="<?php echo e($status); ?>"
                                         data-search="<?php echo e(strtolower($docName . ' ' . $instansi . ' ' . $docNumber . ' ' . $poinLabel . ' ' . $notes)); ?>">
                                        
                                        <div class="card border shadow-sm rounded-3 p-3 position-relative fase4-doc-card-inner h-100 <?php echo e($isFinalGoal ? 'border-2 border-warning' : ''); ?>" style="background: #ffffff; <?php echo e($isFinalGoal ? 'border: 2px solid #f59e0b !important;' : ''); ?>">
                                            <form class="fase4-item-form d-flex flex-column h-100" id="form_doc_<?php echo e($docId); ?>" onsubmit="saveSingleFase4Doc(event, '<?php echo e($docId); ?>')" enctype="multipart/form-data">
                                                <input type="hidden" name="doc_id" value="<?php echo e($docId); ?>">
                                                <input type="hidden" name="existing_syarat_files" id="existing_syarat_files_<?php echo e($docId); ?>" value="<?php echo e(json_encode($syaratFiles)); ?>">
                                                <input type="hidden" name="deleted_syarat_files" id="deleted_syarat_files_<?php echo e($docId); ?>" value="[]">
                                                <input type="hidden" name="doc_name" id="card_doc_name_<?php echo e($docId); ?>" value="<?php echo e($docName); ?>">
                                                <input type="hidden" name="poin_label" id="card_poin_label_<?php echo e($docId); ?>" value="<?php echo e($poinLabel); ?>">
                                                <input type="hidden" name="instansi" id="card_instansi_<?php echo e($docId); ?>" value="<?php echo e($instansi); ?>">
                                                <input type="hidden" name="nominal" id="card_nominal_<?php echo e($docId); ?>" value="<?php echo e($nominal); ?>">
                                                <input type="hidden" name="luas" id="card_luas_<?php echo e($docId); ?>" value="<?php echo e($luas); ?>">
                                                <input type="hidden" name="notes" id="card_notes_<?php echo e($docId); ?>" value="<?php echo e($notes); ?>">
                                                <input type="hidden" name="syarat_dokumen" id="card_syarat_dokumen_<?php echo e($docId); ?>" value="<?php echo e($syaratDokumen); ?>">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="fase4-card-head d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3 pb-2 border-bottom">
                                                        <div class="fase4-card-head-title overflow-hidden me-1" style="max-width: 65%;">
                                                            <div class="d-flex align-items-center gap-1.5 mb-1">
                                                                <span class="badge <?php echo e($isFinalGoal ? 'bg-warning text-dark' : 'bg-primary'); ?> py-0.5 px-2 font-monospace" style="font-size: 10px;">
                                                                    <?php echo e($poinLabel); ?>
                                                            ...
                                                            <h6 class="mb-0 fw-bold text-dark" title="<?php echo e($docName); ?>" style="font-size: 0.90rem; line-height: 1.35; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; min-height: 2.4rem;">
                                                                <?php echo e($docName); ?>

                                                            </h6>
                                                        </div>
                                                        <div class="d-flex align-items-center gap-1 flex-wrap justify-content-end">
                                                            <?php if($status === 'terbit' || $status === 'selesai'): ?>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select name="status" class="form-select form-select-sm fw-semibold" style="font-size: 0.84rem; border-color: <?php echo e($statusBorderColor); ?>;">
                                                            <option value="belum" <?php echo e($status == 'belum' ? 'selected' : ''); ?>>Belum Ada</option>
                                                            <option value="proses" <?php echo e($status == 'proses' ? 'selected' : ''); ?>>Sedang Proses (BPN / Notaris / Dinas)</option>
                                                            <option value="terbit" <?php echo e($status == 'terbit' || $status == 'selesai' ? 'selected' : ''); ?>>Selesai / Terbit Resmi</option>
                                                            <option value="ditolak" <?php echo e($status == 'ditolak' ? 'selected' : ''); ?>>Ditolak / Kendala</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="row g-2 mb-2">
                                                        <div class="col-7">
                                                            ...
                                                            <input type="text" name="doc_number" class="form-control form-control-sm fase4-form-input" value="<?php echo e($docNumber); ?>" placeholder="Nomor resmi SK/Registrasi" style="font-size: 0.84rem;">
                                                        </div>
                                                        <div class="col-5">
                                                            <label class="form-label mb-1 text-muted" style="font-size: 0.78rem; font-weight: 600;">
                                                                Tanggal
                                                            </label>
                                                            <input type="date" name="doc_date" class="form-control form-control-sm fase4-form-input" value="<?php echo e($docDate); ?>" style="font-size: 0.84rem;">
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="p-2.5 px-3 rounded-3 mb-2" style="background: #f0fdf4; border: 1.5px solid #86efac;">
                                                                <div class="d-flex align-items-center gap-2 mb-2">
                                                                    ...
                                                                    <div class="overflow-hidden flex-grow-1">
                                                                        ...
                                                                        <small class="text-muted text-truncate d-block" style="font-size: 0.72rem;"><?php echo e(basename($filePath)); ?></small>
                                                                    </div>
                                                                </div>
                                                                <button type="button" class="btn btn-xs btn-success text-white py-1.5 px-3 d-inline-flex align-items-center justify-content-center gap-1.5 w-100 shadow-sm btn-preview-doc"
                                                                    ...
                                                                    data-ext="<?php echo e(pathinfo($filePath, PATHINFO_EXTENSION)); ?>"
                                                                    data-label="<?php echo e($docName); ?>"
                                                    ...
                                                    <div class="mt-3 mb-2 pt-1">
                                                        <button type="button" class="btn btn-sm w-100 py-1.5 px-3 d-flex align-items-center justify-content-between btn-modal-rincian-trigger" 
                                                            ...
                                                            data-bs-target="#modalRincianDoc_<?php echo e($docId); ?>" 
                                                            style="font-size: 0.80rem; font-weight: 600; border-radius: 6px;">
                                                            <span class="d-inline-flex align-items-center gap-2">
                                                                <span class="text-dark fw-bold">Rincian & Prasyarat</span>
                                                                <?php if($totalSyarat > 0): ?>
                                                                    <span class="badge <?php echo e($isAllSyaratReady ? 'bg-success text-white' : ($checkedCount > 0 ? 'bg-warning text-dark' : 'bg-secondary text-white')); ?> px-2 py-0.5 font-monospace" style="font-size: 0.68rem; border-radius: 4px;">
                                                                        <?php echo e($checkedCount); ?>/<?php echo e($totalSyarat); ?> Syarat
                                                                    </span>
                                                                <?php endif; ?>
                                                            </span>
                                                ...
                                                <div class="fase4-card-footer d-flex align-items-center justify-content-between mt-auto pt-3 border-top" style="border-top-color: #e2e8f0 !important;">
                                                    <button type="submit" class="btn btn-sm btn-success px-3.5 py-1.5 fw-bold shadow-sm d-inline-flex align-items-center" id="btn_save_doc_<?php echo e($docId); ?>" style="border-radius: 6px; font-size: 0.82rem; gap: 8px;">
                                                        <i class="fas fa-save me-1.5"></i> <span>Simpan Dokumen</span>
                                                    </button>
                                                    <button type="button" class="btn btn-fase4-delete d-inline-flex align-items-center" onclick="deleteFase4Doc('<?php echo e($docId); ?>', '<?php echo e(addslashes($docName)); ?>')" title="Hapus Dokumen Ini" style="gap: 6px;">
    ...
    <?php $__currentLoopData = ($workflowDocs ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $docIndex => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $docId = $doc['id'] ?? ('doc_' . uniqid());
            $poinLabel = $doc['poin_label'] ?? ('Poin ' . ($docIndex + 7));
            $docName = $doc['doc_name'] ?? 'Dokumen Pengindukan';
        ...
        <div class="modal fade" id="modalRincianDoc_<?php echo e($docId); ?>" tabindex="-1" aria-hidden="true" style="z-index: 1060;">
                ...
                <div class="modal-content rounded-3 border-0 shadow-lg overflow-hidden">
                    <div class="modal-header px-4 py-3 bg-white border-bottom align-items-center">
                        <div class="d-flex align-items-center gap-2 overflow-hidden me-2">
                            <span class="badge <?php echo e($isFinalGoal ? 'bg-warning text-dark' : 'bg-primary'); ?> py-1 px-2 font-monospace flex-shrink-0" style="font-size: 0.78rem; border-radius: 4px;">
                                <?php echo e($poinLabel); ?>
                            ...
                            <?php endif; ?>
                            <h5 class="modal-title mb-0 fw-bold text-dark text-truncate" style="font-size: 1.05rem;" title="<?php echo e($docName); ?>">
                                <?php echo e($docName); ?>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-lg-6 d-flex flex-column gap-3">
                                ...
                                <div class="p-3 bg-white rounded-3 border shadow-xs">
                                    ...
                                    <div class="row g-2 mb-2">
                                        <div class="col-8">
                                            ...
                                            <input type="text" name="modal_doc_name_<?php echo e($docId); ?>" id="modal_doc_name_<?php echo e($docId); ?>" class="form-control form-control-sm fase4-form-input fw-semibold" value="<?php echo e($docName); ?>" required placeholder="Nama dokumen" style="font-size: 0.84rem;">
                                        </div>
                                        <div class="col-4">
                                            <label class="form-label mb-1 text-muted" style="font-size: 0.76rem; font-weight: 600;">
                                                Urutan
                                            </label>
                                            <input type="text" name="modal_poin_label_<?php echo e($docId); ?>" id="modal_poin_label_<?php echo e($docId); ?>" class="form-control form-control-sm fase4-form-input font-monospace" value="<?php echo e($poinLabel); ?>" placeholder="Poin 7" style="font-size: 0.84rem;">
                                        </div>
                                    </div>
                                    <div class="mb-0">
                                        <label class="form-label mb-1 text-muted" style="font-size: 0.76rem; font-weight: 600;">
                                        ...
                                        <input type="text" name="modal_instansi_<?php echo e($docId); ?>" id="modal_instansi_<?php echo e($docId); ?>" class="form-control form-control-sm fase4-form-input" value="<?php echo e($instansi); ?>" placeholder="BPN / Kelurahan / Dinas" style="font-size: 0.84rem;">
                                    </div>
                                </div>
                                ...
                                <div class="p-3 bg-white rounded-3 border shadow-xs">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-7">
                                            ...
                                            <input type="text" name="modal_nominal_<?php echo e($docId); ?>" id="modal_nominal_<?php echo e($docId); ?>" class="form-control form-control-sm fase4-form-input input-currency" value="<?php echo e($nominal ? number_format($nominal, 0, ',', '.') : ''); ?>" placeholder="0" onkeyup="formatCurrencyDirect(this)" style="font-size: 0.84rem;">
                                        </div>
                                        <div class="col-5">
                                            <label class="form-label mb-1 text-muted" style="font-size: 0.76rem; font-weight: 600;">
                                                Luas (m²)
                                            </label>
                                            <input type="number" step="0.01" name="modal_luas_<?php echo e($docId); ?>" id="modal_luas_<?php echo e($docId); ?>" class="form-control form-control-sm fase4-form-input" value="<?php echo e($luas); ?>" placeholder="m²" style="font-size: 0.84rem;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-3 bg-white rounded-3 border shadow-xs">
                                    ...
                                    <?php if($filePath): ?>
                                        ...
                                        <div class="pratanah-file-upload-modern mb-0">
                                            <input type="file" name="modal_file_doc_<?php echo e($docId); ?>" accept=".pdf,.jpg,.jpeg,.png">
                                ...
                                <div class="p-3 bg-white rounded-3 border shadow-xs">
                                    ...
                                    <textarea name="modal_notes_<?php echo e($docId); ?>" id="modal_notes_<?php echo e($docId); ?>" class="form-control fase4-form-input fase4-notes-area" rows="3" placeholder="Catatan teknis pengurusan..." style="min-height: 90px !important; font-size: 0.84rem; line-height: 1.5;"><?php echo e($notes); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-6 d-flex flex-column gap-3">
                                ...
                                <div class="p-3 bg-white rounded-3 border shadow-xs d-flex flex-column">
                                    <div class="d-flex justify-content-between align-items-center mb-2 pb-2 border-bottom">
                                        ...
                                        <span class="badge <?php echo e($isAllSyaratReady ? 'bg-success text-white' : ($checkedCount > 0 ? 'bg-warning text-dark' : 'bg-secondary text-white')); ?> px-2.5 py-1" style="font-size: 0.72rem;">
                                            <?php echo e($checkedCount); ?>/<?php echo e($totalSyarat); ?> Siap
                                        </span>
                                    </div>

                                    <div class="d-flex flex-column gap-2 my-1 fase4-syarat-list-container">
                                        <?php if($totalSyarat > 0): ?>
                                            <?php $__currentLoopData = $syaratItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $sItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php 
                                                ...
                                                ?>
                                                <div class="p-2.5 rounded-3 border bg-white shadow-xs" style="border-color: <?php echo e($isItemChecked ? '#86efac' : '#e2e8f0'); ?> !important; background: <?php echo e($isItemChecked ? '#fbfdfb' : '#ffffff'); ?>;">
                                                    <div class="d-flex align-items-center justify-content-between gap-2 mb-2">
                                                        <div class="form-check mb-0 d-flex align-items-center gap-2 overflow-hidden flex-grow-1">
                                                            <input class="form-check-input flex-shrink-0" type="checkbox" name="modal_syarat_checklist_<?php echo e($docId); ?>[]" value="<?php echo e($sItem); ?>" id="chk_modal_<?php echo e($docId); ?>_<?php echo e($idx); ?>" <?php echo e($isItemChecked ? 'checked' : ''); ?> style="cursor: pointer; width: 16px; height: 16px;">
                                                            <label class="form-check-label small fw-bold <?php echo e($isItemChecked ? 'text-success' : 'text-dark'); ?> text-truncate mb-0" for="chk_modal_<?php echo e($docId); ?>_<?php echo e($idx); ?>" title="<?php echo e($sItem); ?>" style="cursor: pointer; font-size: 0.80rem;">
                                                                <?php echo e($sItem); ?>

                                                            </label>
                                                        </div>
                                                        <?php if($itemFile): ?>
                                                            <button type="button" class="btn btn-xs btn-outline-success py-1 px-2.5 rounded-2 btn-preview-doc d-inline-flex align-items-center gap-1 flex-shrink-0" data-url="<?php echo e(route('dokumen.preview', ['path' => $itemCleanPath])); ?>" data-ext="<?php echo e($itemExt); ?>" data-label="<?php echo e($sItem); ?>" title="Lihat: <?php echo e($sItem); ?>" style="font-size: 0.72rem; font-weight: 600;">
                                                    ...
                                                    <div class="pratanah-file-upload-modern">
                                                        <input type="file" name="modal_syarat_file_<?php echo e($docId); ?>_<?php echo e($idx); ?>" id="file_syarat_<?php echo e($docId); ?>_<?php echo e($idx); ?>" class="d-none" accept=".pdf,.jpg,.jpeg,.png" onchange="previewSyaratFileName(this, 'label_modal_syarat_<?php echo e($docId); ?>_<?php echo e($idx); ?>', 'chk_modal_<?php echo e($docId); ?>_<?php echo e($idx); ?>')">
                                                        <label for="file_syarat_<?php echo e($docId); ?>_<?php echo e($idx); ?>" class="pratanah-file-label-modern py-1.5 px-2.5 rounded-3 d-flex align-items-center gap-2.5 w-100 mb-0" style="border: 1.5px dashed <?php echo e($itemFile ? '#86efac' : '#c4b5fd'); ?>; background: <?php echo e($itemFile ? '#f0fdf4' : '#fdfcff'); ?>; cursor: pointer; transition: all 0.2s ease;">
                                                            <div class="p-1 rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="background: <?php echo e($itemFile ? 'rgba(34, 197, 94, 0.12)' : 'rgba(154, 85, 255, 0.12)'); ?>; width: 30px; height: 30px;">
                                                                <i class="mdi <?php echo e($itemFile ? 'mdi-file-check text-success' : 'mdi-cloud-upload text-primary'); ?>" style="font-size: 1.15rem;"></i>
                                                            </div>
                                                            <div class="pratanah-file-info-modern overflow-hidden flex-grow-1">
                                                                <span class="file-label-text fw-bold <?php echo e($itemFile ? 'text-success' : 'text-primary'); ?> text-truncate d-block" id="label_modal_syarat_<?php echo e($docId); ?>_<?php echo e($idx); ?>" style="font-size: 0.77rem;">
                                                                    <?php if($itemFile): ?>
                                                                        <i class="fas fa-check text-success me-1"></i> <?php echo e(basename($itemFile)); ?>
                                ...
                                <div class="p-3 bg-white rounded-3 border shadow-xs">
                                    ...
                                    <textarea name="modal_syarat_dokumen_<?php echo e($docId); ?>" id="modal_syarat_dokumen_<?php echo e($docId); ?>" class="form-control fase4-form-input" rows="5" style="min-height: 120px !important; font-size: 0.84rem; line-height: 1.5;" placeholder="• Contoh Syarat 1&#10;• Contoh Syarat 2"><?php echo e($syaratDokumen); ?></textarea>
                    ...
                    <div class="modal-footer fase4-modal-footer bg-white border-top d-flex justify-content-end align-items-center gap-2.5 py-3 px-4">
                        ...
                        <button type="button" class="btn text-white px-4 py-2 rounded-3 shadow-sm" onclick="saveDocFromModal('<?php echo e($docId); ?>')" style="background: linear-gradient(135deg, #9a55ff 0%, #7e22ce 100%); font-size: 0.82rem; font-weight: 700; border: none;">
                            Simpan Perubahan
                        </button>
                    </div>
                </div>
                            ...
                            <div class="p-3 bg-white rounded-3 border shadow-xs">
                                ...
                                <div class="row g-2 mb-2">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="poin_label" class="form-control form-control-sm fase4-form-input font-monospace" placeholder="Poin <?php echo e(count($workflowDocs ?? []) + 7); ?>" style="font-size: 0.84rem;">
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label mb-1 text-muted" style="font-size: 0.76rem; font-weight: 600;">
                ...
                <div class="modal-body p-4 bg-light" style="max-height: 75vh; overflow-y: auto;">
                        ...
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-md-5">
                                <select class="form-select master-category-select" id="filterMasterCategorySelect" onchange="filterMasterPickerCategory(this.value)">
                                    <option value="">Semua Kategori (<?php echo e(isset($masterDocuments) ? $masterDocuments->count() : 0); ?> Dokumen)</option>
                                    <?php if(isset($masterDocuments)): ?>
                                        <?php $__currentLoopData = $masterDocuments->pluck('kategori')->unique(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($kategori); ?>"><?php echo e($kategori); ?> (<?php echo e($masterDocuments->where('kategori', $kategori)->count()); ?>)</option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </select>
                            </div>
                    ...
                    <form id="formPickerMasterPerizinan">
                        ...
                        <div class="row g-3" id="masterPickerListContainer">
                            <?php if(isset($masterDocuments) && $masterDocuments->count() > 0): ?>
                                <?php $__currentLoopData = $masterDocuments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div class="col-12 col-md-6 master-picker-item" 
                                         data-kategori="<?php echo e($m->kategori); ?>" 
                                         data-search="<?php echo e($searchString); ?>"
                                         data-already="<?php echo e($isAlreadyAdded ? '1' : '0'); ?>">
                                        <div class="card h-100 p-3 transition-all master-picker-card <?php echo e($isAlreadyAdded ? 'is-disabled' : ''); ?>" 
                                             id="picker_card_<?php echo e($m->id); ?>"
                                             style="cursor: <?php echo e($isAlreadyAdded ? 'default' : 'pointer'); ?>;"
                                             onclick="togglePickerCardClick(event, '<?php echo e($m->id); ?>', <?php echo e($isAlreadyAdded ? 'true' : 'false'); ?>)">
                                            <div class="d-flex align-items-start gap-3">
                                                <div class="flex-shrink-0 pt-1 me-1">
                                                    <input class="form-check-input master-picker-checkbox custom-picker-chk" 
                                                           ...
                                                           id="picker_chk_<?php echo e($m->id); ?>"
                                                           <?php echo e($isAlreadyAdded ? 'disabled' : ''); ?>
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <div class="d-flex align-items-center justify-content-between gap-1 mb-1">
                                                        <div class="d-flex align-items-center gap-1.5 flex-wrap">
                                                            <span class="badge bg-light text-dark border font-monospace rounded-2" style="font-size: 0.72rem;"><?php echo e($m->kode_dokumen); ?></span>
                                                            <span class="badge rounded-2 fw-semibold" style="background-color: rgba(154,85,255,0.12); color: #9a55ff; font-size: 0.7rem;"><?php echo e($m->kategori); ?></span>
                                                        </div>
                                                    ...
                                                    <h6 class="fw-bold mb-1 text-truncate <?php echo e($isAlreadyAdded ? 'text-secondary' : 'text-dark'); ?>" style="font-size: 0.88rem;" title="<?php echo e($m->nama_dokumen); ?>">
                                                        <?php echo e($m->nama_dokumen); ?>

                                                    </h6>

                                                    <?php if($m->instansi_terkait): ?>
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center gap-1.5 mt-2.5 pt-2 border-top" style="font-size: 0.74rem;">
                                                        <?php if($m->estimasi_hari): ?>
                                                            <span class="badge bg-light text-secondary border px-2 py-1 rounded-2 d-inline-flex align-items-center gap-1.5" style="font-size: 0.70rem; font-weight: 500;">
                                                                ...
                                                                <span><?php echo e($m->estimasi_hari); ?> Hari</span>
                                                            </span>
                                                        <?php endif; ?>
                                                        <?php if($m->estimasi_biaya > 0): ?>
                                                            <span class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-25 px-2 py-1 rounded-2 d-inline-flex align-items-center gap-1.5" style="font-size: 0.70rem; font-weight: 700;">
                                                                ...
                                                                <span>Rp <?php echo e(number_format($m->estimasi_biaya, 0, ',', '.')); ?></span>
                                                            </span>
                                                        <?php endif; ?>
                                                        <?php if($m->syarat_dokumen): ?>
                                                            <span class="badge bg-light text-muted border px-2 py-1 rounded-2 d-inline-flex align-items-center gap-1.5 text-truncate" style="max-width: 220px; font-size: 0.70rem; font-weight: 500;" title="Syarat: <?php echo e($m->syarat_dokumen); ?>">
                                                                <i class="fas fa-file-alt text-secondary"></i>
                                                                <span class="text-truncate"><?php echo e($m->syarat_dokumen); ?></span>
                                                            </span>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const initialWilayah = {
                province: "<?php echo e(old('provinsi', $land->province ?? '')); ?>",
                city: "<?php echo e(old('kota', $land->city ?? '')); ?>",
                district: "<?php echo e(old('kecamatan', $land->district ?? '')); ?>",
                village: "<?php echo e(old('kelurahan', $land->village ?? '')); ?>"
            };
...
<?php $__env->stopPush(); ?>
    ...
    <script>
        ...
        // ==========================================
        const FASE4_DOC_DATA = <?php echo json_encode($workflowDocs ?? [], 15, 512) ?>;
        ...
        function saveSingleFase4Doc(e, docId, modalSource = null) {
            ...
            const uploadUrl = '<?php echo e(route("properti.upload-custom-workflow-doc", $land->id)); ?>';
...
function deleteFase4Doc(docId, docName) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const deleteUrl = '<?php echo e(route("properti.delete-custom-workflow-doc", $land->id)); ?>';
        ...
        function loadFase4DefaultTemplate() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const loadUrl = '<?php echo e(route("properti.load-fase4-template", $land->id)); ?>';
        ...
        function submitBatchFromMaster() {
            ...
            Swal.fire({
                ...
                if (res.isConfirmed) {
                    ...
                    const batchUrl = '<?php echo e(route("properti.add-from-master", $land->id)); ?>';
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Property-Management-Web-App\resources\views/properti/edit.blade.php ENDPATH**/ ?>