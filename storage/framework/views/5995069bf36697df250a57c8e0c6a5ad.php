                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" name="area" value="<?php echo e($land->area ?? ''); ?>" placeholder="Luas tanah di sertifikat" <?php echo e((!$canEditGeneralInfo || ($land && ($land->status == 'approved' || $land->status == 'rejected'))) ? 'disabled' : ''); ?>>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Luas Tanah di Lapangan (m²)</label>
                                            <input type="number" class="form-control" name="field_area" value="<?php echo e($land->field_area ?? ''); ?>" placeholder="Luas tanah di lapangan" <?php echo e((!$canEditGeneralInfo || ($land && ($land->status == 'approved' || $land->status == 'rejected'))) ? 'disabled' : ''); ?>>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="p-3 rounded-3 h-100" style="background: linear-gradient(135deg, #fbf9ff, #f6f0ff); border: 1px solid rgba(154, 85, 255, 0.2);">
                                                ...
                                                <div class="d-flex flex-column gap-2">
                                                    ...
                                                    <div class="fase2-info-row">
                                                        ...
                                                        <span class="fase2-info-value"><?php echo e($land && $land->field_area ? number_format($land->field_area, 0, ',', '.') . ' m²' : '-'); ?></span>
                                                    </div>
                                                    <div class="fase2-info-row">
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select border-primary" id="fase3_status_akhir" name="status" <?php echo e(($land && ($land->status == 'approved' || $land->status == 'rejected')) ? 'disabled' : ''); ?>>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" name="prioritas" <?php echo e(($land && ($land->status == 'approved' || $land->status == 'rejected')) ? 'disabled' : ''); ?>>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control" name="catatan" rows="3" placeholder="Masukkan ringkasan pertimbangan keputusan rapat, kesepakatan notaris, tanggal rencana akta pelepasan..." <?php echo e(($land && ($land->status == 'approved' || $land->status == 'rejected')) ? 'disabled' : ''); ?>><?php echo e($land->notes ?? ''); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php if(!$isStaffLegal || $isAdmin): ?>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $activeBiayas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <?php
                                                    $val = null;
                                                    $hasSavedVal = false;
                                                ...
                                                <div class="col-12 col-sm-6 col-md-3 mb-2">
                                                    <label class="form-label text-muted fw-semibold d-flex justify-content-between align-items-center" style="font-size: 0.82rem;">
                                                        <span class="text-truncate" title="<?php echo e($mItem->nama_biaya); ?>"><?php echo e($mItem->nama_biaya); ?></span>
                                                        <?php if($mItem->tipe_perhitungan === 'persentase' && $mItem->persentase_standar): ?>
                                                            <span class="badge bg-purple-subtle text-purple ms-1 flex-shrink-0" style="font-size: 10px; color: #7e22ce; background: rgba(126, 34, 206, 0.1);">
                                                                <?php echo e($mItem->persentase_standar); ?>%
                                                            </span>
                                                        <?php endif; ?>
                                                    </label>

                                                    <?php if(!in_array($mItem->kode_biaya, ['BIAYA-IJB-PPJB', 'PAJAK-PPH-BPHTB', 'FEE-MAKELAR', 'BIAYA-LAIN-ADMIN'])): ?>
                                                        <input type="hidden" name="custom_costs[master_<?php echo e($mItem->id); ?>][master_id]" value="<?php echo e($mItem->id); ?>">
                                                        <input type="hidden" name="custom_costs[master_<?php echo e($mItem->id); ?>][name]" value="<?php echo e($mItem->nama_biaya); ?>">
                                                        <input type="hidden" name="custom_costs[master_<?php echo e($mItem->id); ?>][code]" value="<?php echo e($mItem->kode_biaya); ?>">
                                                        <input type="hidden" name="custom_costs[master_<?php echo e($mItem->id); ?>][category]" value="<?php echo e($mItem->kategori); ?>">
                                                    <?php endif; ?>
                                                    ...
                                                    <input type="text" 
                                                        ...
                                                        data-cost-name="<?php echo e($mItem->nama_biaya); ?>" 
                                                        data-default-val="<?php echo e($mItem->nominal_standar); ?>" 
                                                        <?php if($mItem->tipe_perhitungan === 'persentase'): ?> data-persen="<?php echo e($mItem->persentase_standar); ?>" <?php endif; ?>
                                                        data-user-edited="<?php echo e($hasSavedVal ? 'true' : 'false'); ?>"
                                                        value="<?php echo e(($val !== null && $val !== '') ? number_format($val, 0, ',', '.') : ''); ?>" 
                                                        placeholder="Contoh: <?php echo e(number_format($mItem->nominal_standar ?? 10000000, 0, ',', '.')); ?>" 
                                                        onkeyup="this.dataset.userEdited = 'true'; formatRupiahTemp(this); updateFinancialSummary();" 
                                                        <?php echo e((!$canEditFinancial || ($land && ($land->status == 'approved' || $land->status == 'rejected'))) ? 'disabled' : ''); ?>>
                                                </div>
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <?php if($land): ?>
                                            <?php if($land->land_bank_id): ?>
                                                <a href="<?php echo e(route('properti.edit', $land->land_bank_id)); ?>" class="btn btn-outline-success py-2 px-3 shadow-sm d-inline-flex align-items-center gap-1" title="Buka data kawasan ini di Pasca Land Bank">
                                            ...
                                            <?php if($land->status === 'approved' || !empty($land->deal_price) || $land->status === 'fase3'): ?>
                                                <a href="<?php echo e(route('perizinan.show', $land->id)); ?>" class="btn btn-gradient-primary py-2 px-3 shadow-sm d-inline-flex align-items-center gap-1" title="Lanjut ke modul Perizinan Proyek untuk pengurusan izin kawasan">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function switchStep(step) {
            ...
            if (step === 3 && currentLandStatus !== 'approved' && currentLandStatus !== 'rejected') {
                ...
                if (!isFase2Done) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Fase 3 Terkunci!',
                        text: 'Fase 2 (Survey & Keputusan Teknis) belum selesai.'
                    }).then(() => switchStep(2));
                    return;
                }
            }
            ...
            // Manage Progress Bar Width (3 Steps: 0%, 50%, 100%)
        ...
        if (isEditMode) {
            if (queryStep >= 1 && queryStep <= 3) {
                ...
                switchStep(3);
            } else if (currentLandStatus === 'fase2' || isFase2Done) {
                switchStep(2);
            } else {
                switchStep(1);
            }
        ...
        function confirmFinalizePasca() {
            ...
            Swal.fire({
                title: '<span style="font-size: 1.15rem; font-weight: 700; color: #1e293b;"><i class="mdi mdi-shield-crown text-success me-1.5"></i> Finalisasi ke Pasca Land Bank</span>',
                html: `
                    <p class="text-muted small mb-0 text-start" style="line-height: 1.6;">
                        Proses transaksi dan notaris Pra Land Bank telah selesai. Lahan ini akan dialihkan secara resmi ke <strong>Pasca Land Bank</strong> untuk melanjutkan pengurusan <strong>Dokumen Pengindukan & Perizinan</strong>.
                    </p>
                `,
                icon: 'question',
                showCancelButton: true,
                ...
                cancelButtonColor: '#6c757d',
                confirmButtonText: '<i class="mdi mdi-check-decagram me-1"></i> Ya, Alihkan ke Pasca Land Bank',
                cancelButtonText: 'Batal',
                focusConfirm: true
            }).then((result) => {
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        text: 'Sedang mendaftarkan tanah ke Pasca Land Bank...',
                        allowOutsideClick: false,
                        didOpen: () => {
                            Swal.showLoading();
                        }
                    ...
                    .then(data => {
                        if (data.success) {
                            Swal.fire({
                                ...
                                text: data.message || 'Lahan berhasil dialihkan ke Pasca Land Bank.',
                                confirmButtonText: 'Buka Dokumen Pengindukan Pasca Land Bank'
                            }).then(() => {
                                if (data.land_bank_id) {
                                    window.location.href = '/properti/' + data.land_bank_id + '/edit#dokumen';
...
<?php echo $__env->make('layouts.partial.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Property-Management-Web-App\resources\views/land_bank/proses_pra_land_bank.blade.php ENDPATH**/ ?>