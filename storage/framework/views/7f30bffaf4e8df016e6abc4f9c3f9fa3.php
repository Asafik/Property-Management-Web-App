...
<div class="container-fluid px-2 px-md-4 py-3">
    ...
    <div class="nav-tabs-clean">
        <a href="<?php echo e(route('perizinan.index')); ?>" class="nav-tab-item">
            <i class="mdi mdi-domain"></i>
            <span>Monitoring Kawasan Proyek</span>
        </a>
        <a href="<?php echo e(route('perizinan.tugas.index')); ?>" class="nav-tab-item active">
            <i class="mdi mdi-clipboard-account-outline"></i>
            <span><?php echo e($isStaffLegal && !$canManage ? 'Tugas Saya (Staf Legal)' : 'Pembagian Tugas Staf Legal'); ?></span>
            <span class="badge rounded-pill" style="background: #4f46e5; color: #ffffff; font-size: 0.72rem;"><?php echo e($totalTugas); ?></span>
        </a>
    </div>
    ...
    <div class="dash-panel">
        <div class="dash-panel-header mb-3 flex-wrap gap-2">
            <div class="dash-panel-title-wrap">
                ...
                <div>
                    ...
                    <p class="dash-panel-subtitle">
                        <?php echo e($isStaffLegal && !$canManage ? 'Daftar berkas perizinan yang didelegasikan kepada Anda' : 'Monitoring seluruh penugasan staf legal dan transparansi pengubah status'); ?>
            ...
            <!-- Toolbar Filter -->
            <form id="filterForm" method="GET" action="<?php echo e(route('perizinan.tugas.index')); ?>" class="m-0">
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <!-- Search Input -->
                    <div style="min-width: 180px;">
                        <input type="text" name="search" class="form-control form-control-sm" placeholder="Cari tugas / proyek..."
                            value="<?php echo e(request('search')); ?>" style="font-size: 0.82rem; border-radius: 6px;">
                    </div>
                    ...
                    <?php if(request()->hasAny(['search', 'employee_id', 'proyek_id', 'status'])): ?>
                        <a href="<?php echo e(route('perizinan.tugas.index')); ?>" class="btn btn-sm btn-light border py-1 px-2" title="Reset Filter" style="border-radius: 6px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="task-user-badge">
                                    <div class="user-avatar-circle" title="<?php echo e($staffName); ?>">
                                        <?php echo e($initials); ?>
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <small class="text-muted d-block text-truncate" style="font-size: 0.72rem;">
                                            <?php echo e($task->employee->position->name ?? 'Staff Legal'); ?>
                            ...
                            <td>
                                <div class="mb-1">
                                    <span class="badge <?php echo e($badgeClass); ?>" style="font-size: 0.74rem; padding: 4px 8px; border-radius: 4px;">
                                ...
                                <div class="dash-progress-wrap" style="gap: 6px;">
                                    ...
                                    <span style="font-size: 0.72rem; font-weight: 700; color: #334155;"><?php echo e($task->progress); ?>%</span>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <div class="user-avatar-circle updater" title="<?php echo e($updaterName); ?>">
                                        <?php echo e($upInitials); ?>

                                    </div>
                                    <div>
                                        <div class="fw-bold text-dark text-truncate" style="font-size: 0.82rem; line-height: 1.2;">
                                            <?php echo e($updaterName); ?>

                                        </div>
                                        <div class="d-flex align-items-center gap-1">
                                            <span class="badge" style="background: #e0f2fe; color: #0284c7; font-size: 0.65rem; padding: 1px 5px; font-weight: 600;">
                                                <?php echo e($updaterPos); ?>

                                            </span>
                                            <small class="text-muted" style="font-size: 0.7rem;">
                                                <?php echo e($task->last_activity_at ? $task->last_activity_at->diffForHumans() : $task->updated_at->diffForHumans()); ?>
                                ...
                                <div class="d-flex align-items-center justify-content-center gap-1">
                                    ...
                                    <?php if($canManage || ($isStaffLegal && $task->employee_id == auth()->id())): ?>
                                        <button type="button" class="btn btn-sm btn-outline-primary py-1 px-2"
                                            ...
                                            onclick='bukaModalUpdateProgres(<?php echo json_encode($task, 15, 512) ?>)'
                                    ...
                                    <?php if($canManage): ?>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" style="font-size: 0.82rem; border-radius: 8px;">
                                                <li>
                                                    <a class="dropdown-item d-flex align-items-center gap-2 py-1.5" href="javascript:void(0)" onclick='bukaModalEditTugas(<?php echo json_encode($task, 15, 512) ?>)'>
                                                ...
                                                <li>
                                                    <form action="<?php echo e(route('perizinan.tugas.destroy', $task->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus tugas ini? Riwayat log tugas juga akan terhapus.');">
                                                        <?php echo csrf_field(); ?>
...
<div class="modal fade" id="modalTambahTugas" tabindex="-1" aria-labelledby="modalTambahTugasLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
            ...
            <form action="<?php echo e(route('perizinan.tugas.store')); ?>" method="POST" onsubmit="return validateTambahTugasForm()">
                <?php echo csrf_field(); ?>
                <div class="modal-body px-4 py-3 bg-white">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-7">
                            ...
                            <div id="wrapperSelectNamaTugas">
                                <select class="form-select form-select-sm" id="selectNamaTugas" onchange="onSelectNamaTugasChange(this)">
                                    ...
                                    <?php $__currentLoopData = $masterDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $md): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($md->nama_dokumen); ?>" 
                                            data-instansi="<?php echo e($md->instansi_terkait); ?>"
                                            data-catatan="<?php echo e($md->deskripsi); ?>">
                                            <?php echo e($md->kode_dokumen ? '[' . $md->kode_dokumen . '] ' : ''); ?><?php echo e($md->nama_dokumen); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="proyek_id" class="form-select form-select-sm">
                                ...
                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($proj['id']); ?>"><?php echo e($proj['nama']); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                            ...
                            <select name="employee_id" class="form-select form-select-sm" required>
                                ...
                                <?php $__currentLoopData = $legalStaffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($staf->id); ?>">
                                        <?php echo e($staf->name); ?> (<?php echo e($staf->position->name ?? 'Staff Legal'); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="deadline" class="form-control form-control-sm" min="<?php echo e(date('Y-m-d')); ?>">
                        </div>
            ...
            <form id="formUpdateProgres" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body px-4 py-3 bg-white">
                    ...
                    <div class="p-2.5 rounded-3 mb-3 d-flex align-items-center gap-2" style="background: #eff6ff; border: 1px solid #bfdbfe; color: #1e40af; font-size: 0.8rem;">
                        ...
                        <div>
                            Pembaruan data ini akan dicatat atas nama <strong><?php echo e(auth()->user()->name); ?> (<?php echo e(auth()->user()->position->name ?? 'Staff'); ?>)</strong> ke dalam Audit Trail / Riwayat Aktivitas.
                        </div>
                    </div>
