            ...
            <div class="d-flex justify-content-between align-items-center px-1">
                <div>
                    <h3 class="text-dark mb-1 fw-bold">
                        <i class="mdi mdi-tag-multiple-outline me-2" style="color: #9a55ff;"></i>Manajemen Promo
                    </h3>
                    <p class="text-muted mb-0">Kelola master data promo diskon, biaya tambahan, dan fasilitas unit</p>
                </div>
            </div>
        </div>
    </div>
