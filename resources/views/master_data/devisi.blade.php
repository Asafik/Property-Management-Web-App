...
@endif
                    ...
                    <div
                        ...
                        <div class="ms-auto">
                            <button class="btn btn-gradient-primary"
                                ...
                                onclick="$('#modalTambahDivisi').modal('show')">
                                    ...
                                    <form id="filterFormDesktop">
                                        <div class="row g-2 align-items-end">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="searchDesktop"
                            ...
                            <table class="table table-hover align-middle" id="tableDivisi">
                                ...
                                <tbody id="tableBody">
                                    @foreach ($division as $index => $item)
                                        <tr>
                                            <td class="text-center">{{ $division->firstItem() + $index }}</td>
                                            <td>{{ $item->name }}</td>
                                            <td class="text-center">
                                                <!-- Tombol Edit -->
                                                <button class="btn btn-outline-warning btn-sm"
                                                    onclick="editDivisi('{{ $item->id }}','{{ $item->name }}')">
                                                    <i class="mdi mdi-pencil"></i>
                                                </button>

                                                <!-- Tombol Delete -->
                                                <form action="{{ route('master.data.division.delete', $item->id) }}" method="POST"
                                                    class="d-inline"
                                                    onsubmit="return confirm('Apakah yakin ingin menghapus divisi ini?')">
    ...
    <div class="modal fade" id="modalTambahDivisi" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('master.data.division.store') }}" method="POST">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" onclick="$('#modalTambahDivisi').modal('hide')"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-form-group">
                            ...
                            <input type="text" id="name" name="name" class="modal-form-control"
                                placeholder="Contoh: Divisi Keuangan" required>
                        </div>

                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-gradient-secondary"
                            onclick="$('#modalTambahDivisi').modal('hide')">Batal</button>
                        <button type="submit" class="btn btn-gradient-primary" onclick="tambahDivisi()">Simpan</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" onclick="$('#modalEditDivisi').modal('hide')"></button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="formEditDivisi" method="POST">
                        ...
                        <div class="modal-form-group">
                            ...
                            <input type="text" id="editNamaDivisi" name="name" class="modal-form-control"
                                required>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-gradient-secondary"
                        onclick="$('#modalEditDivisi').modal('hide')">
                        Batal
                    </button>

                    <button type="button" class="btn btn-gradient-primary" onclick="updateDivisi()">
                        Update
                    </button>
                </div>
...
setTimeout(function () {
    ...
    <script>
        ...
        function updateDivisi() {
            ...
            $('#formEditDivisi').attr(
                'action',
                '/master-data/division/update/' + id
            );

            $('#formEditDivisi').submit();
        }
    </script>
@endpush
