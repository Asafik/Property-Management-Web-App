                            ...
                            <div class="d-block d-md-none">
                                <form id="filterFormMobile">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="searchMobile" placeholder="Cari nama posisi..." style="height: 45px;">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="divisiMobile" style="height: 45px;">
                                            <option value="">Semua Divisi</option>
                                            <option value="1">Divisi Keuangan</option>
                                            <option value="2">Divisi SDM</option>
                                            <option value="3">Divisi IT</option>
                                            <option value="4">Divisi Marketing</option>
                                            <option value="5">Divisi Operasional</option>
                                        </select>
                                    </div>
                                ...
                                <form id="filterFormDesktop">
                                    <div class="row g-2 align-items-end">
                                        <div class="col-md-5">
                                            ...
                                            <input type="text" class="form-control" id="searchDesktop" placeholder="Cari nama posisi...">
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" id="divisiDesktop">
                                                <option value="">Semua Divisi</option>
                                                <option value="1">Divisi Keuangan</option>
                                                <option value="2">Divisi SDM</option>
                                                <option value="3">Divisi IT</option>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" onclick="$('#modalTambahPosisi').modal('hide')" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="formTambahPosisi">
                    <div class="modal-form-group">
                        <label>
                            <i class="mdi mdi-sitemap me-1"></i>Divisi
                        </label>
                        <select id="divisiTambah" class="modal-form-control" required>
                    ...
                    <div class="modal-form-group mt-3">
                        <label>
                            <i class="mdi mdi-badge-account-horizontal me-1"></i>Nama Posisi
                        </label>
                        <input type="text" id="namaPosisi" class="modal-form-control" placeholder="Contoh: Manager Keuangan" required>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-gradient-secondary" onclick="$('#modalTambahPosisi').modal('hide')">Batal</button>
                <button type="button" class="btn btn-gradient-primary" onclick="tambahPosisi()">Simpan</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" onclick="$('#modalEditPosisi').modal('hide')" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="formEditPosisi">
                    ...
                    <div class="modal-form-group">
                        ...
                        <select id="editDivisi" class="modal-form-control" required>
                            <option value="">Pilih Divisi</option>
                            <option value="1">Divisi Keuangan</option>
                            <option value="2">Divisi SDM</option>
                            <option value="3">Divisi IT</option>
                    ...
                    <div class="modal-form-group mt-3">
                        ...
                        <input type="text" id="editNamaPosisi" class="modal-form-control" required>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-gradient-secondary" onclick="$('#modalEditPosisi').modal('hide')">Batal</button>
                <button type="button" class="btn btn-gradient-primary" onclick="updatePosisi()">Update</button>
            </div>
        </div>
    </div>
</div>
