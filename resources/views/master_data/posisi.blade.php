...
.btn-action { width: 36px; height: 36px; padding: 0; display: inline-flex; align-items: center; justify-content: center; border-radius: 10px; margin-left: 6px; transition: all 0.3s ease; border: none; cursor: pointer; }
...
.badge-division { padding: 0.35rem 0.8rem; border-radius: 20px; font-weight: 600; font-size: 0.82rem; display: inline-block; background: linear-gradient(135deg, #17a2b8, #56c6d8); color: #fff; }
...
.action-cell { text-align: right !important; min-width: 120px; }
</style>
