                            ...
                            <div class="d-block d-md-none">
                                <form method="GET" action="">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="search" placeholder="Cari pekerjaan..." style="height: 45px;">
                                    </div>
                                ...
                                <form method="GET" action="">
                                    <div class="row g-2 align-items-end">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="search" placeholder="Nama pekerjaan...">
                                        </div>
                        ...
                        <table class="table table-hover align-middle" id="tableDeadline" data-use-datatables="true">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-tools text-primary me-2" style="font-size: 1.2rem;"></i>
                                            <span class="fw-bold">I. PEKERJAAN PERSIAPAN</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="progress">
                                    ...
                                    <td>
                                        <i class="mdi mdi-calendar-start text-success me-1"></i>01 Feb 2025
                                    </td>
                                    <td>
                                        <i class="mdi mdi-calendar-end text-success me-1"></i>05 Feb 2025
                                    </td>
                                    <td>
                                        <span class="fw-bold">5 hari</span>
                                    </td>
                                    <td>
                                        <span class="deadline-countdown success">
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <button class="btn btn-outline-info btn-sm" title="Detail">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-foundation text-warning me-2" style="font-size: 1.2rem;"></i>
                                            <span class="fw-bold">II. PEKERJAAN PONDASI</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="progress">
                                    ...
                                    <td>
                                        <i class="mdi mdi-calendar-start text-success me-1"></i>06 Feb 2025
                                    </td>
                                    <td>
                                        <i class="mdi mdi-calendar-end text-warning me-1"></i>20 Feb 2025
                                    </td>
                                    <td>
                                        <span class="fw-bold">15 hari</span>
                                    </td>
                                    <td>
                                        <span class="deadline-countdown warning">
                                            <i class="mdi mdi-clock-outline me-1"></i>H-7
                                        </span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-bridge text-warning me-2" style="font-size: 1.2rem;"></i>
                                            <span class="fw-bold">III. PEKERJAAN STRUKTUR</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="progress">
                                    ...
                                    <td>
                                        <i class="mdi mdi-calendar-start text-success me-1"></i>10 Feb 2025
                                    </td>
                                    <td>
                                        <i class="mdi mdi-calendar-end text-warning me-1"></i>25 Feb 2025
                                    </td>
                                    <td>
                                        <span class="fw-bold">16 hari</span>
                                    </td>
                                    <td>
                                        <span class="deadline-countdown warning">
                                            <i class="mdi mdi-clock-outline me-1"></i>H-7
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-wall text-danger me-2" style="font-size: 1.2rem;"></i>
                                            <span class="fw-bold">IV. PEKERJAAN DINDING</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="progress">
                                    ...
                                    <td>
                                        <i class="mdi mdi-calendar-start text-success me-1"></i>12 Feb 2025
                                    </td>
                                    <td>
                                        <i class="mdi mdi-calendar-end text-danger me-1"></i>28 Feb 2025
                                    </td>
                                    <td>
                                        <span class="fw-bold">17 hari</span>
                                    </td>
                                    <td>
                                        <span class="deadline-countdown danger">
                                            <i class="mdi mdi-clock-alert me-1"></i>H-3
                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge badge-gradient-danger">
                                            <i class="mdi mdi-alert-circle me-1"></i>H-3
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-roofing text-info me-2" style="font-size: 1.2rem;"></i>
                                            <span class="fw-bold">V. PEKERJAAN ATAP</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="progress">
                                    ...
                                    <td>
                                        <i class="mdi mdi-calendar-start text-warning me-1"></i>20 Feb 2025
                                    </td>
                                    <td>
                                        <i class="mdi mdi-calendar-end text-info me-1"></i>10 Mar 2025
                                    </td>
                                    <td>
                                        <span class="fw-bold">19 hari</span>
                                    </td>
                                    <td>
                                        <span class="deadline-countdown warning">
                                            <i class="mdi mdi-clock-outline me-1"></i>H-14
                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge badge-gradient-info">
                                            <i class="mdi mdi-clock-outline me-1"></i>On Track
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-brush text-info me-2" style="font-size: 1.2rem;"></i>
                                            <span class="fw-bold">VI. PEKERJAAN FINISHING</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="progress">
                                    ...
                                    <td>
                                        <i class="mdi mdi-calendar-start text-warning me-1"></i>25 Feb 2025
                                    </td>
                                    <td>
                                        <i class="mdi mdi-calendar-end text-info me-1"></i>20 Mar 2025
                                    </td>
                                    <td>
                                        <span class="fw-bold">24 hari</span>
                                    </td>
                                    <td>
                                        <span class="deadline-countdown warning">
                                            <i class="mdi mdi-clock-outline me-1"></i>H-19
                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge badge-gradient-info">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <i class="mdi mdi-dots-horizontal text-secondary me-2" style="font-size: 1.2rem;"></i>
                                            <span class="fw-bold">VII. PEKERJAAN LAINNYA</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="progress">
                                    ...
                                    <td>
                                        <i class="mdi mdi-calendar-start text-info me-1"></i>15 Mar 2025
                                    </td>
                                    <td>
                                        <i class="mdi mdi-calendar-end text-info me-1"></i>30 Mar 2025
                                    </td>
                                    <td>
                                        <span class="fw-bold">16 hari</span>
                                    </td>
