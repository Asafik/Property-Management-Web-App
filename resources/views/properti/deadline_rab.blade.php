            ...
            <div class="d-flex justify-content-between align-items-center px-1">
                <div>
                    <h3 class="text-dark mb-1 fw-bold">
                        <i class="mdi mdi-clock-alert-outline me-2" style="color: #9a55ff;"></i>Deadline RAB per Unit
                    </h3>
                    <p class="text-muted mb-0">Monitor deadline setiap tahapan pekerjaan dan estimasi target penyelesaian unit</p>
                </div>
            </div>
        </div>
    </div>
