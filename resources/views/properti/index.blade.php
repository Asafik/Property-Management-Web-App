                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <i class="mdi mdi-home-variant text-primary me-1"
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    @if (($item->zoning ?? 'Tanah') == 'Rumah')
                                                        <i class="mdi mdi-home-city text-info me-1"
                                                            style="font-size: 0.9rem;"></i>
                                                    @elseif(($item->zoning ?? 'Tanah') == 'Apartemen')
                                                        <i class="mdi mdi-office-building text-info me-1"
                                                            style="font-size: 0.9rem;"></i>
                                                    @elseif(($item->zoning ?? 'Tanah') == 'Ruko')
                                                        <i class="mdi mdi-store text-info me-1"
                                                            style="font-size: 0.9rem;"></i>
                                                    @elseif(($item->zoning ?? 'Tanah') == 'Tanah')
                                                        <i class="mdi mdi-terrain text-info me-1"
                                                            style="font-size: 0.9rem;"></i>
                                                    @else
                                                        <i class="mdi mdi-shape-outline text-info me-1"
                                                            style="font-size: 0.9rem;"></i>
                                                    @endif
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="modal fade" id="documentModal{{ $item->id }}" tabindex="-1"
                                                    aria-labelledby="documentModalLabel{{ $item->id }}"
                                                    aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    ...
                                                                    <i class="mdi mdi-file-document-multiple me-2"
                                                                        style="color: #9a55ff;"></i>
                                                                    Dokumen - {{ $item->name }}
                                                                </h5>
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table
                                                                            ...
                                                                            <thead class="table-light">
                                                                                <tr>
                                                                                    <th><i
                                                                                            class="mdi mdi-format-list-numbered me-1"></i>Nomer
                                                                                        Dokumen</th>
                                                                                    <th><i
                                                                                            class="mdi mdi-file-outline me-1"></i>Tipe
                                                                                    </th>
                                                                                    <th><i
                                                                                            class="mdi mdi-information me-1"></i>Status
                                                                                    </th>
                                                                                    <th width="100"><i
                                                                                            class="mdi mdi-eye me-1"></i>Aksi
                                                                                    </th>
                                                                                </tr>
                                                                            </thead>
                                                                            <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            @if ($doc->type == 'sertifikat')
                                                                                                <i
                                                                                                    class="mdi mdi-certificate text-primary me-1"></i>
                                                                                            @elseif($doc->type == 'imb')
                                                                                                <i
                                                                                                    class="mdi mdi-domain text-info me-1"></i>
                                                                                            @else
                                                                                                <i
                                                                                                    class="mdi mdi-file text-secondary me-1"></i>
                                                                                            @endif
                                                                                            {{ ucfirst($doc->type) }}
                                                                                        </td>
                                                                                        <td>
                                                                                            @if ($doc->status == 'pending')
                                                                                                <span
                                                                                                    ...
                                                                                                    <i
                                                                                                        class="mdi mdi-clock-outline me-1"></i>Pending
                                                                                                </span>
                                                                                            @elseif($doc->status == 'ditolak')
                                                                                                <span
                                                                                                    class="badge badge-gradient-danger">
                                                                                                    <i
                                                                                                        class="mdi mdi-close-circle me-1"></i>Ditolak
                                                                                                </span>
                                                                                            @elseif($doc->status == 'terverifikasi')
                                                                                                <span
                                                                                                    class="badge badge-gradient-success">
                                                                                                    <i
                                                                                                        class="mdi mdi-check-circle me-1"></i>Terverifikasi
                                                                                                </span>
                                                                                            @else
                                                                                                <span
                                                                                                    class="badge bg-secondary">{{ ucfirst($doc->status) }}</span>
                                                                                            @endif
                                                                                        </td>
                                                                                        <td>
        ...
        $(document).ready(function() {
            ...
            `,
                ...
                columnDefs: [{
                        orderable: false,
                        targets: [0, 7, 8]
                    } // Non-aktifkan sorting untuk kolom No, Dokumen, Aksi
                ],
