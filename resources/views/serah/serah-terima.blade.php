...
<style>
/* =========================================================
   TRANSAKSI SERAH TERIMA UNIT STYLES & LAYOUT
   ========================================================= */
                    ...
                    <div class="transaksi-detail-list">
                        ...
                        @else
                            ...
                            <div class="transaksi-detail-item mt-2">
                                <span>Metode Pembayaran</span>
                                <span class="badge {{ strtolower($booking->purchase_type ?? '') == 'kpr' ? 'badge-gradient-primary' : 'badge-gradient-success' }} text-white">
