...
@section('content')
    ...
    <style>
        ...
        .konfirmasi-btn-success {
            background: linear-gradient(135deg, #28a745, #5cb85c);
            color: #ffffff;
        }

        .konfirmasi-btn-warning {
            background: linear-gradient(135deg, #ffc107, #ffdb6d);
            color: #2c2e3f;
        }
    ...
    <div class="row">
        <div class="col-12">
            <!-- Header Info Customer (Statis) dengan Badge KPR -->
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <!-- Info Customer dengan Badge KPR - 3 DATA DARI DB -->
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center flex-wrap">
                                <h4 class="mb-1">{{ $application->customer->full_name }}</h4>
                                <span class="kpr-badge">KPR</span>
                            </div>
                            <p class="text-muted mb-0">Booking ID: BK/2025/03/001</p>
                        </div>
    ...
    <div class="row mt-4">
                        ...
                        <div class="row g-2 g-md-0">
                            <div class="col-2 col-md text-center mb-3 mb-md-0">
                                <div class="step completed">
                                    ...
                                    <small class="text-muted d-none d-sm-block">10 Maret 2025</small>
                                </div>
                            </div>
                            <div class="col-2 col-md text-center mb-3 mb-md-0">
                                <div class="step completed">
                                    ...
                                    <small class="text-muted d-none d-sm-block">12 Maret 2025</small>
                                </div>
                            </div>
                            <div class="col-2 col-md text-center mb-3 mb-md-0">
                                <div class="step completed">
        ...
        <!-- Kolom Kanan: Detail KPR - 1 DATA DARI DB (BANK) -->
                ...
                <div class="card-body">
                    ...
                    <div class="konfirmasi-timeline">
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                <span class="d-block">Serah Terima Unit</span>
                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div id="formSelesai" style="display: none;">
                            ...
                            <div class="konfirmasi-form-group">
                                ...
                                <textarea class="konfirmasi-form-control" name="catatan" rows="2"
                                    placeholder="Contoh: Proses akad selesai, dokumen lengkap">Proses akad berjalan lancar, dokumen lengkap</textarea>
                            </div>
                        </div>
                        ...
                        <div id="formTunda" style="display: none;">
                            ...
                            <div class="konfirmasi-form-group mt-3">
                                <label>Jadwal Ulang (Jika memilih Jadwal Ulang)</label>
                                <input type="date" class="konfirmasi-form-control" name="jadwal_ulang" value="2025-03-25">
                            </div>
                        </div>
            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <div>Dokumen KTP/KK (Asli & Fotocopy)</div>
                    </div>
                    <div class="d-flex mb-2">
                        <div style="width: 24px;" class="me-2">
                            <i class="mdi mdi-check-circle text-success"></i>
                        </div>
                        <div>SP3K dari Bank (Asli)</div>
                    </div>
                    <div class="d-flex mb-2">
                        <div style="width: 24px;" class="me-2">
                            <i class="mdi mdi-check-circle text-success"></i>
                    ...
                    <div class="d-flex">
                        ...
                        <div>Fotocopy sertifikat (3 rangkap)</div>
                    </div>
                </div>
            </div>
        </div>
