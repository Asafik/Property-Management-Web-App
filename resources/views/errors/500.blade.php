...
<head>
    ...
    <title>500 - Internal Server Error | Properti Management</title>
...
<body>
    <div class="error-card">
        <!-- Icon 500 dengan tema server error / maintenance -->
        <div class="error-icon">
            <i class="mdi mdi-server-off"></i>
        </div>

        <!-- Angka 500 dengan gradient -->
        ...
        <div class="action-buttons">
            ...
            <a href="javascript:window.location.reload()" class="btn btn-gradient-secondary">
                <i class="mdi mdi-refresh"></i>
                Coba Lagi
            </a>
        </div>

        <!-- Info tambahan dengan pesan lebih relevan untuk 500 -->
        <div class="info-text">
            <i class="mdi mdi-information-outline"></i>
            <span>Jika masalah berlanjut, silakan hubungi tim support</span>
        </div>
