...
<head>
    ...
    <title>403 - Akses Ditolak | Properti Management</title>
...
<body>
    <div class="error-card">
        <!-- Icon 403 dengan tema terlarang / gembok -->
        <div class="error-icon">
            <i class="mdi mdi-lock-outline"></i>
        </div>

        <!-- Angka 403 dengan gradient -->
        ...
        <p class="error-message">
            ...
            Halaman ini mungkin memerlukan hak akses khusus atau akun dengan otorisasi tertentu.
        </p>
        ...
        <!-- Info tambahan dengan pesan lebih relevan untuk 403 -->
        <div class="info-text">
            <i class="mdi mdi-information-outline"></i>
            <span>Jika Anda seharusnya memiliki akses, hubungi administrator</span>
        </div>
