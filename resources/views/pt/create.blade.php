...
@section('title', 'Tambah Perusahaan (PT) - Property Management App')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="address" rows="2" class="form-control form-control-custom" 
                                  placeholder="Contoh: Jl. Letjen Sutoyo No. 99 A, Kel. Kaliwates, Kec. Kaliwates, Kab. Jember">{{ old('address') }}</textarea>
                                    ...
                                    <div class="pratanah-file-upload-modern">
                                        ...
                                        <div class="pratanah-file-label-modern">
                                            ...
                                            <div class="pratanah-file-info-modern">
                                                <span class="file-label-text" id="label_text_{{ $doc['field'] }}">Pilih Berkas...</span>
