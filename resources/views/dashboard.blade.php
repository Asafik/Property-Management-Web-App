...
@section('content')
                                                                ...
                                                                <tbody>
                                                                    @foreach ($item->units as $unit)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ $unit->name ?? ($unit->unit_name ?? '-') }}
                                                                            </td>
                                                                            <td>{{ $unit->block ?? ($unit->blok ?? '-') }}
                                                                            </td>
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                Rp
                                                                                {{ number_format($unit->price ?? ($unit->harga ?? 0), 0, ',', '.') }}
                                                                            </td>
                                                                            <td>
                                                                                @php
                                                                                    $status = strtolower(
                                                                                ...
                                                                                @elseif ($status == 'draft' || $status == 'ready')
    ...
    <div class="modal fade modal-detail-unit" id="modalDetailLandbank" tabindex="-1" aria-labelledby="modalDetailLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="timeline-detail-card">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="timeline-detail-item">
                                    <div class="timeline-detail-label"><i
                                            class="mdi mdi-format-list-bulleted-type"></i>Kategori</div>
                                    <div class="timeline-detail-value" id="detail-zoning">-</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="timeline-detail-item">
                                    <div class="timeline-detail-label"><i class="mdi mdi-shield-check"></i>Status Legal
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="timeline-detail-item">
                                    <div class="timeline-detail-label"><i class="mdi mdi-currency-usd"></i>Harga Perolehan
                                    </div>
                    ...
                    <div class="timeline-detail-card">
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    @foreach ($landBank as $item)
                                        @forelse ($item->paginated_units as $unit)
                                            <tr>
                                                <td class="text-center fw-bold">
                                                    {{ $item->paginated_units->firstItem() + $loop->index }}
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <i class="mdi mdi-home-outline text-primary me-2"></i>
                                                        <span class="fw-bold">
                                                            {{ $unit->unit_name ?? ($unit->unit_number ?? ($unit->unit_code ?? '-')) }}
                                                        </span>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    {{ optional(optional($unit->activeBooking)->customer)->full_name ?? '-' }}
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                        ...
                        @foreach ($landBank as $item)
                            @if ($item->paginated_units->hasPages())
                                <div class="mt-3">
                                    {{ $item->paginated_units->links() }}
                                </div>
                            @endif
                        @endforeach
                    </div>
