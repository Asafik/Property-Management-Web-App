 ...
 @section('content')
                     ...
                     <div class="card-body">
                         <div class="d-flex flex-wrap align-items-center gap-3">
                             ...
                             <div class="flex-grow-1">
                                 ...
                                 <p class="text-muted mb-0">{{ $application->unit->unit_name }} -
                                     {{ $application->bank->bank_name }}</p>
                             </div>
                         </div>
                     </div>
                 </div>
    ...
    @php
        ...
        $requiredDocs = ['ktp','kk','slip_gaji','rekening_koran'];
        $isComplete = true;
             ...
             document.querySelectorAll('.upload-file-modern input[type="file"]').forEach(input => {
                 input.addEventListener('change', function(e) {
                     ...
                     if (fileName) {
                         ...
                         else if (inputId === 'document-kk') label.textContent =
                             'Upload Kartu Keluarga';
                         else if (inputId === 'document-npwp') label.textContent = 'Upload NPWP';
                         else if (inputId === 'document-slip-gaji') label.textContent =
                             'Upload Slip Gaji';
                         else if (inputId === 'document-rekening') label.textContent =
                             'Upload Rekening Koran';
                         else if (inputId === 'document-nikah') label.textContent =
                             'Upload Surat Nikah';
                         else if (inputId === 'document-siup') label.textContent =
                             'Upload SIUP / IUMK';
