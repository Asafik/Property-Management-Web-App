            ...
            <div class="card shadow-sm border-0">
                <div class="card-body d-flex flex-wrap align-items-center gap-3">
                    ...
                    <div class="flex-grow-1">
                        <h4 class="mb-1 text-dark">Budi Santoso</h4>
                        <p class="text-muted mb-0">Booking ID: #INV/202502/002</p>
                    </div>
                    ...
                    <div class="row g-2 g-md-0">
                        <div class="col-4 col-md text-center mb-3 mb-md-0">
                            <div class="step completed">
                                ...
                                <small class="text-muted d-none d-sm-block">10 Feb 2025</small>
                            </div>
                        </div>
                        <div class="col-4 col-md text-center mb-3 mb-md-0">
                            <div class="step completed">
                                ...
                                <span class="d-block text-success small fw-medium">DP 20%</span>
                        ...
                        <div class="col-4 col-md text-center mt-2 mt-md-0">
                            <div class="step">
                                <div class="step-icon bg-light text-muted rounded-circle d-flex align-items-center justify-content-center mx-auto mb-2" style="width: 35px; height: 35px;">
                                    <i class="mdi mdi-certificate" style="font-size: 18px;"></i>
                                </div>
                                <span class="d-block text-muted small fw-medium">Serah Terima</span>
                                <small class="text-muted d-none d-sm-block">Menunggu</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="detail-info">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-medium">Rp 450.000.000</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-medium">Rp 435.000.000</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-muted">DP 20%</span>
                            <span class="fw-medium">Rp 87.000.000</span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="text-muted">Sisa Pembayaran</span>
                            <span class="fw-medium text-primary">Rp 348.000.000</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <span class="fw-medium d-block">Rina Wijaya</span>
                    ...
                    <div class="mt-3">
                        ...
                        <span class="badge badge-success">Cash Bertahap</span>
                        <span class="badge badge-info ms-2">Transfer Bank</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-8 mb-4 mb-lg-0">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <!-- FORM AKAD SELESAI (muncul jika pilih selesai) -->
                    <div id="formSelesai" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="akad-form-group">
                                    <label>No. Akad</label>
                                    <input type="text" class="akad-form-control" value="AKAD/CASH/2025/002">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="akad-form-group">
                                    <label>Tanggal Akad</label>
                                    <input type="date" class="akad-form-control" value="2025-02-25">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="akad-form-group">
                                    ...
                                    <select class="akad-form-control">
                        ...
                        <div class="akad-form-group">
                            ...
                            <div class="akad-file-upload-modern">
                                <input type="file" id="uploadAkad" name="uploadAkad" accept=".jpg,.jpeg,.png,.pdf">
                        ...
                        <div class="akad-form-group">
                            ...
                            <textarea class="akad-form-control" rows="2" placeholder="Catatan proses akad...">Akad selesai, pembayaran lunas</textarea>
                        </div>
                    </div>

                    <!-- FORM AKAD BATAL (muncul jika pilih batal) -->
                    <div id="formBatal" style="display: none;">
                        ...
                        <div class="akad-form-group">
                            ...
                            <select class="akad-form-control" id="alasanBatal">
                        ...
                        <div class="akad-form-group" id="alasanLainnya" style="display: none;">
                            ...
                            <input type="text" class="akad-form-control" placeholder="Contoh: Masalah internal">
                        </div>

                        <div class="akad-form-group">
                            <label>Catatan Pembatalan</label>
                            <textarea class="akad-form-control" rows="2" placeholder="Detail pembatalan..."></textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="akad-tindakan-card">
                                    <input type="radio" name="tindakan" id="tindakanRefund" checked>
                            ...
                            <div class="col-md-6">
                                <div class="akad-tindakan-card">
                                    <input type="radio" name="tindakan" id="tindakanHangus">
        ...
        <div class="col-12 col-lg-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <h6 class="mb-3 text-primary">Ringkasan Pembayaran</h6>
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-2">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fw-medium"><span class="badge badge-warning">Belum Lunas</span></span>
                        </div>
                    </div>
                    ...
                    <div class="akad-timeline">
                        <div class="akad-timeline-item">
                            <div class="akad-timeline-icon">
                                <i class="mdi mdi-check-circle text-success"></i>
                            </div>
                            <div class="akad-timeline-content">
                                <span class="akad-timeline-text">Pembayaran DP 20%</span>
                                <small class="akad-timeline-date">12 Feb 2025 - Rp 87.000.000</small>
                            </div>
                        </div>
                        <div class="akad-timeline-item">
                            <div class="akad-timeline-icon">
                            ...
                            <div class="akad-timeline-content">
                                <span class="akad-timeline-text">Pelunasan</span>
                                <small class="akad-timeline-date">Menunggu pembayaran</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Tombol Aksi -->
                    <button class="akad-btn akad-btn-primary w-100 mb-2" id="btnSimpan">
                        <i class="mdi mdi-content-save me-2"></i>
                        Simpan Konfirmasi
                    </button>

                    <a href="{{ url('/marketing/cash') }}" class="akad-btn akad-btn-outline-secondary w-100">
...
$(document).ready(function() {
    ...
    $('#uploadAkad').change(function(e) {
        ...
        const label = $(this).closest('.akad-file-upload-modern').find('.akad-file-info-modern span');
