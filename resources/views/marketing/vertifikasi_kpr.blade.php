                        ...
                        <div class="mt-3 mt-sm-0">
                            <div class="d-flex flex-wrap gap-3">
                                <div>
                                    ...
                                    <span class="fw-medium">{{ $booking->unit->unit_name }} -
                                ...
                                <div>
                                    ...
                                    <span class="fw-medium text-primary">
                                        Rp {{ number_format(optional($booking->unit)->price ?? 0, 0, ',', '.') }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <button class="verifikasi-btn verifikasi-btn-outline-primary"
                                            style="padding: 0.25rem 0.5rem; font-size: 0.875rem;" title="Lihat Dokumen">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="verifikasi-btn verifikasi-btn-outline-secondary"
                                            style="padding: 0.25rem 0.5rem; font-size: 0.875rem;" title="Upload Dokumen"
                                            disabled>
