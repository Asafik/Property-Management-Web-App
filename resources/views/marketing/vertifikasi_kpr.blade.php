                    ...
                    <form action="{{ route('kpr.verifikasi.store', $booking->id) }}" method="POST"
                        ...
                        <div>
                            <div class="konfirmasi-form-group">
                                ...
                                <textarea class="konfirmasi-form-control" name="catatan_tolak" rows="3"
                                    placeholder="Berikan catatan untuk customer atau internal..."></textarea>
                            </div>
                            ...
                            <div class="verifikasi-form-group mb-4">
                                ...
                                <div class="verifikasi-file-upload">
                                    <input type="file" id="uploadDokumen" name="berita_acara"
                                    ...
                                    <div class="konfirmasi-tindakan-card">
                                        ...
                                        <label class="konfirmasi-tindakan-label" for="tindakanLengkapi">
                                            ...
                                            <div class="konfirmasi-tindakan-content">
                                                ...
                                                <span class="konfirmasi-tindakan-desc">Customer diminta melengkapi
                                                    dokumen</span>
                                            </div>
                                    ...
                                    <div class="konfirmasi-tindakan-card">
                                        ...
                                        <label class="konfirmasi-tindakan-label" for="tindakanBanding">
                                            ...
                                            <div class="konfirmasi-tindakan-content">
                                                ...
                                                <span class="konfirmasi-tindakan-desc">Ajukan banding ke bank yang
                                                    sama</span>
                                            </div>
                                            <div class="konfirmasi-tindakan-check">
                                                <i class="mdi mdi-check-circle"></i>
