                ...
                <div class="add-col-12">
                    <div class="add-card">
                        <form action="{{ route('customer.store') }}" method="POST">
                            ...
                            <div
                                class="add-card-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                            ...
                            <div class="add-card-body">
                                <form class="add-forms-sample">
                                    ...
                                    <div class="add-alert add-alert-info d-flex align-items-start gap-2 mb-4"
                                        ...
                                        <span>Data customer akan digunakan untuk booking unit, pengajuan KPR, dan dokumen
                                            legal. Pastikan data sesuai dengan dokumen resmi.</span>
                                    </div>
                                    ...
                                    <div class="add-custom-tabs-wrapper overflow-auto mb-3">
                                        <ul class="add-custom-tabs" id="customerTab" role="tablist">
                                            <li class="add-custom-tab-item">
                                                <a class="add-custom-tab-link active" id="pribadi-tab" data-toggle="tab"
                                                    href="#pribadi" role="tab" aria-controls="pribadi"
                                                    aria-selected="true">
                                            ...
                                            <li class="add-custom-tab-item">
                                                <a class="add-custom-tab-link" id="alamat-tab" data-toggle="tab"
                                                    href="#alamat" role="tab" aria-controls="alamat"
                                                    aria-selected="false">
                                            ...
                                            <li class="add-custom-tab-item">
                                                <a class="add-custom-tab-link" id="kontak-tab" data-toggle="tab"
                                                    href="#kontak" role="tab" aria-controls="kontak"
                                                    aria-selected="false">
                                            ...
                                            <li class="add-custom-tab-item">
                                                <a class="add-custom-tab-link" id="pekerjaan-tab" data-toggle="tab"
                                                    href="#pekerjaan" role="tab" aria-controls="pekerjaan"
                                                    aria-selected="false">
                                            ...
                                            <li class="add-custom-tab-item">
                                                <a class="add-custom-tab-link" id="keluarga-tab" data-toggle="tab"
                                            ...
                                            <li class="add-custom-tab-item">
                                                <a class="add-custom-tab-link" id="dokumen-tab" data-toggle="tab"
                                                    href="#dokumen" role="tab" aria-controls="dokumen"
                                                    aria-selected="false">
                                    ...
                                    <div class="tab-content mt-3 mt-md-4" id="customerTabContent">
                                            ...
                                            <div class="add-row">
                                                ...
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="nickname"
                                            ...
                                            <div class="add-row">
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="nik"
                                                ...
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="no_kk"
                                                            placeholder="16 digit" maxlength="16">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="add-row">
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="birthplace"
                                                            placeholder="Jakarta">
                                                    </div>
                                                </div>
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        ...
                                                        <div class="add-date-input">
                                                            ...
                                                            <input type="date" class="add-form-control"
                                                                name="date_birth">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="number" class="add-form-control" name="age"
                                            ...
                                            <div class="add-row">
                                                ...
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="number" class="add-form-control" name="child_count"
                                                            value="0" min="0">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="add-custom-tab-pane" id="alamat" role="tabpanel"
                                            ...
                                            <div class="add-checkbox-wrapper mb-4">
                                                ...
                                                <label class="add-checkbox-label" for="alamatSamaKTP">
                                                    ...
                                                    <span class="add-check-text">Alamat domisili sama dengan alamat
                                                        KTP</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="add-row">
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        ...
                                                        <select class="add-form-control" id="provinsiKTP"
                                                            name="province">
                                                ...
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" id="kotaKTP"
                                                            name="city" placeholder="Jakarta Selatan">
                                                    </div>
                                                </div>
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        <label>Kecamatan</label>
                                                        <input type="text" class="add-form-control" id="kecamatanKTP"
                                                            name="subdistrict" placeholder="Kebayoran Baru">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="add-row">
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" id="kelurahanKTP"
                                                            name="village" placeholder="Cipete">
                                                    </div>
                                                </div>
                                                <div class="add-col-6 add-col-md-2">
                                                    <div class="add-form-group">
                                                        <label>RT</label>
                                                        <input type="text" class="add-form-control" id="rtKTP"
                                                ...
                                                <div class="add-col-6 add-col-md-2">
                                                    <div class="add-form-group">
                                                        <label>RW</label>
                                                        <input type="text" class="add-form-control" id="rwKTP"
                                                            name="rw" placeholder="002">
                                                    </div>
                                                </div>
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        <label>Kode Pos</label>
                                                        <input type="text" class="add-form-control" id="kodePosKTP"
                                            ...
                                            <div class="add-form-group">
                                                ...
                                                <textarea class="add-form-control" id="alamatKTP" name="address" rows="2" placeholder="Jl. Contoh No. 123"></textarea>
                                            </div>
                                            ...
                                            <div class="add-row">
                                                ...
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        <label>Kota/Kabupaten</label>
                                                        <input type="text" class="add-form-control" id="kotaDomisili"
                                                            name="domicile_city" placeholder="Jakarta Selatan">
                                                    </div>
                                                </div>
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control"
                                                            id="kecamatanDomisili" name="domicile_subdistrict"
                                            ...
                                            <div class="add-row">
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        <label>Kelurahan/Desa</label>
                                                        <input type="text" class="add-form-control"
                                                            id="kelurahanDomisili" name="domicile_village"
                                                            placeholder="Cipete">
                                                    </div>
                                                </div>
                                                <div class="add-col-6 add-col-md-2">
                                                    <div class="add-form-group">
                                                        <label>RT</label>
                                                        <input type="text" class="add-form-control" id="rtDomisili"
                                                            name="domicile_rt" placeholder="001">
                                                    </div>
                                                </div>
                                                <div class="add-col-6 add-col-md-2">
                                                    <div class="add-form-group">
                                                        <label>RW</label>
                                                        <input type="text" class="add-form-control" id="rwDomisili"
                                                            name="domicile_rw" placeholder="002">
                                                    </div>
                                                </div>
                                                <div class="add-col-md-4">
                                                    <div class="add-form-group">
                                                        <label>Kode Pos</label>
                                                        <input type="text" class="add-form-control"
                                                            id="kodePosDomisili" name="domicile_postal_code"
                                                            placeholder="12345">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="add-form-group">
                                                ...
                                                <textarea class="add-form-control" id="alamatDomisili" name="domicile_address" rows="2"
                                        ...
                                        <div class="add-custom-tab-pane" id="kontak" role="tabpanel"
                                            ...
                                            <div class="add-row">
                                                ...
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="home_phone"
                                            ...
                                            <div class="add-row">
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="email" class="add-form-control" name="email"
                                                ...
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="email" class="add-form-control"
                                                            name="office_email" placeholder="john@company.com">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="add-section-title mt-3">
                                                ...
                                                Media Sosial
                                                <span class="add-badge add-badge-secondary ms-2"
                                                    style="font-size: 0.6rem;">Opsional</span>
                                            </div>
                                            ...
                                            <div class="add-row">
                                                ...
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="facebook"
        ...
        <input type="text" class="add-form-control" id="jobStatusLainnya" name="job_status_lainnya" placeholder="Tulis di sini...">
                                                ...
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control"
                                                            name="company_name" placeholder="PT. Contoh Abadi">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="add-row">
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="main_income"
                                                ...
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="side_income"
                                            ...
                                            <div class="add-row">
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        <label>NPWP</label>
                                                        <input type="text" class="add-form-control" name="npwp"
                                            ...
                                            <div class="add-row">
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="spouse_name"
                                                ...
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="spouse_nik"
                                            ...
                                            <div class="add-row">
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="father_name"
                                                ...
                                                <div class="add-col-md-6">
                                                    <div class="add-form-group">
                                                        ...
                                                        <input type="text" class="add-form-control" name="mother_name"
