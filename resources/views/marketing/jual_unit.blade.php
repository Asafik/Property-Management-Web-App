                            ...
                            <div class="d-none d-md-block">
                                <div class="row g-2 align-items-end">
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <button type="button" class="btn btn-gradient-secondary w-100 btn-icon-only" title="Reset Filter">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="text-nowrap fw-bold text-success">Rp {{ number_format($unit->price ?? 0, 0, ',', '.') }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <i class="mdi mdi-compass text-info me-2" style="font-size: 1rem;"></i>
                                                    {{ $unit->facing ?? '-' }}
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                @else
                                                    <span class="badge badge-gradient-warning">
                                                        <i class="mdi mdi-clock-outline me-1"></i>{{ ucfirst($unit->status) }}
                                                    </span>
                                                @endif
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <i class="mdi mdi-account-tie text-primary me-2" style="font-size: 1rem;"></i>
                                                    {{ $unit->agency->name ?? '-' }}
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <i class="mdi mdi-account text-success me-2" style="font-size: 1rem;"></i>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-1">
                                                    ...
                                                    <button onclick="$('#modalCustomer').modal('show')" class="btn btn-outline-danger btn-sm" title="Tambah Customer">
                                                        <i class="mdi mdi-account-plus"></i>
                                                    </button>
                                                    <button class="btn btn-outline-info btn-sm bukaModal" data-unit="{{ $unit->id }}" title="Pilih Agency">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                            <div class="card grid-card h-100">
                                <div class="card-body p-3">
                                    ...
                                    <h5 class="mt-2 fs-6">{{ $unit->unit_code }} - {{ $unit->landBank->name ?? '-' }}</h5>
                                    <p class="text-muted small mb-1">
                                        <i class="mdi mdi-map-marker me-1"></i>{{ Str::limit($unit->landBank->address ?? '-', 20) }}
                                    </p>
                                    <p class="small mb-1">
                                        <i class="mdi mdi-arrow-expand me-1"></i>{{ $unit->building_area ?? ($unit->area ?? '-') }} m² | Hadap {{ $unit->facing ?? '-' }}
                                    </p>
                                    <h5 class="text-primary mt-2">Rp {{ number_format($unit->price ?? 0, 0, ',', '.') }}</h5>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                        <small class="text-muted">
                                            @if($unit->customer)
                                                <i class="mdi mdi-account me-1"></i>{{ $unit->customer->full_name ?? '-' }}
                                            @else
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            @else
                                                <button class="btn btn-outline-danger" onclick="$('#modalCustomer').modal('show')">
                                                    <i class="mdi mdi-account-plus"></i>
                                                </button>
                                            @endif
                                        </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" onclick="$('#modalCustomer').modal('hide')" aria-label="Close"></button>
            </div>
                        ...
                        <tbody>
                            @foreach ($customers as $c)
                                <tr>
                                    ...
                                    <td>{{ $c->job_status ?? '-' }}</td>
                                    <td>
                                        <button class="btn btn-sm btn-gradient-success pilihCustomer" data-id="{{ $c->id }}">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.pilihCustomer', function() {
        ...
        let actionUrl = "{{ url('marketing/set-customer') }}/" + selectedUnitId;
