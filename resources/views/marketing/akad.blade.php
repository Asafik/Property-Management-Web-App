                ...
                <div class="card-body">
                    ...
                    <div id="formSetuju" style="display: none;">
                        ...
                        <div class="konfirmasi-form-group">
                            ...
                            <textarea class="konfirmasi-form-control" rows="2"
                                placeholder="Contoh: Disetujui dengan nilai 360jt, bunga 7.25%">Disetujui dengan nilai 360jt, bunga 7.25%</textarea>
                        </div>
                    </div>
                    ...
                    <div id="formTolak" style="display: none;">
                        ...
                        <div class="konfirmasi-form-group" id="alasanLainnya" style="display: none;">
                            ...
                            <input type="text" class="konfirmasi-form-control"
