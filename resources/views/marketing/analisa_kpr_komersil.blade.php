                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <div class="d-block d-md-none">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder="Cari nama customer atau unit..." style="height: 45px;">
                                    </div>
                                    ...
                                    <div class="row g-2">
                                        <div class="col-6">
                                            <button type="button"
                                                class="btn btn-gradient-primary w-100 py-2 d-flex align-items-center justify-content-center btn-filter">
                                                <i class="mdi mdi-filter me-1"></i> Filter
                                            </button>
                                        </div>
                                        <div class="col-6">
                                            <button type="button"
                                                class="btn btn-gradient-secondary w-100 py-2 d-flex align-items-center justify-content-center btn-reset">
                                ...
                                <div class="d-none d-md-block">
                                    <div class="row g-2 align-items-end">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Cari nama customer atau unit...">
                                        </div>
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <button type="button"
                                                class="btn btn-gradient-primary w-100 btn-icon-only btn-filter">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <button type="button"
                                                class="btn btn-gradient-secondary w-100 btn-icon-only btn-reset">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle" id="tableKprKomersil"
                                data-use-datatables="{{ $applications->count() > 0 ? 'true' : 'false' }}">
                                <thead>
                                    <tr>
                                    ...
                                    @forelse($applications as $key => $app)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($app->unit->construction_progress == 'selesai')
