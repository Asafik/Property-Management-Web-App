                                        ...
                                        <div class="row g-2 align-items-end w-100">
                                            ...
                                            <div class="col-md-1">
                                                ...
                                                <select class="form-control" name="per_page">
                                                    <option value="10"
                                                        {{ (int) request('per_page', $perPage ?? 10) === 10 ? 'selected' : '' }}>
                                                        10</option>
                                                    <option value="15"
                                                        {{ (int) request('per_page', $perPage ?? 10) === 15 ? 'selected' : '' }}>
                                                        15</option>
                                                    <option value="25"
                                                        {{ (int) request('per_page', $perPage ?? 10) === 25 ? 'selected' : '' }}>
                                                        25</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a href="{{ route('analisa.kpr.komersil') }}"
