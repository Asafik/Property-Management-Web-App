            ...
            <div class="card shadow-sm border-0">
                <div class="card-body d-flex flex-wrap align-items-center gap-3">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="text-muted mb-0">Kode Booking: #INV/202502/001</p>
                    </div>
                    ...
                    <div class="mt-3 mt-sm-0">
                        <div class="d-flex flex-wrap gap-3">
                            ...
                            <div>
                                ...
                                <span class="fw-medium text-primary">Rp 450.000.000</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-2 g-md-0">
                        ...
                        <div class="col text-center mb-3 mb-md-0">
                            <div class="step completed">
                                ...
                                <small class="text-muted d-none d-sm-block">25 Feb 2025</small>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="serah-form-group">
                        ...
                        <textarea class="serah-form-control" rows="2" placeholder="Contoh: Unit dalam kondisi baik, listrik dan air sudah aktif, kunci sudah diterima customer">Unit dalam kondisi baik, customer sudah cek seluruh ruangan dan menyatakan puas.</textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="serah-form-group">
                        ...
                        <div class="serah-signature-area" onclick="alert('Demo: Modal tanda tangan akan muncul')">
                            ...
                            <small class="text-muted mt-2">Budi Santoso</small>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-column gap-2">
                        ...
                        <button class="serah-btn serah-btn-primary w-100" style="background: linear-gradient(135deg, #25D366, #128C7E);">
