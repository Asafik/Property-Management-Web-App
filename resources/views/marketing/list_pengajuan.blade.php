...
@media (min-width: 768px) {
    ...
    .fs-md-4 { font-size: 1.3rem; }
    .fs-md-5 { font-size: 1.2rem; }
}
            ...
            <div class="card bg-gradient-primary card-img-holder text-white h-100">
                <div class="card-body p-2 p-sm-2 p-md-3 d-flex align-items-center">
                    <div class="rounded-circle p-2 p-md-3 me-2 me-md-3" style="background: rgba(255,255,255,0.2);">
                        <i class="mdi mdi-file-document" style="font-size: clamp(1rem, 3vw, 1.5rem);"></i>
                    </div>
                    <div>
                        <h2 class="mb-0 fs-5 fs-md-3">24</h2>
                        <small class="text-white opacity-75" style="font-size: clamp(0.7rem, 2vw, 0.85rem);">Total Pengajuan</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card bg-gradient-info card-img-holder text-white h-100">
                <div class="card-body p-2 p-sm-2 p-md-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-white opacity-75" style="font-size: clamp(0.7rem, 2vw, 0.85rem);">KPR Diproses</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card bg-gradient-success card-img-holder text-white h-100">
                <div class="card-body p-2 p-sm-2 p-md-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-white opacity-75" style="font-size: clamp(0.7rem, 2vw, 0.85rem);">Cash</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card bg-gradient-warning card-img-holder text-white h-100">
                <div class="card-body p-2 p-sm-2 p-md-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-white opacity-75" style="font-size: clamp(0.7rem, 2vw, 0.85rem);">Cair / Lunas</small>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                            <button class="btn btn-xs btn-gradient-info" title="Detail">
                                                <i class="mdi mdi-eye"></i>
                                            </button>
                                            <button class="btn btn-xs btn-gradient-warning" title="Edit">
                                                <i class="mdi mdi-pencil"></i>
                                            </button>
                                            <button class="btn btn-xs btn-gradient-danger" title="Hapus">
