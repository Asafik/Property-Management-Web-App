...
@media (max-width: 767px) {
    ...
    .filter-row-mobile { display: block; }
}
</style>
                                ...
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" name="status">
                                            ...
                                            <option value="dokumen" {{ request('status') == 'dokumen' ? 'selected' : '' }}>Dokumen</option>
                                        </select>
                                    </div>
                        ...
                        <div class="filter-row-mobile">
                            ...
                            <form method="GET" action="">
                                <div class="row g-2">
                                    ...
                                    <div class="col-6">
                                        <a href="{{ url()->current() }}" class="btn btn-gradient-secondary btn-icon-only w-100">
                                            <i class="mdi mdi-refresh"></i>
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <td class="text-center">
                                            <div class="action-group">
                                                @if($unitType === 'komersil')
                                                    ...
                                                    @else
                                                        <a href="{{ route('kpr.akad', $application->id) }}" class="btn-table-action btn-akad">
                                                            <i class="mdi mdi-file-document-check-outline"></i>Lanjut ke Akad
                                                        </a>
                                                    @endif
                                                @else
                                                    <a href="{{ route('kpr.survey', $application->id) }}" class="btn-table-action btn-survey">
