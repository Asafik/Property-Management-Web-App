                            ...
                            <div class="d-block d-md-none">
                                <form method="GET" action="{{ route('customer.kpr') }}">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-6">
                                            <a href="{{ route('customer.kpr') }}" class="btn btn-gradient-secondary w-100 py-2 d-flex align-items-center justify-content-center">
                        ...
                        <table class="table table-hover align-middle" id="tableCustomerKPR">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="fw-bold">Rp {{ number_format($booking->unit->price ?? 0, 0, ',', '.') }}</span>
                                    </td>
                                    <td>
                                        @if($booking->sales)
                                            <div class="d-flex align-items-center">
