                            ...
                            <form method="GET" action="">
                                <div class="row g-2 align-items-end">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="search_customer" value="{{ request('search_customer') }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="search_unit" value="{{ request('search_unit') }}"
                                            placeholder="Nama/kode/tipe unit...">
                                    </div>
                                    ...
                                    <div class="col-md-4 d-flex gap-2">
                                        ...
                                        <a href="" class="btn btn-gradient-secondary w-100 d-flex align-items-center justify-content-center">
                            ...
                            <tbody>
                                        ...
                                        <div class="aksi-buttons">
                                            @if ($application->unit->type === 'komersil')
                                                @if ($application->status === 'survey')
                                                    <a href="{{ route('kpr.survey', $application->id) }}" class="btn btn-outline-purple btn-sm">
                                                        <i class="mdi mdi-map-marker me-1"></i>Lanjut ke Survey
                                                    </a>
                                                @else
                                                    <a href="{{ route('kpr.akad', $application->id) }}" class="btn btn-gradient-success btn-sm">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center text-muted py-5">
                                        <i class="mdi mdi-home-account-off" style="font-size: 3rem; opacity: 0.3;"></i>
